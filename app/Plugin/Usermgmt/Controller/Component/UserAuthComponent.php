...
class UserAuthComponent extends Component {
	...
	function beforeFilter(&$c) {
		...
		$permissionFree=array('users/login','users/changePassword','users/myprofile', 'users/logout', 'users/register', 'users/userVerification', 'users/forgotPassword', 'users/activatePassword', 'pages/display', 'users/accessDenied','app/menu_permission','customers/customer_list','customers/customer_post','dashboards/dashboard1','dashboards/dashboard2');
	...
	/**
	 * Used to get user person id from session
	 *
	 * @access public
	 * @return integer
	 */
	...
	public function getPersonId() {
		return $this->Session->read('UserAuth.User.sales_person_id');
	}
	...
	public function getOfficeParentId() {
		return $this->Session->read('Office.parent_office_id');
	}
	
	public function getStoreId() {
		return $this->Session->read('Office.store_id');
	}
