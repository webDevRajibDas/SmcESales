    ...
    <div class="col-md-12">
		<div class="box box-primary">
			...
			<?php echo $this->Form->create('User'); ?>
				...
				<?php echo $this->Form->input('SalesPerson.office_id_old', array('type'=>'hidden','id'=>'selectedOfficeId')); ?>
				<div class="form-group">
					<?php echo $this->Form->input('SalesPerson.office_id', array('class' => 'form-control office_id','empty'=>'---- Select ----','id'=>'office_id')); ?>
				</div>
				<div class="form-group">
					<?php echo $this->Form->input("User.user_group_id", array('class' => 'form-control','empty'=>'---- Select Group ----','id'=>'user_group_id')); ?>
				</div>
				...
				<?php if($sr_data){?>
				 <div class="form-group" id="sr_list">
					<?php echo $this->Form->input('SalesPerson.dist_sales_representative_id', array('class' => 'form-control sr_id', 'id'=>'sr_id', 'options'=>$sr_data, 'selected'=>$sr_id,'empty'=>'--- Select ---')); ?>
				</div> 
				<?php }?>
				<div class="form-group">
...
$(document).ready(function(){  
	...
	var selectedOfficeId = $('#office_id').find(":selected").val();
	$('#selectedOfficeId').val(selectedOfficeId);
	
	$('.office_id').on('change', function() {
    	alert('Change New Office!!!');
	});
