 ...
 */
class ApiData166RetrivesController extends AppController {
    ...
    public function user_login() {
        ...
        $path = APP . 'logs/';
        $myfile = fopen($path . "login_166.txt", "a") or die("Unable to open file!");
    ...
    public function get_product_wise_open_bonus_and_price_combination()
    {
        ...
        $open_combination=$this->OpenCombinationProduct->find('all',array(
            ...
            'order'=>array('OpenCombinationProduct.product_id')
            ));
        $open_data=array();
    ...
    public function create_return_challan() {
        ...
        if (!empty($cdata)) {
            ...
            $prev_return_challan=$this->ReturnChallan->find('first',
                array(
    ...
    public function update_territory_wise_collection_deposit_balance($so_id) {
        ...
        foreach ($instrument_type as $key => $ins_data) {
            $collection_data = $this->Collection->find('first', array(
                ...
                'conditions' => array('SalesPerson.territory_id' => $territory_id, 'Collection.type' => $key,'Collection.memo_date >='=>'2018-10-01'),
                'joins' => array(
                    array(
                        'table' => 'sales_people',
                        'alias' => 'SalesPerson',
