 ...
 */
class ApiData177RetrivesController extends AppController
{
            ...
            if (is_numeric($json_data['market_id']) || true) {
                ...
                if ($count == 0) {
                    ...
                    foreach ($json_data['memo_details'] as $val) {
                        ...
                        $this->update_current_inventory($sale_quantity, ($val['virtual_product_id'] ? $val['virtual_product_id'] : $val['product_id']), $json_data['store_id'], 'deduct', 11, $memo_date);
