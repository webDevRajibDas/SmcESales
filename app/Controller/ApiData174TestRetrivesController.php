 ...
 */
class ApiData174TestRetrivesController extends AppController {
    ...
    public function get_product_combination_v2()
    {
        ...
        foreach($product_combination as $key=>$p_data)
        {
            ...
            $outlet_category_data=array_map(function($data){return $data[0];},$outlet_category_data);
    ...
    public function get_special_group() 
    {
        ...
        foreach($special_group_data as $data)
        {
            ...
            if($data_array)
            {
                ...
                $details=array_map(function($data){return $data['SpecialGroupOtherSetting'];},$details);
   ...
   /*
    ...
    public function get_policy_list_v2() {
        ...
        $conditions =array('DiscountBonusPolicy.is_so' => 1,
                'OR'=>array(
