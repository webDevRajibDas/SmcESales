 ...
 */
class ApiDataDist134RetrivesController extends AppController
{
	...
	{	//15,16,18,19,22,23,24,25,26,27,28,29,44
		...
		28	Kushtia Sales Officedist
		29	Barisal Sales Office
		44	Dhaka Metro */
		date_default_timezone_set('Asia/Dhaka');
		if (date('H:i') >= "18:00" && date('H:i') < "19:00")
			$restricted_office = array(19, 22, 23, 24, 25, 26, 27, 28, 29, 44);
		else if (date('H:i') >= "19:00" && date('H:i') < "20:00")
			$restricted_office = array(15, 16, 18, 24, 25, 26, 27, 28, 29, 44);
		else if (date('H:i') >= "20:00" && date('H:i') < "21:00")
			$restricted_office = array(15, 16, 18, 19, 22, 23,   27, 28, 29, 44);
		else if (date('H:i') >= "21:00" && date('H:i') < "22:30")
			$restricted_office = array(15, 16, 18, 19, 22, 23,   24, 25, 26);
		else
	...
	public function dist_create_order_bk()
	{
		$this->loadModel('DistOrder');
		$this->loadModel('DistOrderDetail');
