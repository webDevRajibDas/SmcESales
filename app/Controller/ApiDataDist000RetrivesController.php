 ...
 */
class ApiDataDist000RetrivesController extends AppController
{
	...
	{	
		...
		*/
		...
		if (date('H:i') >= "08:00" && date('H:i') < "08:20")
			$restricted_office = array(19, 15);
		else if (date('H:i') >= "08:20" && date('H:i') < "08:40")
			$restricted_office = array(23, 26);
		else if (date('H:i') >= "08:40" && date('H:i') < "09:00")
			$restricted_office = array(28, 24);
		else if (date('H:i') >= "09:00" && date('H:i') < "09:20")
			$restricted_office = array(27, 22);
		else if (date('H:i') >= "09:20" && date('H:i') < "09:40")
			$restricted_office = array(44, 25);
		else if (date('H:i') >= "09:40" && date('H:i') < "10:00")
			$restricted_office = array(16, 18);
		else if (date('H:i') >= "10:00" && date('H:i') < "10:20")
			$restricted_office = array(29);
		else
	...
	/* ------------------- Dist Memo Create ----------------------- */
	public function dist_create_memo_bk()
	{
		$this->loadModel('DistOrder');
		$this->loadModel('DistOrderDetail');
		$this->loadModel('DistMemo');
