...
class EffectiveCallsBaseWiseController extends AppController {
    ...
    public function admin_get_effective_call_outlet_session_base_wise_data() {
        ...
        $SaleTarget = $this->SaleTarget->find('all', array(
            ...
            'fields' => array('SaleTarget.outlet_coverage_pharma', 'SaleTarget.outlet_coverage_non_pharma', 'SaleTarget.session', 'SaleTarget.effective_call_pharma', 'SaleTarget.effective_call_non_pharma'),
            'recursive' => -1
                )
        );
