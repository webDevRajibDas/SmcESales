 ...
 */
class SalesAnalysisLoadReportsController extends AppController
{
    ...
    public function admin_index($id = null)
    {
        ...
        $start_time = $this->current_datetime();
        fwrite($myfile, "\n" . $start_time . ':' . "Request Started : " . $_SERVER['UNIQUE_ID']);
        ...
        // $office_parent_id = $this->UserAuth->getOfficeParentId(); // comment for default sales analysis run
        $office_parent_id = 0;
        ...
        $this->request->data = array(
            'submit' => 'Submit',
            'SalesAnalysisReports' => array(
                'date_from' => '01-07-2022',
                'date_to' => '31-12-2022',
                'rows' => 'area',
                'rows_for_target' => 'territory',
                'target' => '',
                'target_rows_type' => 'day',
                'target_working_days' => '',
                'columns' => 'product',
                'columns_for_target' => 'product',
                'indicators' => array(
                    '0' => 'volume',
                    '1' => 'value',
                    '2' => 'oc',
        ...
        // if ($this->request->is('post')) { // comment for auto script test
        if (1 == 1) {
            ...
            if ($this->request->data['SalesAnalysisReports']['target']) {
                ...
                if ($this->request->data['SalesAnalysisReports']['indicators']) {
                    ...
                    if ($request_data['SalesAnalysisReports']['program_type_id']) {
                        ...
                        if (in_array(6, $program_type_ids)) {
                            $where .= " union 
	 									...
	 									left join outlets o on o.institute_id=np.institute_id";
                    ...
                    if ($rows == 'month' || $rows == 'national') {
                            ...
                            foreach ($rows_list as $row_key => $row_val) {
                                ...
                                if ($request_data['SalesAnalysisReports']['columns'] == 'category') {
                                        ...
                                        'fields' => array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc',  'MemoDetail.product_id', 'Product.cyp_cal as cyp', 'Product.cyp as cyp_v', 'Product.product_category_id'),
                                        ...
                                        'fields' => array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc',  'Product.brand_id'),
                                        ...
                                        'fields' => array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc',  'MemoDetail.product_id', 'Product.cyp_cal as cyp', 'Product.cyp as cyp_v', 'Product.brand_id'),
                                        ...
                                        'fields' => array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc',  'Outlet.category_id'),
                                        ...
                                        'fields' => array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc',  'MemoDetail.product_id', 'Product.cyp_cal as cyp', 'Product.cyp as cyp_v', 'Outlet.category_id'),
                                        ...
                                        'fields' => array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc'),
                                        //'group' => array( 'Outlet.category_id'),
                                        ...
                                        'fields' => array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc',  'MemoDetail.product_id', 'Product.cyp_cal as cyp', 'Product.cyp as cyp_v'),
                                    ...
                                    $q_results[$row_key] = $this->Memo->find('all', array(
                                        ...
                                        //'fields' => array('SUM(CASE WHEN MemoDetail.price>0 THEN MemoDetail.sales_qty END) AS volume,SUM(CASE WHEN MemoDetail.price=0 THEN MemoDetail.sales_qty END) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc'),
                                        'fields' => array('SUM(
															ROUND((ROUND(
																	(CASE WHEN MemoDetail.price>0 THEN MemoDetail.sales_qty END) * 
																	(CASE WHEN ProductMeasurement.qty_in_base is null then 1 ELSE ProductMeasurement.qty_in_base END)
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc',  'MemoDetail.product_id', 'Product.cyp_cal as cyp', 'Product.cyp as cyp_v', 'Product.order'),
                                        ...
                                        'fields' => array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc',  'Product.product_category_id'),
                                        'group' => array('Product.product_category_id'),
                                ...
                                $fields = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'sales_person_id', 'MemoDetail.product_id', 'Product.cyp_cal as cyp', 'Product.cyp as cyp_v');
                                    ...
                                    $fields2 = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'sales_person_id', 'Outlet.category_id', 'MemoDetail.product_id', 'Product.cyp_cal as cyp', 'Product.cyp as cyp_v');
                                ...
                                $fields = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Memo.sales_person_id', 'Product.product_category_id');
                                ...
                                $fields2 = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'sales_person_id', 'Product.product_category_id', 'MemoDetail.product_id', 'Product.cyp_cal as cyp', 'Product.cyp as cyp_v');
                                ...
                                $fields = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Memo.sales_person_id', 'Product.brand_id');
                                ...
                                $fields2 = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'sales_person_id', 'Product.brand_id', 'MemoDetail.product_id', 'Product.cyp_cal as cyp', 'Product.cyp as cyp_v');
                                ...
                                $fields = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'sales_person_id', 'Outlet.category_id');
                                ...
                                $fields = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'sales_person_id');
                        ...
                        if ($request_data['SalesAnalysisReports']['rows'] == 'territory') {
                            if ($request_data['SalesAnalysisReports']['columns'] == 'product') {
                                $fields = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Memo.territory_id', 'MemoDetail.product_id', 'Product.cyp_cal as cyp', 'Product.cyp as cyp_v');
                                $group = array('Memo.territory_id', 'MemoDetail.product_id', 'cyp_cal', 'cyp');
                                    ...
                                    $fields2 = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Memo.territory_id', 'Outlet.category_id', 'MemoDetail.product_id', 'Product.cyp_cal as cyp', 'Product.cyp as cyp_v');
                                    $group2 = array('Memo.territory_id', 'Outlet.category_id', 'MemoDetail.product_id', 'cyp_cal', 'cyp');
                                }
                            } elseif ($request_data['SalesAnalysisReports']['columns'] == 'category') {
                                $fields = array('SUM(
															ROUND((ROUND(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Memo.territory_id', 'Product.product_category_id');
                                $group = array('Memo.territory_id', 'Product.product_category_id');
                                ...
                                $fields2 = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Memo.territory_id', 'Product.product_category_id', 'MemoDetail.product_id', 'Product.cyp_cal as cyp', 'Product.cyp as cyp_v');
                                $group2 = array('Memo.territory_id', 'Product.product_category_id', 'MemoDetail.product_id', 'cyp_cal', 'cyp');
                            } elseif ($request_data['SalesAnalysisReports']['columns'] == 'brand') {
                                $fields = array('SUM(
															ROUND((ROUND(
																	(CASE WHEN MemoDetail.price>0 THEN MemoDetail.sales_qty END) * 
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Memo.territory_id', 'Product.brand_id');
                                $group = array('Memo.territory_id', 'Product.brand_id');
                                ...
                                $fields2 = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Memo.territory_id', 'Product.brand_id', 'MemoDetail.product_id', 'Product.cyp_cal as cyp', 'Product.cyp as cyp_v');
                                $group2 = array('Memo.territory_id', 'Product.brand_id', 'MemoDetail.product_id', 'cyp_cal', 'cyp');
                            } elseif ($request_data['SalesAnalysisReports']['columns'] == 'outlet_type') {
                                $fields = array('SUM(
															ROUND((ROUND(
																	(CASE WHEN MemoDetail.price>0 THEN MemoDetail.sales_qty END) * 
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Memo.territory_id', 'Outlet.category_id');
                                $group = array('Memo.territory_id', 'Outlet.category_id');
                                ...
                                $fields = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Memo.territory_id');
                                $group = array('Memo.territory_id');
                                ...
                                $group2 = array('Memo.territory_id', 'MemoDetail.product_id', 'cyp_cal', 'cyp');
                            }
                        }
                                ...
                                $fields = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Memo.office_id', 'MemoDetail.product_id', 'Product.cyp_cal as cyp', 'Product.cyp as cyp_v');
                                    ...
                                    $fields2 = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Memo.office_id', 'Outlet.category_id', 'MemoDetail.product_id', 'Product.cyp_cal as cyp', 'Product.cyp as cyp_v');
                                ...
                                $fields = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Memo.office_id', 'Product.product_category_id');
                                ...
                                $fields2 = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Memo.office_id', 'Product.product_category_id', 'MemoDetail.product_id', 'Product.cyp_cal as cyp', 'Product.cyp as cyp_v');
                                ...
                                $fields = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Memo.office_id', 'Product.brand_id');
                                ...
                                $fields2 = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Memo.office_id', 'Product.brand_id', 'MemoDetail.product_id', 'Product.cyp_cal as cyp', 'Product.cyp as cyp_v');
                                ...
                                $fields = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Memo.office_id', 'Outlet.category_id');
                                ...
                                $fields = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Memo.office_id');
                                ...
                                $fields = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Office.parent_office_id', 'MemoDetail.product_id', 'Product.cyp_cal as cyp', 'Product.cyp as cyp_v');
                                    ...
                                    $fields2 = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Office.parent_office_id', 'Outlet.category_id', 'MemoDetail.product_id', 'Product.cyp_cal as cyp', 'Product.cyp as cyp_v');
                                ...
                                $fields = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Office.parent_office_id', 'Product.product_category_id');
                                ...
                                $fields2 = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Office.parent_office_id', 'Product.product_category_id', 'MemoDetail.product_id', 'Product.cyp_cal as cyp', 'Product.cyp as cyp_v');
                                ...
                                $fields = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Office.parent_office_id', 'Product.brand_id');
                                ...
                                $fields2 = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Office.parent_office_id', 'Product.brand_id', 'MemoDetail.product_id', 'Product.cyp_cal as cyp', 'Product.cyp as cyp_v');
                                ...
                                $fields = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Office.parent_office_id', 'Outlet.category_id');
                                ...
                                $fields = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Office.parent_office_id');
                                ...
                                $fields = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Division.id', 'MemoDetail.product_id', 'Product.cyp_cal as cyp', 'Product.cyp as cyp_v');
                                    ...
                                    $fields2 = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Division.id', 'Outlet.category_id', 'MemoDetail.product_id', 'Product.cyp_cal as cyp', 'Product.cyp as cyp_v');
                                ...
                                $fields = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Division.id', 'Product.product_category_id');
                                ...
                                $fields2 = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Division.id', 'Product.product_category_id', 'MemoDetail.product_id', 'Product.cyp_cal as cyp', 'Product.cyp as cyp_v');
                                ...
                                $fields = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Division.id', 'Product.brand_id');
                                ...
                                $fields2 = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Division.id', 'Product.brand_id', 'MemoDetail.product_id', 'Product.cyp_cal as cyp', 'Product.cyp as cyp_v');
                                ...
                                $fields = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Division.id', 'Outlet.category_id');
                                ...
                                $fields = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Division.id');
                                ...
                                $fields = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'District.id', 'MemoDetail.product_id', 'Product.cyp_cal as cyp', 'Product.cyp as cyp_v');
                                    ...
                                    $fields2 = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'District.id', 'Outlet.category_id', 'MemoDetail.product_id', 'Product.cyp_cal as cyp', 'Product.cyp as cyp_v');
                                ...
                                $fields = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'District.id', 'Product.product_category_id');
                                ...
                                $fields2 = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'District.id', 'Product.product_category_id', 'MemoDetail.product_id', 'Product.cyp_cal as cyp', 'Product.cyp as cyp_v');
                                ...
                                $fields = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'District.id', 'Product.brand_id');
                                ...
                                $fields2 = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'District.id', 'Product.brand_id', 'MemoDetail.product_id', 'Product.cyp_cal as cyp', 'Product.cyp as cyp_v');
                                ...
                                $fields = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'District.id', 'Outlet.category_id');
                                ...
                                $fields = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'District.id');
                                ...
                                $fields = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Thana.id', 'MemoDetail.product_id', 'Product.cyp_cal as cyp', 'Product.cyp as cyp_v');
                                    ...
                                    $fields2 = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Thana.id', 'Outlet.category_id', 'MemoDetail.product_id', 'Product.cyp_cal as cyp', 'Product.cyp as cyp_v');
                                ...
                                $fields = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Thana.id', 'Product.product_category_id');
                                ...
                                $fields2 = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Thana.id', 'Product.product_category_id', 'MemoDetail.product_id', 'Product.cyp_cal as cyp', 'Product.cyp as cyp_v');
                                ...
                                $fields = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Thana.id', 'Product.brand_id');
                                ...
                                $fields2 = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Thana.id', 'Product.brand_id', 'MemoDetail.product_id', 'Product.cyp_cal as cyp', 'Product.cyp as cyp_v');
                                ...
                                $fields = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Thana.id', 'Outlet.category_id');
                                ...
                                $fields = array('SUM(
													...
													SUM(
															ROUND((ROUND(
																...
																(CASE WHEN ProductMeasurementSales.qty_in_base is null then 1 ELSE ProductMeasurementSales.qty_in_base END)
																,2,1)
														) AS bonus, sum(MemoDetail.sales_qty*MemoDetail.price) AS value, COUNT(DISTINCT Memo.memo_no) AS ec, COUNT(DISTINCT Memo.outlet_id) as oc', 'Thana.id');
                    ...
                    if ($request_data['SalesAnalysisReports']['columns'] == 'product') {
                        ...
                        if ($request_data['SalesAnalysisReports']['rows'] == 'territory') {
                            foreach ($q_results as $q_result) {
                                $results[$q_result['Memo']['territory_id']][$q_result['MemoDetail']['product_id']] = array(
                                    'volume' => $q_result[0]['volume'],
                                    'bonus' => $q_result[0]['bonus'],
                                    'value' => $q_result[0]['value'],
                                    'ec' => $q_result[0]['ec'],
                        ...
                        if ($request_data['SalesAnalysisReports']['rows'] == 'territory') {
                            foreach ($q_results2 as $q_result2) {
                                $results2[$q_result2['Memo']['territory_id']][$q_result2['Product']['product_category_id']][$q_result2['MemoDetail']['product_id']] = array(
                                    'volume' => $q_result2[0]['volume'],
                                    'bonus' => $q_result2[0]['bonus'],
                                    'cyp' => $q_result2[0]['cyp'],
                                    'cyp_v' => $q_result2[0]['cyp_v'],
                            ...
                            foreach ($q_results as $q_result) {
                                ...
                                $sales_qty = 0;
                                $bonus_qty = 0;
                                foreach ($results2[$q_result['Memo']['territory_id']][$q_result['Product']['product_category_id']] as $cyp_result) {
                                    //pr($cyp_result);
                                    $pro_volume = $cyp_result['volume'] ? $cyp_result['volume'] : 0;
                                    $base_qty = $this->unit_convert($cyp_result['product_id'], $product_measurement[$cyp_result['product_id']], $pro_volume);
                                ...
                                $results[$q_result['Memo']['territory_id']][$q_result['Product']['product_category_id']] = array(
                                    //'volume' => $q_result[0]['volume'],
                                    'volume' => $sales_qty,
                                    'bonus' => $bonus_qty,
                                    'value' => $q_result[0]['value'],
                        ...
                        if ($request_data['SalesAnalysisReports']['rows'] == 'territory') {
                            foreach ($q_results2 as $q_result2) {
                                $results2[$q_result2['Memo']['territory_id']][$q_result2['Product']['brand_id']][$q_result2['MemoDetail']['product_id']] = array(
                                    'volume' => $q_result2[0]['volume'],
                                    'bonus' => $q_result2[0]['bonus'],
                                    'cyp' => $q_result2[0]['cyp'],
                                    'cyp_v' => $q_result2[0]['cyp_v'],
                            ...
                            foreach ($q_results as $q_result) {
                                ...
                                $sales_qty = 0;
                                $bonus_qty = 0;
                                foreach ($results2[$q_result['Memo']['territory_id']][$q_result['Product']['brand_id']] as $cyp_result) {
                                    //pr($cyp_result);
                                    $pro_volume = $cyp_result['volume'] ? $cyp_result['volume'] : 0;
                                    $base_qty = $this->unit_convert($cyp_result['product_id'], $product_measurement[$cyp_result['product_id']], $pro_volume);
                                ...
                                $results[$q_result['Memo']['territory_id']][$q_result['Product']['brand_id']] = array(
                                    //'volume' => $q_result[0]['volume'],
                                    'volume' => $sales_qty,
                                    'bonus' => $bonus_qty,
                                    'value' => $q_result[0]['value'],
                        ...
                        if ($request_data['SalesAnalysisReports']['rows'] == 'territory') {
                            foreach ($q_results2 as $q_result2) {
                                $results2[$q_result2['Memo']['territory_id']][$q_result2['Outlet']['category_id']][$q_result2['MemoDetail']['product_id']] = array(
                                    'volume' => $q_result2[0]['volume'],
                                    'bonus' => $q_result2[0]['bonus'],
                                    'cyp' => $q_result2[0]['cyp'],
                                    'cyp_v' => $q_result2[0]['cyp_v'],
                            ...
                            foreach ($q_results as $q_result) {
                                $cyp = 0;
                                $total_cyp = 0;
                                foreach ($results2[$q_result['Memo']['territory_id']][$q_result['Outlet']['category_id']] as $cyp_result) {
                                    //pr($cyp_result);
                                    $pro_volume = $cyp_result['volume'] ? $cyp_result['volume'] : 0;
                                    $base_qty = $this->unit_convert($cyp_result['product_id'], $product_measurement[$cyp_result['product_id']], $pro_volume);
                                    $cyp_s = $cyp_result['cyp'] ? $cyp_result['cyp'] : 0;
                                ...
                                $results[$q_result['Memo']['territory_id']][$q_result['Outlet']['category_id']] = array(
                                    'volume' => $q_result[0]['volume'],
                                    'bonus' => $q_result[0]['bonus'],
                                    'value' => $q_result[0]['value'],
                                    'ec' => $q_result[0]['ec'],
                        ...
                        if ($request_data['SalesAnalysisReports']['rows'] == 'territory') {
                            foreach ($q_results2 as $q_result2) {
                                $results2[$q_result2['Memo']['territory_id']][] = array(
                                    'volume' => $q_result2[0]['volume'],
                                    'bonus' => $q_result2[0]['bonus'],
                                    'cyp' => $q_result2[0]['cyp'],
                                    'cyp_v' => $q_result2[0]['cyp_v'],
                            ...
                            foreach ($q_results as $q_result) {
                                ...
                                foreach ($results2[$q_result['Memo']['territory_id']] as $cyp_result) {
                                    $pro_volume = $cyp_result['volume'] ? $cyp_result['volume'] : 0;
                                    $base_qty = $this->unit_convert($cyp_result['product_id'], $product_measurement[$cyp_result['product_id']], $pro_volume);
                                    $cyp_s = $cyp_result['cyp'] ? $cyp_result['cyp'] : 0;
                                    $cyp_v = $cyp_result['cyp_v'] ? $cyp_result['cyp_v'] : 0;
                                ...
                                $results[$q_result['Memo']['territory_id']] = array(
                                    'volume' => $q_result[0]['volume'],
                                    'bonus' => $q_result[0]['bonus'],
                                    'value' => $q_result[0]['value'],
                                    'ec' => $q_result[0]['ec'],
                                        ...
                                        if ($request_data['SalesAnalysisReports']['rows'] == 'national') {
                                            if ($columns == 'category') {
                                                ...
                                                foreach ($results2[$row_key] as $result2) {
                                                    if ($result2['Product']['product_category_id'] == $col_key) {
                                                        ...
                                                        $base_qty = $this->unit_convert($result2['MemoDetail']['product_id'], $product_measurement[$result2['MemoDetail']['product_id']], $pro_volume);

                                                        $pro_bonus = $result2[0]['bonus'];
                                                        $bonus_base_qty = $this->unit_convert($result2['MemoDetail']['product_id'], $product_measurement[$result2['MemoDetail']['product_id']], $pro_bonus);
                                                        ...
                                                        //$sales_qty+= ($unit_type==1)?$pro_volume:$this->unit_convert($result2['MemoDetail']['product_id'], $product_measurement[$result2['MemoDetail']['product_id']], $pro_volume);
                                                        $sales_qty += ($unit_type == 1) ? $pro_volume : $base_qty;
                                                ...
                                                for ($n = 0; $n < $total; $n++) {
                                                    ...
                                                    if (@$results[0][$n]['MemoDetail']['product_id'] == $col_key) {
                                                        ...
                                                        $bonus_base_qty = $this->unit_convert($col_key, $product_measurement[$col_key], $pro_bonus);
                                              ...
                                              else
                                              {
                                                ...
                                                for ($n = 0; $n < $total; $n++) {
                                                    ...
                                                    if (@$results[$row_key][$n]['MemoDetail']['product_id'] == $col_key) {
                                                        ...
                                                        $bonus_base_qty = $this->unit_convert($col_key, $product_measurement[$col_key], $bonus_qty);
                                                        if ($in_key == 'cyp') {
                                                            $pro_qty =  @$sales_qty;
                                            ...
                                            if ($request_data['SalesAnalysisReports']['columns'] == 'product') {
                                                ...
                                                if ($in_key == 'cyp') {
                                                    ...
                                                    $base_qty_bonus = $this->unit_convert($col_key, $product_measurement[$col_key], $sales_qty_bonus);
        ...
        $end_time = $this->current_datetime();
		...
		echo "Seconds: ".$diff->s;
		exit; */
        //fwrite($myfile, "\n" . $end_time . ':' . "Request closed :  -- " .$diff->i." Min ".$diff->s ." Sec -- "  . $_SERVER['UNIQUE_ID'] ." :-". $output);
        // echo $view->element('sql_dump');

        $this->set(compact('offices', 'outlet_type', 'territories'));
        fwrite($myfile, "\n" . $end_time . ':' . "Request closed :  -- " . $diff->i . " Min " . $diff->s . " Sec -- "  . $_SERVER['UNIQUE_ID']);
        fclose($myfile);
    }
