 ...
 */
class ApiData173RetrivesController extends AppController {
    ...
    public function user_login() {
        ...
        $path = APP . 'logs/';
        $myfile = fopen($path . "login_173.txt", "a") or die("Unable to open file!");
    ...
    public function get_product_wise_open_bonus_and_price_combination()
    {
        ...
        $open_combination=$this->OpenCombinationProduct->find('all',array(
            /*'conditions'=>array('OpenCombination.end_date <='=>date('Y-m-d',strtotime('-4 Months'))),*/'conditions'=>array("OR"=>array(
                    'OpenCombination.is_bonus'=>0,
