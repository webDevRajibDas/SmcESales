    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title"><i class="glyphicon glyphicon-edit"></i>  <?php echo __('Create SR Order'); ?></h3>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6">
                        <div class="form-group">
                            <?php echo $this->Form->input('order_date', array('class' => 'form-control datepicker', 'value' => ($selected_order_date)?$selected_order_date:$current_date, 'type' => 'text', 'required' => TRUE)); ?>
                        </div>
                    ...
                    <table class="table table-striped table-condensed table-bordered invoice_table" id="main_invoice_data">
                        ...
                        <tfoot>
                            ...
                            <tr>
                                ...
                                <td align="center"><input name="data[DistOrder][cash_recieved]" class="form-control width_100" type="text" id="cash_collection" />
                            ...
                            <!-- <tr>
                                ...
                                <td align="center"><input name="data[DistOrder][credit_amount]" class="form-control width_100" type="hidden" id="credit_amount" readonly />
                                </td>
                                <td></td>
                            </tr> -->
                            <tr>
                                <td colspan="5" align="right"><b>Discount : </b></td>
                                <td align="center"><input name="data[DistOrder][discount_percent]" class="form-control width_100 discount_percent" type="text" id="discount_percent" readonly/>
                                </td>
                                <td></td>
                              
                            </tr>
                            <tr><td colspan="4"> <a class="btn btn-primary btn-xs show_bonus" data-toggle="modal"  data-backdrop="static" data-keyboard="false"   data-target="#bonus_product"><i class="glyphicon glyphicon-plus"></i>Bonus</a>
                                ...
                                <td align="center"><input name="data[DistOrder][discount_value]" class="form-control width_100 discount_value" type="text" id="discount_value" readonly />
                                </td>
                                <td></td>
...
<script>
    $(document).ready(function () {
        ...
        $('body').on("click", ".make_market", function () 
        {
            ...
            var market_order_date=$("#DistOrderOrderDate").val();
    ...
    $("#market_model").submit(function (event) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                window.location.assign("<?php echo BASE_URL; ?>admin/dist_Orders/create_Order");
            }
        });
        //$('.img-circle').hide();
    ...
    $(document).ready(function () {
        ...
        $("body").on("change", ".product_id", function ()
        {
            ...
            if ($('#' + current_row_no + '>th>.product_rate').val() != '' && product_change_flag == 1) {
                ...
                $.ajax({
                    url: '<?= BASE_URL . 'DistOrders/delete_Order' ?>',
                    'type': 'POST',
                    ...
                    success: function (result) {
                        if (result == 'yes') {
                            ...
                            if (no_of_new_combined_product > 0) {
                                ...
                                $.ajax({
                                    url: '<?= BASE_URL . 'DistOrders/get_combine_or_individual_price' ?>',
                                    'type': 'POST',
                                    data: {combined_product: combined_product_change, min_qty: min_qty_new, product_id: product_id_new, product_id_list: product_id_list_change,order_date:order_date},
                                    success: function (result) {
...
<script>
    ...
    { 
        ...
        if (product_category_id != 32 && pro_val) {
            ...
            console.log(combined_product_field.val());
            var product_unit_id = product_box.find("th:nth-child(3) .product_unit_id");
            var product_price_id = product_box.find("th:nth-child(4) .product_price_id");
        ...
        var distributor_id = $('#distributor_id').val();
            ...
            if (new_product == 1) {
                ...
                $.ajax({
                    ...
                    'type': 'POST',
                    data: {product_id: product_id, territory_id: territory_id, distributor_id: distributor_id, product_id_list: product_id_list,order_date:order_date,min_qty:min_qty},
                    success: function (result)
                    {
                        var obj = jQuery.parseJSON(result);
                        console.log(obj.combined_product);
                        ...
                        combined_product_field.val(obj.combined_product);
                        ...
                        var total_booking_qty = obj.total_booking_qty;
                        ...
                        /*if(total_qty < total_booking_qty){
                            $('#'+current_row_no+'>th>.min_qty').attr('max', 0);
                        }
                        else{*/
                            //var qty = total_qty - total_booking_qty;
         ...
         delay(function ()
            {
                ...
                $.ajax({
                    url: '<?= BASE_URL . 'DistOrders/get_combine_or_individual_price' ?>',
                    'type': 'POST',
                    data: {combined_product: combined_product, min_qty: min_qty, product_id: id, product_id_list: product_id_list,order_date:order_date},
                    success: function (result)
                    {
                        var obj = jQuery.parseJSON(result);
                        console.log("get_combine_or_individual_price on change qty change:"+result);
                       /* $.ajax({
                            url: '<?= BASE_URL . 'DistOrders/get_combine_or_individual_price_without_bonus' ?>',
                            'type': 'POST',
                            data: {combined_product: combined_product, min_qty: min_qty, product_id: id, product_id_list: product_id_list,order_date:order_date},
                            success: function (result)
                            {*/
                ...
                $.ajax({
                    ...
                    success: function (result)
                    {
                        if (result == 'yes') {
                            ...
                            if (no_of_new_combined_product > 0) {
                                $.ajax({
                                    url: '<?= BASE_URL . 'dist_Orders/get_combine_or_individual_price' ?>',
                                    'type': 'POST',
                                    data: {combined_product: combined_product, min_qty: min_qty_new, product_id: product_id_new, product_id_list: product_id_list,order_date:order_date},
                                    success: function (result) {
...
<?php if ($dist == 1) { ?>
        ...
        $(document).ready(function () {
            ...
            function get_sr_list_by_distributor_id(distributor_id)
            {
                ...
                {
                 $.ajax({
                    url: '<?= BASE_URL . 'DistOrders/get_sr_list_by_distributot_id' ?>',
                    data: {'distributor_id': distributor_id,'order_date':order_date},
                    type: 'POST',
                    success: function (data)
                    {
