    ...
    <div class="col-md-12">
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><i class="glyphicon glyphicon-edit"></i>  <?php echo __('Edit SR Order'); ?></h3>
 ...
 <?php echo $this->Form->input('sale_type_id', array('class' => '', 'required'=>TRUE, 'id' => 'sale_type_id', 'type' => 'hidden', 'value'=> '10')); ?>                    
      ...
      <div class="table-responsive">	
              ...
              if($val['price']==0.000)
				...
				<tfoot>
					<tr>
						...
						<td align="center"><input name="data[DistOrder][gross_value]" class="form-control width_100" type="text" id="gross_value" value="<?php echo $existing_record['DistOrder']['gross_value']; ?>" readonly />
              <input name="data[DistOrder][credit_amount]" class="form-control width_100" type="hidden" id="credit_amount" value="<?php echo $existing_record['DistOrder']['credit_amount']; ?>" readonly />
						</td>
						<td></td>
					...
					<tr>
						...
						<td align="center"><input name="data[DistOrder][cash_recieved]" class="form-control width_100" type="text" id="cash_collection" value="<?php echo $existing_record['DistOrder']['cash_recieved']; ?>" />
						</td>
						<td></td>
            ...
            <td align="right"><b>Credit : </b></td>
                      <td></td>
            <td align="center"><input name="data[DistOrder][credit_amount]" class="form-control width_100" type="hidden" id="credit_amount" value="<?php echo $existing_record['DistOrder']['credit_amount']; ?>" readonly />
            </td>
            <td></td>
          </tr> -->
          <tr>
            <td colspan="5" align="right"><b>Discount : </b></td>
            <td align="center"><input name="data[DistOrder][discount_percent]" class="form-control width_100 discount_percent" type="text" id="discount_percent" value="<?php echo $existing_record['DistOrder']['discount_percent']; ?>" readonly/>
            </td>
            <td></td>
        ...
        <tr>
           ...
           <td colspan="4"> <a class="btn btn-primary btn-xs show_bonus" data-toggle="modal"  data-backdrop="static" data-keyboard="false"   data-target="#bonus_product"><i class="glyphicon glyphicon-plus"></i>Bonus</a>
                        ...
                        <tbody class="bonus_product">
                          ...
                          <tr  class="bonus_row">
                            <th class="text-center" <?php if($sl==1)?> id="bonus_product_list">
                              <?php
                                echo $this->Form->input('product_id', array('name' => 'data[OrderDetail][product_id][]', 'class' => 'form-control width_100 open_bonus_product_id','options'=>$product_list,'empty'=>'---- Select Product ----', 'label' => false,'autofocus' => true,'default'=>$val['product_id']));
                              ?>
            ...
            <td align="center"><input name="data[DistOrder][discount_value]" class="form-control width_100 discount_value" type="text" id="discount_value" value="<?php echo $existing_record['DistOrder']['discount_value']; ?>" readonly />
            </td>
            <td></td>
