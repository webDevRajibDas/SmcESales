			...
			<div class="box-body">
                <table id="OfficePeople" class="table table-bordered table-striped">
					...
					<tr>
						...
						<td class="text-center"><?php echo h($officePerson['Office']['office_name']); ?></td>
						<td class="text-center"><?php echo h($officePerson['SalesPerson']['name']); ?></td>
						<td class="text-center"><?php echo h($officePerson['OfficePerson']['effective_date']); ?></td>
						<td class="text-center">
						<?php
							if($officePerson['OfficePerson']['is_active']==1){
								echo h('Yes');
							}else{
								echo h('No');
							}
