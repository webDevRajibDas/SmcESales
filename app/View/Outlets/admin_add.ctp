    ...
    <div class="col-md-12">
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><i class="glyphicon glyphicon-edit"></i>  <?php echo __('Add Outlet'); ?></h3>
			...
			<?php echo $this->Form->create('Outlet', array('role' => 'form')); ?>
				...
				<div class="form-group">
					<?php echo $this->Form->input('location_type_id', array('id'=>'location_type_id','class' => 'form-control','empty'=>'---- Select ----')); ?>
				</div>					
				<div class="form-group">
				...
				<div class="form-group">
					<?php echo $this->Form->input('bonus_type_id', array('class' => 'form-control bonus_type','type'=>'select','options'=>array('0'=>'Not Applicable','1'=>'Small Bonus','2'=>'Big Bonus'))); ?>
				</div>
				<div class="form-group">
