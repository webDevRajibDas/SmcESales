...
<!--                <div class="form-group">
                    <?php echo $this->Form->input('dist_sales_representative_id', array('label' => 'Sales Representative', 'id' => 'dist_sales_representative_id', 'class' => 'form-control', 'empty' => '---- Select ----')); ?>
                </div>-->
                <div class="form-group">
