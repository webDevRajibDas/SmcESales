		...
		<div class="box box-primary">
			...
			<div class="box-body">
				<div class="search-box">
					<?php echo $this->Form->create('ProductMeasurement', array('role' => 'form','action'=>'filter')); ?>
					<table class="search">
						<tr>
							<td width="60%">
								<?php echo $this->Form->input('product_category_id', array('class' => 'form-control','required'=>false,'options'=>$product_cat_list,'empty'=>'---- Select ----','id'=>'product_category_id')); ?>
							</td>
							<td width="40%">							
								<?php echo $this->Form->input('product_id', array('class' => 'form-control','required'=>false,'empty'=>'---- Select ----','id'=>'product_id')); ?>
							</td>							
						</tr>										
						<tr align="center">
							<td colspan="2">
                ...
                <table id="ProductMeasurements" class="table table-bordered table-striped">
					...
					<tr>
						...
						<td class="text-center"><?php echo h($productMeasurement['Product']['name']); ?></td>
						<td class="text-center"><?php echo h($productMeasurement['MeasurementUnit']['name']); ?></td>
						<td class="text-center">
						<?php
							if($productMeasurement['ProductMeasurement']['is_base']==1){
								echo h('Yes');
							}else{
								echo h('No');
							}
						...
						<td class="text-center">
						<?php
							if($productMeasurement['ProductMeasurement']['is_active']==1){
								echo h('Yes');
							}else{
								echo h('No');
							}
...
$(document).ready(function() {
	$('#product_category_id').selectChain({
		target: $('#product_id'),
		value:'title',
		url: '<?= BASE_URL.'product_combinations/get_product_list'?>',
		type: 'post',
