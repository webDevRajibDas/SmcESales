    ...
    <div class="col-md-12">
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><i class="glyphicon glyphicon-edit"></i>  <?php echo __('Edit Product Measurement'); ?></h3>
			...
			<?php echo $this->Form->create('ProductMeasurement', array('role' => 'form')); ?>
				...
				<div class="form-group">
					<?php echo $this->Form->input('is_base', array('class' => 'form-control','type'=>'checkbox','label'=>'<b>Is Base :</b>')); ?>
				</div>
				<div class="form-group">
