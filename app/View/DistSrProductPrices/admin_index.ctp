				...
				<table id="ProductCategories" class="table table-bordered table-striped">
					...
					<tr>
						...
						<td class="text-center">
                            ...
                            <?php echo $this->Html->link('Set Combined Price', array('controller' => 'dist_sr_product_combinations','action'=>'index', $product['Product']['id']), array('class' => 'btn btn-primary btn-xs', 'escape' => false, 'data-toggle'=>'tooltip', 'title' => 'Set Combined Price'));  ?>
