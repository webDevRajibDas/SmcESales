			...
			<div class="box-body">
                <table id="Districts" class="table table-bordered table-striped">
					...
					<tr>
						...
						<td class="text-center"><?php echo h($district['District']['name']); ?></td>
						<td class="text-center">
							<?php if($this->App->menu_permission('districts','admin_view')){ echo $this->Html->link(__('<i class="glyphicon glyphicon-eye-open"></i>'), array('action' => 'view', $district['District']['id']), array('class' => 'btn btn-primary btn-xs', 'escape' => false, 'data-toggle'=>'tooltip', 'title' => 'view')); } ?>
