	...
	<div class="col-md-12">
		<div class="box box-primary">
			...
			<!--<div class="form-group">
				<?php //echo $this->Form->input('tso_id', array('id'=> 'tso_id', 'class' => 'form-control','empty'=>'---- Select Tso ----','options'=>$tsos,'required'=>true)); ?>
			</div>-->

			<div class="form-group">
				<?php echo $this->Form->input('receiver_store_id', array('id'=> 'receiver_store_id', 'class' => 'form-control','empty'=>'---- Select DB ----', 'options'=>$distdistributors, 'required'=>true)); ?>
			</div>
			<div class="form-group">
...
<script>	
	...
	$(document).ready(function(){
		$('#tso_id').change(function() {
			$.ajax({
				type: "POST",
				url: '<?= BASE_URL ?>dist_ncp_product_issues/get_db_list',
				data: 'tso_id=' + $('#tso_id').val(),
				cache: false,
				success: function(response) {
					$('#receiver_store_id').html(response);
				}
			});
		});
