                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <div id="market_list" class="input select" style="float:left; width:80%; padding-left:0px;">
                                    <div class="selection" style="float:left; width:100%; padding:5px 5px 5px 30px; border:#ccc solid 1px; height:auto; overflow:auto">
                                        <?php //echo $this->Form->input('product_type', array('id' => 'product_type', 'label'=>false, 'class' => 'product_type checkbox', 'fieldset' => false, 'multiple' => 'checkbox', 'required'=> true, 'options'=> $product_type_list)); 
                                        ?>
                                    </div>
                                </div> -->
    ...
    $('#office_id').change(function() {
        ...
        if (date_from && date_to) {
            $.ajax({
                ...
                url: '<?= BASE_URL ?>sales_reports/get_territory_so_list',
