    ...
    <div class="col-md-12">
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><i class="glyphicon glyphicon-edit"></i>  <?php echo __('Add/Edit BSP Program'); ?></h3>
				<div class="box-tools pull-right">
					<?php echo $this->Html->link(__('<i class="glyphicon glyphicon-th-large"></i> BSP Program List'), array('action' => 'larc_program_list'), array('class' => 'btn btn-primary', 'escape' => false)); ?>
				</div>
			</div>
			<div class="box-body">		
				...
				{	
				?>
				<?php echo $this->Form->create('Program', array('role' => 'form','action'=>'add_bsp_list')); ?>
				...
				<table class="table table-bordered table-striped outlet_list">
					...
					$program_info = $ProgramsController->get_program_info($doctor_id=0, $request_data, $outlet_id=$val[0]['outlet_id'], $program_type_id=2);
					//pr($program_info);
					?>
                    <tr>
						<td class="text-center">							
