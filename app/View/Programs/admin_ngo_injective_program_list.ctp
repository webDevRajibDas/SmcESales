	...
	<div class="col-xs-12">
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><i class="glyphicon glyphicon-th-large"></i> <?php echo __('NGO For Injectable Outlet List'); ?></h3>
				<div class="box-tools pull-right">
					<?php if ($this->App->menu_permission('programs', 'admin_add_ngo_injective')) {
						echo $this->Html->link(__('<i class="glyphicon glyphicon-plus"></i> Add/Edit NGO For Injectable Outlets'), array('action' => 'add_ngo_injective'), array('class' => 'btn btn-primary', 'escape' => false));
					} ?>
				</div>
			</div>
			<div class="box-body">
				<div class="search-box">
					...
					<table class="search">
						<tr>
							<td width="50%">
								<?php echo $this->Form->input('program_type_id', array('type' => 'hidden', 'value' => 5)); ?>
				...
				<table id="BonusCards" class="table table-bordered table-striped">
					...
					<tbody>
						...
						<td class="text-left"><?php echo h($program['Outlet']['ownar_name']); ?></td><?php */ ?>
								...
								<td class="text-center">
									<?php if ($this->App->menu_permission('programs', 'admin_edit_ngo_injective')) {
										echo $this->Html->link(__('<i class="glyphicon glyphicon-pencil"></i>'), array('action' => 'edit_ngo_injective', $program['Program']['id']), array('class' => 'btn btn-warning btn-xs', 'escape' => false, 'data-toggle' => 'tooltip', 'title' => 'Deassigned'));
									} ?>
								</td>
							</tr>
						<?php endforeach; ?>
