    ...
    <div class="col-md-12">
		<div class="box box-primary">
			...
			<div class="form-group">
				<?php echo $this->Form->input('receiver_store_id', array('id'=> 'receiver_store_id', 'class' => 'form-control','options'=>$receiverStore,'selected'=>$ncp_challan_draft_info[0]['Challan']['receiver_store_id'],'required'=>true)); ?>
			</div>
			<div class="form-group">
			...
			<table class="table table-striped table-condensed table-bordered invoice_table">
				...
				<tbody>
				    ...
				    foreach ($ncp_challan_draft_info[0]['ChallanDetail'] as $value) {
