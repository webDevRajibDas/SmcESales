    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title"><i class="glyphicon glyphicon-edit"></i>  <?php echo __('New Challan'); ?></h3>
...
/*Challan Datepicker : End*/
    ...
    $(document).ready(function () {
        ...
        /*$('#product_type').change(function(){
            $.ajax({
                url: '<?= BASE_URL.'Challans/get_product_list'?>',
                type: 'POST',
                ...
                success:function(response){
                    ...
                    var options='';
                   for(x in response){
                    options+='<option '+x+'>'+response[x]+'</option>'
                   }
