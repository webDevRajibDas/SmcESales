...
<script>
    ...
    $('body').on('click','.find',function() {
        ...
        ({
            type: "POST",
            url: '<?=BASE_URL?>distributor_date_editable_permissions/get_order_recommended_list',
            data: 
            {
                office_id:office_id,
                date_from:date_from,
                ...
                for(var i = 0; i<obj.length; i++){
                    ...
                    '<tr id ="table_row_'+id+'">\
                        ...
                        <td class ="recommender_note" >\
                            <input type ="text" class="recommender_note" name="data[DistributorDateEditablePermission][recommender_note]" id="recommender_note_'+id+'">\
                        </td>\
    ...
    function collection_recommended(id){
        ...
        if(recommender_note == ''){
            ...
            ({
                type: "POST",
                url: '<?=BASE_URL?>distributor_date_editable_permissions/order_recommended',
