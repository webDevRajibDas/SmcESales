        ...
        <div class="box box-primary">
			...
			<?php echo $this->Form->create('Challan', array('role' => 'form')); ?>
                <div class="form-group">
                            <?php echo $this->Form->input('receiver_store_id', array('class' => 'form-control','options'=>$receiverStore,'required'=>true,'default'=>$challan_info['Challan']['receiver_store_id'])); ?>
                </div>
                <div class="form-group">
                            <?php echo $this->Form->input('challan_date', array('label'=>'Product Issue Date','type'=>'text','class' => 'form-control datepicker','required'=>true, 'value'=>$challan_info['Challan']['challan_date'])); ?><span style="color:red">*</span>
                </div>
                <div class="form-group">
