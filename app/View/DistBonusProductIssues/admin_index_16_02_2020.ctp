		...
		<div class="box box-primary">
			...
			<div class="box-body">
				...
				<table id="Challan" class="table table-bordered table-striped">
					...
					<tr>
						<td align="center"><?php echo h($challan['DistChallan']['id']); ?></td>
						...
						<td class="text-center">
							<?php if($this->App->menu_permission('challans','admin_view')){ echo $this->Html->link(__('<i class="glyphicon glyphicon-eye-open"></i>'), array('action' => 'view', $challan['DistChallan']['id']), array('class' => 'btn btn-primary btn-xs', 'escape' => false, 'data-toggle'=>'tooltip', 'title' => 'view')); } ?>
							<?php
							if ($challan['DistChallan']['status'] == 0) {
								if($this->App->menu_permission('memos','admin_edit')){ echo $this->Html->link(__('<i class="glyphicon glyphicon-pencil"></i>'), array('action' => 'edit', $challan['DistChallan']['id']), array('class' => 'btn btn-warning btn-xs', 'escape' => false, 'data-toggle'=>'tooltip', 'title' => 'edit')); } 
							}
							?>
						</td>
					</tr>
