        ...
        <div class="box box-primary">
            <div class="box-header">
                ...
                <div class="box-tools pull-right">
					<?php if($this->App->menu_permission('dist_bonus_product_issues','admin_add')){ echo $this->Html->link(__('<i class="glyphicon glyphicon-plus"></i> Create New'), array('action' => 'add'), array('class' => 'btn btn-primary', 'escape' => false)); } ?>
				</div>
            </div>	
            <div class="box-body">
                    ...
                    <table class="search">
                        ...
                        <tr>
                            <td width="50%">                              
                                ...
                                <?php echo $this->Form->input('is_bonus_challan', array('type'=>'hidden','class' => 'form-control', 'required' => false,'value'=>'1')); ?>
                            </td>
                            <td width="50%"><?php echo $this->Form->input('status', array('class' => 'form-control', 'type' => 'select', 'required' => false, 'empty' => '---- Select ----', 'options' => array(1 => 'Pending', 2 => 'Received'))); ?>
                            </td>							
                        </tr>					
                        <tr>
                            <td>
...
foreach ($challans as $challan):
    ?>					
                                <tr>
                                    ...
                                    echo $distributors_all[$d_id]; ?></td>
                                    <td align="center"><?php echo $this->App->dateformat($challan['DistChallan']['received_date']); ?></td>
                                    <td align="center">
                                        <?php
                                    ...
                                    <td class="text-left"><?php echo h($challan['DistChallan']['remarks']); ?></td>
                                    <td class="text-center">

                                        <?php 
                                        if ($this->App->menu_permission('dist_bonus_product_issues', 'admin_view')) {
                                        ...
                                        <?php
											if ($challan['DistChallan']['status'] == 0) {
												if($this->App->menu_permission('dist_bonus_product_issues','admin_edit')){ echo $this->Html->link(__('<i class="glyphicon glyphicon-pencil"></i>'), array('action' => 'edit', $challan['DistChallan']['id']), array('class' => 'btn btn-warning btn-xs', 'escape' => false, 'data-toggle'=>'tooltip', 'title' => 'edit')); } 
											}
											?>
                                    </td>
                                </tr>
