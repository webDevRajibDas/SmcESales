			...
			<div class="box-body">
				...
				<table id="ProductCategories" class="table table-bordered table-striped">
					...
					<tr>
						...
						<?php if($product_price['ProductPrice']['effective_date'] >= $product_prices[0]['ProductPrice']['effective_date']){?>
							<?php echo $this->Html->link('Edit Price', array('action' => 'set_price',$product_price['ProductPrice']['product_id'],$product_price['ProductPrice']['id']), array('class' => 'btn btn-primary btn-xs', 'escape' => false, 'data-toggle'=>'tooltip', 'title' => 'Edit Price'));  ?>
						<?php }else{?>
							<?php echo $this->Html->link('View Price', array('action' => 'view_price',$product_price['ProductPrice']['product_id'],$product_price['ProductPrice']['id']), array('class' => 'btn btn-info btn-xs', 'escape' => false, 'data-toggle'=>'tooltip', 'title' => 'View Price'));  ?>
						<?php } ?>
						</td>
					</tr>
					<?php endforeach; ?>
