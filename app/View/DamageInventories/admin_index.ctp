			...
			<div class="box-body">
                <div class="search-box">
					...
					<table class="search">
						...
						<tr>
							<td width="50%"><?php echo $this->Form->input('inventory_status_id', array('type'=>'hidden','class' => 'form-control','required'=>false,'value'=>3)); ?></td>
						</tr>
						<tr align="center">
							<td colspan="2">
				...
				<table id="CurrentInventories" class="table table-bordered table-striped">
					...
					<tr>
						...
						<td class="text-center">
							<?php if($this->App->menu_permission('CurrentInventories','admin_view')){ echo $this->Html->link(__('<i class="glyphicon glyphicon-eye-open"></i>'), array('action' => 'viewDetails', $currentInventory['CurrentInventory']['product_id'],$currentInventory['CurrentInventory']['store_id']), array('class' => 'btn btn-primary btn-xs', 'escape' => false, 'data-toggle'=>'tooltip', 'title' => 'View details')); } ?>
						</td>
					</tr>
					<?php endforeach; ?>
					</tbody>
