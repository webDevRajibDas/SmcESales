    ...
    <div class="col-md-12">
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><i class="glyphicon glyphicon-edit"></i>  <?php echo __('Add Transaction Type'); ?></h3>
			...
			<?php echo $this->Form->create('TransactionType', array('role' => 'form')); ?>
				...
				<div class="form-group">
					<?php echo $this->Form->input('adjust', array('class' => 'form-control', 'checked'=>'checked', 'type'=>'checkbox','label'=>'<b>Adjust :</b>')); ?>
				</div>

				<div class="form-group">
					<?php echo $this->Form->input('active_status', array('class' => 'form-control', 'checked'=>'checked', 'type'=>'checkbox','label'=>'<b>Active :</b>')); ?>
				</div>
