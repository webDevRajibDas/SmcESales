    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title"><i class="glyphicon glyphicon-edit"></i>  <?php echo __('Add New Sales Representatives'); ?></h3>
            ...
            <div class="box-body">		
                ...
                <div class="form-group input-group">
                    <div class="input text required ">
                        ...
                        <input style="width:260px;display: inline-block;float:left;" name="data[DistSalesRepresentative][code]" class="form-control" maxlength="255" type="number" value="" id="DistSalesRepresentativeCode_new" readonly>
                    </div>                
                </div>
