    ...
    <div class="col-md-12">
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><i class="glyphicon glyphicon-edit"></i>  <?php echo __('Deassigned Notundin Institute'); ?></h3>
			...
			<div class="box-body">		
			<?php 			
			$deassigned_date = ($this->request->data['NotundinProgram']['deassigned_date']!=NULL ? date('d-m-Y',strtotime($this->request->data['NotundinProgram']['deassigned_date'])) : '');
			echo $this->Form->create('NotundinProgram', array('role' => 'form')); 			
			?>
