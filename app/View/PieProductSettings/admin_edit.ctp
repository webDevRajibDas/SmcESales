    ...
    <div class="col-md-12">
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><i class="glyphicon glyphicon-edit"></i>  <?php echo __('Edit Pie Product Setting'); ?></h3>
			...
			<?php echo $this->Form->create('PieProductSetting', array('role' => 'form')); ?>
				<div class="form-group">
					<?php echo $this->Form->input('brand_id', array('id'=>'brand_id', 'class' => 'form-control chosen','empty'=>'---- Select ----')); ?>
				</div>
				<div class="form-group">
