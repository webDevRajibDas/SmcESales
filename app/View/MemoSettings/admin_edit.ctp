    ...
    <div class="col-md-12">
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><i class="glyphicon glyphicon-edit"></i>  <?php echo __('Edit Product Setting'); ?></h3>
			...
			<?php echo $this->Form->create('ProductSetting', array('role' => 'form')); ?>
				<div class="form-group">
					<?php echo $this->Form->input('product_id', array('id'=>'product_id', 'class' => 'form-control','empty'=>'---- Select ----')); ?>
				</div>
				<div class="form-group">
					<?php echo $this->Form->input('colour', array('class' => 'form-control', 'label' => 'Colour Code :')); ?>
				</div>
				<div class="form-group">
