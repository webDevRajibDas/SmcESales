    ...
    <div class="col-md-12">
		<div class="box box-primary">
			...
			<?php echo $this->Form->create('Memo', array('role' => 'form')); ?>
				...
				<div class="form-group">
					<?php echo $this->Form->input('sales_person_id', array('class' => 'form-control','id'=>'sales_person_id','empty'=>'---- Select Sale Sales Officer ----')); ?>
				...
				<div class="form-group">
					<?php echo $this->Form->input('market_id', array('class' => 'form-control','id'=>'market_id','empty'=>'---- Select Market ----')); ?>
				</div>
				<div class="form-group">
					<?php echo $this->Form->input('outlet_id', array('class' => 'form-control','id'=>'outlet_id','empty'=>'---- Select Outlet Name ----')); ?>
				</div>
				<div class="form-group">
					<?php echo $this->Form->input('entry_date', array('class' => 'form-control datepicker','type'=>'text')); ?>
				</div>
				<div class="form-group">
					<?php echo $this->Form->input('memo_date', array('class' => 'form-control datepicker','type'=>'text')); ?>
				</div>
				<div class="form-group">
				...
				<tbody class="product_row_box">
					<tr>
						...
						<th class="text-center">
							<?php
								echo $this->Form->input('product_id',array('name'=>'data[MemoDetail][product_id][]','class'=>'form-control width_100 product_id','options'=>$product_list,'empty'=>'---- Select Product ----','label'=>false));
							?>
						</th>
						<th class="text-center" width="12%">
							<input type="text" name="" class="form-control width_100 product_unit_name"/>
							<input type="hidden" name="data[MemoDetail][measurement_unit_id][]" class="form-control width_100 product_unit_id"/>
						</th>
						<th class="text-center" width="12%">
							<input type="text" name="data[MemoDetail][Price][]" class="form-control width_100 product_rate"/>
							<input type="hidden" name="data[MemoDetail][product_price_id][]" class="form-control width_100 product_price_id"/>
						</th>
						<th class="text-center" width="12%">
							<input type="number" name="data[MemoDetail][sales_qty][]" class="form-control width_100 min_qty"/>
							<input type="hidden" class="combined_product"/>
						</th>
						<th class="text-center" width="12%">
							<input type="text" name="data[MemoDetail][total_price][]" class="form-control width_100 total_value"/>
						</th>
				...
				<tfoot>
					<tr>
						...
						<td align="center"><input name="data[Memo][gross_value]" class="form-control width_100" type="text" id="gross_value"/>
						</td>
						<td></td>
						<td></td>
					</tr>
...
<script>
	$(document).ready(function(){
		...
		$("body").on("click",".add_more",function(){
			...
			product_box.append('<tr>'+current_row+'</tr>');
		});
		/*------- unset session -------*/
	});
</script>
