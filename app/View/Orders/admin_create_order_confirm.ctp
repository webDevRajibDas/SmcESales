            ...
            <div class="box-body">
               ...
               <?php if($this->Session->read('Office.group_id')==1){ ?>
                <div class="form-group"  id="distribut_id_so">
                    <?php echo $this->Form->input('distribut_outlet_id', array('label' => 'Distributer:', 'id' => 'distribut_outlet_id', 'class' => 'form-control distribut_outlet_id', 'required' => TRUE, 'empty' => '---- Select Dealer ----', 'options' => $distributers)); ?>
                </div>
                 <?php } else {?>
                  <div class="form-group"  id="distribut_id_so">
       ...
       <!--- <div class="form-group"  id="market_id_so">
            <?php echo $this->Form->input('market_id', array('id' => 'market_id', 'class' => 'form-control market_id', 'required' => TRUE, 'empty' => '---- Select Market ----')); ?>
               ...
               <!--  <div class="form-group"  id="outlet_id_so">
                   <?php echo $this->Form->input('outlet_id', array('label' => 'Outlets:', 'id' => 'outlet_id', 'class' => 'form-control outlet_id', 'required' => TRUE, 'empty' => '---- Select Dealer ----', 'options' => $outlets)); ?>
               </div> -->
