    ...
    <div class="col-md-12">
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><i class="glyphicon glyphicon-edit"></i>  <?php echo __('Admin Edit Claim'); ?></h3>
			...
			<?php echo $this->Form->create('Claim', array('role' => 'form')); ?>
					...
					<div class="form-group">
						<?php echo $this->Form->input('claim_no', array('class' => 'form-control')); ?>
					</div>
					<div class="form-group">
						<?php echo $this->Form->input('claim_status', array('class' => 'form-control')); ?>
					</div>
					<div class="form-group">
						<?php echo $this->Form->input('claim_type', array('class' => 'form-control')); ?>
					</div>
					<div class="form-group">
