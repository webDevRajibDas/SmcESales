                ...
                <table id="OfficeTypes" class="table table-bordered table-striped">
					<thead>
						<tr>
							...
							<th class="text-center"><?php echo $this->Paginator->sort('sap_office_code'); ?></th>
					...
					<tr>
						...
						<td class="text-left"><?php echo h($office['Office']['sap_office_code']); ?></td>
						<td class="text-left"><?php echo h($office['Office']['short_name']); ?></td>
						...
						<td class="text-left"><?php echo h($office['Office']['order']); ?></td>						
						<td class="text-left"><?php echo h($office['Office']['phone']); ?></td>						
						<td class="text-left"><?php echo h($office['Office']['email']); ?></td>						
						<td class="text-left"><?php echo h($office['Office']['address']); ?></td>						
						<td class="text-left"><?php echo h($office['Office']['longitude']); ?></td>						
						<td class="text-left"><?php echo h($office['Office']['latitude']); ?></td>						
