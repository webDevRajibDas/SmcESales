<?php
App::import('Controller', 'DBWiseTopSheetReportsOldController');
$db_wise_topsheet_report = new DBWiseTopSheetReportsOldController;
?>
    ...
    <div class="col-xs-12">
		<div class="box box-primary">
				...
				<div class="search-box">
                    ...
                    <table class="search">
                        ...
                        <?php if($office_parent_id==0 || $office_parent_id==14){ ?>
                            <tr>
                                <td class="" width="50%"><?php echo $this->Form->input('office_id', array('label' => 'Area Office :', 'id' => 'office_id','class' => 'form-control office_id','required'=>true,'empty'=>'---- All ----')); ?></td>
                                <td></td>
                            </tr>
                        <?php }else{ ?>
                            <tr>
            ...
            <div id="content" style="width:90%;height:100%;margin-left:5%;margin-right:5%; float:left;">
                ...
                .qty_val{ width:90px; margin:0; float:left; text-transform:capitalize;}
                ...
                #sum_table{font-size:75%;}
                .report_table {margin-bottom: 18px; max-width: 100%; width: 100%;}
                .table-responsive {min-height: 0.01%;overflow-x: auto;}
                #sum_table td{padding:5px 0; text-align:center;}
                </style>
                ...
                <div class="table-responsive">
                    ...
                    <?php if(@$product_quantity){ ?>
                        ...
                        {
                            $product_qnty[$data['0']['db_id']][$data['0']['product_id']]=$data['0']['pro_quantity'];
                            $product_price[$data['0']['db_id']][$data['0']['product_id']]=$data['0']['price'];
    						$product_cyp_v[$data['0']['db_id']][$data['0']['product_id']]=$data['0']['cyp_v'];
    						$product_cyp[$data['0']['db_id']][$data['0']['product_id']]=$data['0']['cyp'];
                        }
                        //pr($product_qnty);
						//exit;
                        ?>
                        ...
                        <table id="sum_table" class="text-center report_table" border="1px solid black" cellpadding="10px" cellspacing="0" align="center">
                              ...
                              <tr class="titlerow">
                                  <th><div class="qty_val" style="width:140px;">Distributor</div></th>
                                  <?php foreach($categories_products as $c_value){ ?>
                                    
                                    <?php if($c_value['Product']){ ?>
										<?php foreach ($c_value['Product'] as $p_value){ ?>
                                            <th><div class="qty_val"><?=$p_value['name']?></div></th>
                                        <?php } ?>
                                        <th style="background:#CCF;"><div class="qty_val">Total <?=$c_value['ProductCategory']['name']?></div></th>
                                    <?php } ?>
                                    
                                  <?php } ?>
                                  
                                  <th><div class="qty_val">Total Sales<br>(Tk.)</div></th>
                                  
                                  
                                  <th><div class="qty_val">CYP</div></th>
                                  <th><div class="qty_val">EC Call</div></th>
                              </tr>
                              <?php
                              //pr($sales_people);
