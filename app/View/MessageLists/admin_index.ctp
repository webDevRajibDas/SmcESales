    ...
    <div class="col-xs-12">
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><i class="glyphicon glyphicon-th-large"></i> <?php echo __('Message List'); ?></h3>
				<div class="box-tools pull-right">
					<?php if($this->App->menu_permission('messageLists','admin_add')){ echo $this->Html->link(__('<i class="glyphicon glyphicon-plus"></i> New Message'), array('action' => 'add'), array('class' => 'btn btn-primary', 'escape' => false)); } ?>
				</div>
			</div>	
			<div class="box-body">
                <table id="MessageCategories" class="table table-bordered table-striped">
					<thead>
						<tr>
							...
							<th class="text-center"><?php echo $this->Paginator->sort('sender_id'); ?></th>
					...
					<tr>
						...
						<td class="text-center"><?php echo h($message['SalesPerson']['name']); ?></td>
						<td class="text-center"><?php echo h(($message['MessageCategory']['title']?$message['MessageCategory']['title']:'From SO')); ?></td>
