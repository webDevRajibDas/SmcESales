    ...
    <div class="col-md-12">
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><i class="glyphicon glyphicon-edit"></i>  <?php echo __('Edit Sales Person'); ?></h3>
			...
			<div class="box-body">		
				<?php echo $this->Form->create('SalesPerson', array('role' => 'form')); ?>
					...
					<div class="form-group">
					<?php echo $this->Form->input('territory_id', array('class' => 'form-control','empty'=>'---- Select ----','id'=>'territory_id','options'=>$territory_list)); ?>
				</div>
