    ...
    <div class="col-xs-12">		
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><i class="glyphicon glyphicon-eye-open"></i> <?php  echo __('Thana'); ?></h3>
		...
		<td>
			<?php echo h($thana['Thana']['id']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('Name'); ?></strong></td>
		<td>
			<?php echo h($thana['Thana']['name']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('District'); ?></strong></td>
		<td>
			<?php echo $this->Html->link($thana['District']['name'], array('controller' => 'districts', 'action' => 'view', $thana['District']['id']), array('class' => '')); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('Is Active'); ?></strong></td>
		<td>
			<?php echo h($thana['Thana']['is_active']); ?>
			&nbsp;
		</td>
</tr>					</tbody>
				</table>
		...
		<th class="text-center"><?php echo __('Is Active'); ?></th>
							...
							<tbody>
									<?php
										$i = 0;
										foreach ($thana['Market'] as $market): ?>
		<tr>
