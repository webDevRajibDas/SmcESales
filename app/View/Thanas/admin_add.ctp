    ...
    <div class="col-md-12">
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><i class="glyphicon glyphicon-edit"></i>  <?php echo __('Add Thana'); ?></h3>
			...
			<?php echo $this->Form->create('Thana', array('role' => 'form')); ?>
				...
				<div class="form-group">
					<?php echo $this->Form->input('district_id', array('class' => 'form-control','empty'=>'---- Select ----')); ?>
				</div>
				<div class="form-group">
