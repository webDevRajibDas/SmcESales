			...
			else
			{
				...
				$.ajax({
					...
					success: function(response){						
						...
						var recRow = '<tr class="s_table_row" id="s_rowCount'+s_rowCount+'"><td align="center">'+s_rowCount+'</td><td><input type="hidden" name="s[selected_product_id][]" class="selected_product_id" value="'+obj.Product.id+batch_no+expire_date+'"/>'+obj.Product.name+'<input type="hidden" name="s[product_id][]" value="'+obj.Product.id+'"/></td><td align="center"><input type="hidden" name="s[batch_no][]" value="'+batch_no+'">'+batch_no+'</td><td align="center"><input type="hidden" name="s[expire_date][]" value="'+expire_date+'">'+display_exp_date+'</td><td align="center">'+obj.ReturnMeasurementUnit.name+'<input type="hidden" name="s[measurement_unit][]" value="'+obj.Product.return_measurement_unit_id+'"></td><td align="center"><input type="hidden" name="s[quantity][]" class="p_quantity" value="'+quantity+'">'+quantity+'</td><td align="center"><input type="hidden" name="s[gross_value][]" class="p_gross_value" value="'+gross_value+'">'+gross_value+'</td><td align="center"><input type="text" class="full_width form-control" name="s[remarks][]"></td><td align="center"><button class="btn btn-danger btn-xs s_remove" value="'+s_rowCount+'"><i class="fa fa-times"></i></button></td></tr>';
