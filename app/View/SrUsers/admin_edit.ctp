...
<div class="row">
    <div class="col-md-12">
		<div class="box box-primary">
			...
			<div class="box-body">		
			<?php echo $this->Form->create('SrUser'); ?>
				...
				<div class="form-group">
					<?php echo $this->Form->input('dist_distributor_id', array('class' => 'form-control dist_distributor_id','empty'=>'---- Select ----','id'=>'dist_distributor_id','options'=>$dist_distributors,'selected'=>$dist_distributor_id)); ?>
				</div>
				<div class="hide">
					<?php echo $this->Form->input("user_group_id", array('class' => 'form-control hide','id'=>'user_group_id','lable'=>false)); ?>
				</div>
				<div class="form-group">
					<?php echo $this->Form->input('username', array('label' => 'Username (Use employee ID here) :','id'=>'username', 'class' => 'form-control username')); ?>
...
$(document).ready(function(){    
	$(".username").keyup(function(){  
		var user_id = '<?php echo $this->request->data['SrUser']['id'];?>';
	...
	$(".code").keyup(function(){  
		var id = '<?php echo $this->request->data['SrUser']['sales_person_id'];?>';		
		var code = $(this).val();   
		if(code.length > 2)
		{  
	...
	$('#user_group_id').change(function(){
		...
		if(user_group == 1032){
			...
			success : function(data){
					...
					$('.sr_id').html('<option value="">---- Select ----');
					console.log(json);
