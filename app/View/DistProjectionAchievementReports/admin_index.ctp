<?php
App::import('Controller', 'DistProjectionAchievementReportsController');
$ProjectionAchievementController = new DistProjectionAchievementReportsController;
?>
...
<div class="row">
    ...
    <div class="box box-primary">
      ...
      <div class="box-header">
        <h3 class="box-title"><i class="glyphicon glyphicon-th-large"></i> <?php echo __('Distributor Projection and Achievement Analysis Report'); ?></h3>
      ...
      <div class="box-body">
          ...
          <?php echo $this->Form->create('DistProjectionAchievementReports', array('role' => 'form', 'action'=>'index')); ?>
          <table class="search">
            ...
            <tr>
              <td><?php echo $this->Form->input('sr_id', array('label'=>'SR:','id' => 'sr_id','class' => 'form-control sr_id', 'required'=>false, 'empty'=>'---- All ----')); ?></td>
              <td>
...
$('.office_id').selectChain({
  target: $('#sr_id'),
  value:'name',
  url: '<?= BASE_URL.'DistProjectionAchievementReports/get_sr_list'?>',
  type: 'post',
...
$(document).ready(function(){
  ...
  $( "#DistProjectionAchievementReportsIndexForm" ).submit(function( event ) {   

  var checked_indicator = $("[name='data[DistProjectionAchievementReports][indicators][]']:checked").length;    

  //var checked_indicator_unit=$("[name='data[DistProjectionAchievementReports][indicator_unit][]']:checked").length;
