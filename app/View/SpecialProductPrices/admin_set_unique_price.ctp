		...
		<div class="box box-primary">
			<div class="box-header">
				...
				<div class="box-tools pull-right">
					<?php if($this->App->menu_permission('special_product_prices','admin_price_list')){ echo $this->Html->link(__('<i class="glyphicon glyphicon-plus"></i> Price List'), array('action' => "admin_price_list/$product_id"), array('class' => 'btn btn-primary', 'escape' => false)); } ?>		
				</div>
			</div>	
			<div class="box-body">				
				...
				?>
					...
					<div class="form-group"><label>Price :</label><input class="form-control" name="data[SpecialProductCombination][update_price][<?=$this->request->data['SpecialProductCombination'][$key]['id'];?>]" value="<?=$this->request->data['SpecialProductCombination'][$key]['price'];?>" type="text"></div>
				<?php 
					}
				}
				?>
...
$(document).ready(function (){
    ...
    $(add_button).click(function(e){ 
        ...
        if(x < max_fields){ 
            x++; 
            $(wrapper).append('<div class="slap_set"><div class="form-group"><label>MinQty :</label><input class="form-control" name="data[SpecialProductCombination][min_qty][]" type="text" required></div><div class="form-group"><label for="price">Price :</label><input class="form-control" name="data[SpecialProductCombination][price][]" type="text" required></div><label></label><a href="#" class="remove_field btn btn-primary btn-xs">Remove</a></div>'); 
        }
    });
