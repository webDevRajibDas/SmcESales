<?php //echo 'done';?><div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            <h3 class="box-title"><i class="glyphicon glyphicon-th-large"></i> <?php echo __('Credit Note Add'); ?></h3>
			...
			<?php echo $this->Form->create('CreditNote', array('role' => 'form')); ?>
                ...
                <div class="form-group">
				    <?php echo $this->Form->input('office_id', array('class' => 'form-control', 'id'=>"office_id", 'empty'=>'----Select Office----',  'options'=>$offices, 'required'=>true,)); ?>
                </div>

                <div class="form-group" id="territory_id_div">
                    <?php echo $this->Form->input('territory_id', array('id' => 'territory_id', 'class' => 'form-control territory_id', 'required' => TRUE, 'empty' => '---- Select Territory ----')); ?>
                </div>
                ...
                <div class="form-group" id="outlet_id_so">
                    <?php echo $this->Form->input('outlet_id', array('id' => 'outlet_id', 'class' => 'form-control', 'required' => TRUE, 'empty' => '---- Select Outlet ----')); ?>
                </div>
...
<div class="pull-right">
            ...
            <?php echo $this->Form->submit('Submit', array('class' => 'btn btn-large btn-warning draft', 'div'=>false, 'name'=>'draft')); ?>
            </div>
