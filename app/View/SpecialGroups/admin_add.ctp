    ...
    <div class="col-md-12">
		<div class="box box-primary">
			...
			<?php echo $this->Form->create('SpecialGroup', array('role' => 'form')); ?>
				...
				<div class="form-group">
					<?php echo $this->Form->input('is_territory', array('label'=>'<b>Territory Add :</b>','type'=>'checkbox','class' => 'checkbox-inline is_territory','div'=>false)); ?>
				</div>
				...
				<div class="form-group">
					<?php echo $this->Form->input('outlet_group_id', array('id' => 'outlet_group_id','class' => 'form-control outlet_group_id chosen div_select', 'multiple' => true, 'options' => $outlet_groups, 'name'=>'data[SpecialGroup][outlet_group_id]', 'required'=>false)); ?>
				</div>
