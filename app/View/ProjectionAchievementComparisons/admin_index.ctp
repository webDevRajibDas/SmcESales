...
<div class="row">
    ...
    <div class="box box-primary">
      ...
      <div class="box-header">
        <h3 class="box-title"><i class="glyphicon glyphicon-th-large"></i> <?php echo __('Projection and Achievement Comparison Report'); ?></h3>        
      </div>
            
              
      <div class="box-body">        
        <div class="search-box">
          <?php echo $this->Form->create('ProjectionAchievementComparisons', array('role' => 'form', 'action'=>'index')); ?>
          <table class="search">
            ...
            <tr>
              <td width="50%"><?php echo $this->Form->input('duration_type', array('label' => 'Duration Type :', 'id' => 'duration_type', 'options' => $duration_types, 'class' => 'form-control','required'=>true,)); ?></td>
              <td></td>             
            </tr>
            
            <tr>
              <td width="50%"><?php echo $this->Form->input('duration_particular', array('label' => 'Particular :', 'id' => 'duration_particular', 'options' => $selected_duration_particulars, 'class' => 'form-control','required'=>true,)); ?></td>
              <td></td>             
            </tr>
            
             <tr>
              <td width="50%"><?php echo $this->Form->input('past_year', array('label' => 'Comparison with :', 'id' => 'past_year', 'options' => $past_years, 'class' => 'form-control','required'=>true,)); ?></td>
              <td>Year</td>             
            </tr>
              ...
              <?php echo $this->Form->input('columns', array('legend'=>'Columns :', 'class' => 'columns', 'type' => 'radio', 'default' => 'product', 'options' => $columns, 'required'=>true));  ?></td>    
                      ...
                      <tr>
                          <td>
              <?php echo $this->Form->input('indicator_unit', array('legend'=>'Indicator Unit :', 'class' => 'indicator_unit', 'type' => 'radio', 'default' => '1', 'options' => $indicator_units, 'required'=>true));  ?></td>    
                            <td></td>
            </tr>
                ...
                <div class="table-responsive">
                      ...
                      <div class="pull-right csv_btn" style="padding-top:20px;">
                        ...
                        <div style="float:left; width:100%; text-align:center; padding:20px 0; clear:both;">
                            ...
                            <h3 style="margin:2px 0;">Projection and Achievement Comparison Report</h3>
...
$(document).ready(function(){
  var json_duration_particulars=<?php echo $json_duration_particulars;?>;
  ...
  $( "#ProjectionAchievementComparisonsIndexForm" ).submit(function( event ) {   

  var checked_indicator = $("[name='data[ProjectionAchievementComparisons][indicators][]']:checked").length;    
  ...
  /* Onchanhe Duration Type , retrieve Particular */
    $('#duration_type').change(function() {   
        var selected_type=this.value;
       
       if(selected_type)
       {                          
           var particular_options = $("#duration_particular");
           var json_data=json_duration_particulars[selected_type];
           ...
           $.each(json_data, function(key, value){
            ...
            $("#duration_particular").html(options);
       }
    });
