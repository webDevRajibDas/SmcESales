        ...
        <div class="box box-primary">
            ...
            <div class="box-body">		
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <?php
                        echo $this->Form->input('ae_name', array('label'=>'Area Executive :','id'=>'ae_name','class' => 'form-control', 'required' => true, 'type' => 'text','value'=>"$ae_name",'readonly'));
                   ?>
                 </div>
                 
                 <div class="form-group">
                    <?php
                        echo $this->Form->input('tso_name', array('label'=>'TSO :','id'=>'tso_name','class' => 'form-control', 'required' => true, 'type' => 'text','value'=>"$tso_name",'readonly'));
                   ?>
                 </div>
                ...
                <?php echo $this->Form->input('dist_tso_id', array('type'=>'hidden','id' => 'dist_tso_id', 'class' => 'form-control')); ?>
                <?php echo $this->Form->input('dist_ae_id', array('type'=>'hidden','id' => 'dist_ae_id', 'class' => 'form-control')); ?>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td width="19%" align="center">							
                                <?php echo $this->Form->input('measurement_unit_id', array('id' => 'measurement_unit_id', 'label' => false, 'class' => 'full_width form-control', 'required' => false,'options'=>array())); ?>
                            </td>
