    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title"><i class="glyphicon glyphicon-edit"></i>  <?php echo __('Edit SR Outlet'); ?></h3>
            ...
            <div class="box-body">		
                ...
                <div class="form-group">
                    <?php echo $this->Form->input('dist_market_id', array('id' => 'dist_market_id','label'=>'Distributor Market', 'class' => 'form-control', 'empty' => '---- Select ----','options' => $distmarkets)); ?>
                </div>
...
<script>
    $(document).ready(function () {
        $(".chosen").chosen();
        $('.institute_id').hide();
        var is_ngo_val = '<?php echo $this->data['DistOutlet']['is_ngo']; ?>';
        if (is_ngo_val == '1')
        {
            $('.institute_id').show();
        }
