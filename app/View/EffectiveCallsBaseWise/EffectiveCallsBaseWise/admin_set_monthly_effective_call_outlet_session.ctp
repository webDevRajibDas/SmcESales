                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-left">
                                <div class="form-group">
                                    <?php echo $this->Form->input('assign_outlet_coverage_pharma', array('class' => 'form-control-1 assign_outlet_coverage_pharma', 'label' => '', 'value' => '0')); ?>
                                </div>
                            </td>
                            <td class="text-left">
                                <div class="form-group">
                                    <?php echo $this->Form->input('assign_outlet_coverage_non_pharma', array('class' => 'form-control-1 assign_outlet_coverage_non_pharma', 'label' => '', 'value' => '0')); ?>
                                </div>
                            </td>
                            <td class="text-left">
                                <div class="form-group">
                                    <?php echo $this->Form->input('assign_effective_call_pharma', array('class' => 'form-control-1 assign_effective_call_pharma', 'label' => '', 'value' => '0')); ?>
                                </div>
                            </td>
                            <td class="text-left">
                                <div class="form-group">
                                    <?php echo $this->Form->input('assign_effective_call_non_pharma', array('class' => 'form-control-1 assign_effective_call_non_pharma', 'label' => '', 'value' => '0')); ?>
                                </div>
                            </td>
                            <td class="text-left">
                                <div class="form-group">
                                    <?php echo $this->Form->input('assign_session', array('class' => 'form-control-1 assign_session', 'label' => '', 'value' => '0')); ?>
                                </div>
                            </td>
                        </tr>
                    </tbody>
                                ...
                                foreach ($month_list as $key => $val):
                                    ...
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <?php echo $this->Form->input('', array('label' => 'Outlet Coverage (Pharma)', 'id' => "SaleTargetMonth_quantity_$key", 'class' => 'assign base_outlet_coverage_pharma', 'name' => 'data[SaleTargetMonth][outlet_coverage_pharma][' . $key . ']', 'value' => (isset($sale_target_month_data[$i]['SaleTargetMonth']['outlet_coverage_pharma'])) ? $sale_target_month_data[$i]['SaleTargetMonth']['outlet_coverage_pharma'] : 0)); ?>

                                        </div>
                                        <div class="form-group">
                                            <?php echo $this->Form->input('', array('label' => 'Outlet Coverage (Non Pharma)', 'class' => 'form-control-new assign base_outlet_coverage_non_pharma', 'name' => 'data[SaleTargetMonth][outlet_coverage_non_pharma][' . $key . ']', 'value' => (isset($sale_target_month_data[$i]['SaleTargetMonth']['outlet_coverage_non_pharma'])) ? $sale_target_month_data[$i]['SaleTargetMonth']['outlet_coverage_non_pharma'] : 0)); ?>
                                        </div>
                                        <div class="form-group">
                                            <?php echo $this->Form->input('', array('label' => 'Effective Call (Pharma)', 'class' => 'form-control-new assign base_effective_call_pharma', 'name' => 'data[SaleTargetMonth][effective_call_pharma][' . $key . ']', 'value' => (isset($sale_target_month_data[$i]['SaleTargetMonth']['effective_call_pharma'])) ? $sale_target_month_data[$i]['SaleTargetMonth']['effective_call_pharma'] : 0)); ?>
                                        </div>
                                        <div class="form-group">
                                            <?php echo $this->Form->input('', array('label' => 'Effective Call (Non Pharma)', 'class' => 'form-control-new assign base_effective_call_non_pharma', 'name' => 'data[SaleTargetMonth][effective_call_non_pharma][' . $key . ']', 'value' => (isset($sale_target_month_data[$i]['SaleTargetMonth']['effective_call_non_pharma'])) ? $sale_target_month_data[$i]['SaleTargetMonth']['effective_call_non_pharma'] : 0)); ?>
                                        </div>
                                        <div class="form-group">
                                            <?php echo $this->Form->input('', array('label' => 'Session', 'class' => 'form-control-new assign base_session', 'name' => 'data[SaleTargetMonth][session][' . $key . ']', 'value' => (isset($sale_target_month_data[$i]['SaleTargetMonth']['session'])) ? $sale_target_month_data[$i]['SaleTargetMonth']['session'] : 0)); ?>
                                            <?php echo $this->Form->input('', array('type' => 'hidden', 'class' => 'form-control saleTargetId', 'name' => 'data[SaleTargetMonth][id][' . $key . ']', 'value' => (isset($sale_target_month_data[$i]['SaleTargetMonth']['id'])) ? $sale_target_month_data[$i]['SaleTargetMonth']['id'] : 0)) ?>
                                        </div>
                                    </td>
                                    <?php
                                    $i++;
