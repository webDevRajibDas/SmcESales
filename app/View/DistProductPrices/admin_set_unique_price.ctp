		...
		<div class="box box-primary">
			...
			<div class="box-body">				
				...
				?>
					...
					<div class="form-group"><label>Price :</label><input class="form-control" name="data[DistProductCombination][update_price][<?=$this->request->data['DistProductCombination'][$key]['id'];?>]" value="<?=$this->request->data['DistProductCombination'][$key]['price'];?>" type="text"></div>
				<?php 
					}
				}
				?>
...
$(document).ready(function (){
    ...
    $(add_button).click(function(e){ 
        ...
        if(x < max_fields){ 
            x++; 
            $(wrapper).append('<div class="slap_set"><div class="form-group"><label>MinQty :</label><input class="form-control" name="data[DistProductCombination][min_qty][]" type="text" required></div><div class="form-group"><label for="price">Price :</label><input class="form-control" name="data[DistProductCombination][price][]" type="text" required></div><label></label><a href="#" class="remove_field btn btn-primary btn-xs">Remove</a></div>'); 
        }
    });
