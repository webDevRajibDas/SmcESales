		...
		<div class="box box-primary">
			...
			<div class="box-body">
                <div class="search-box">
					<?php echo $this->Form->create('Product', array('role' => 'form','controller'=>'DistProductPrices','action'=>'filter')); ?>
					<table class="search">
						<tr>
							<td width="50%"><?php echo $this->Form->input('product_category_id', array('id' => 'category_id', 'class' => 'form-control','required'=>false,'empty'=>'---- Select ----')); ?>
								<?php echo $this->Form->input('is_distributor_product', array('id' => 'is_distributor_product','type'=>'hidden', 'class' => 'form-control','value'=> 1)); ?>
							</td>							
							<td></td>
						</tr>																	
						<tr align="center">
				...
				<table id="ProductCategories" class="table table-bordered table-striped">
					...
					<tr>
						...
						<td class="text-center">
                            ...
                            <?php echo $this->Html->link('Set Combined Price', array('controller' => 'dist_product_combinations','action'=>'index', $product['Product']['id']), array('class' => 'btn btn-primary btn-xs', 'escape' => false, 'data-toggle'=>'tooltip', 'title' => 'Set Combined Price'));  ?>
