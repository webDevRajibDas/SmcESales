          ...
          <?php if($this->App->menu_permission('nationalSalesReports', 'admin_add')){ echo $this->Html->link(__('<i class="glyphicon glyphicon-plus"></i> New ProjectionAchievement Setting'), array('action' => 'add'), array('class' => 'btn btn-primary', 'escape' => false)); } ?>
            ...
            <div class="box-body">
                ...
                <div class="search-box">
                    <?php echo $this->Form->create('TransactionListStocks', array('role' => 'form', 'action' => 'index')); ?>
                    <table class="search">
                        <tr>
                                    ...
                                    <table cellspacing="0" cellpadding="10px" border="1px solid black" align="center" class="text-center report_table" id="sum_table">
                                        <thead>
                                            <tr class="titlerow">
                                                ...
                                                <?php foreach ($f_product_list as $product_id => $product_name) { ?>
                                                    <th><?= $product_name ?><br>[<?= $unit_type_text ?>]</th>
                                                <?php } ?>
                                            </tr>
                                        </thead>


                                        <?php if ($f_product_list) { ?>

                                            <tbody>
                                                <?php foreach ($aso_opening_closing_results as $tran_date => $datas) { ?>
                                                    <tr style="font-weight:bold;">
                                                        <td><?= date('d M Y', strtotime($tran_date)) ?></td>
                                                        <td style="text-align:left;">Opening</td>
                                                        <td></td>
                                                        <td></td>
                                                        <td></td>
                                                        <?php foreach ($f_product_list as $product_id => $product_name) { ?>
                                                            <td><?= $datas[$product_id]['opening_balance'] ?></td>
                                                        <?php } ?>
                                                    </tr>
                                                    ...
                                                    $pro_2 = array();
                                                    $pro_total = array();
                                                    if (@$challan_results[$tran_date]) {
                                                        foreach ($challan_results[$tran_date] as $tran_type_id => $challan_datas) {
                                                            foreach ($challan_datas as $challan_no => $p_datas) {
                                                                $c = $tran_type_id == 4 ? 'f8fff9' : 'fdf7f8';
                                                    ?>
                                                                <tr style="background:#<?= $c ?>">
                                                                    <td></td>
                                                                    <td style="text-align:left;"><?= $transaction_types[$tran_type_id] ?></td>
                                                                    <td><?= $challan_no ?></td>
                                                                    <?php
                                                                    $so_name = '';
                                                                    foreach ($f_product_list as $product_id => $product_name) {
                                                                        $so_name = @$p_datas[$product_id]['so_name'];
                                                                        break;
                                                                    }
                                                                    ?>
                                                                    <td style="text-align:left;"><?= @$so_name ?></td>
                                                                    <td style="text-align:left;"><?= @$all_territory_list[$p_datas[$product_id]['territory_id']] ?></td>
                                                                    <?php
                                                                    foreach ($f_product_list as $product_id => $product_name) {
                                                                    ?>
                                                                        <td>
                                                                            <?= @$p_datas[$product_id]['challan_qty'] ?></td>
                                                                    <?php
                                                                        if ($tran_type_id == 4) {
                                                                            @$pro_1[$product_id] += $p_datas[$product_id]['challan_qty'];
                                                                        } else {
                                                                            @$pro_2[$product_id] += $p_datas[$product_id]['challan_qty'];
                                                                        }
                                                                        @$pro_total[$product_id] = $pro_1[$product_id] - $pro_2[$product_id];
                                                                    }
                                                                    ?>
                                                                </tr>
                                                    <?php
                                                    ...
                                                    $r_pro_2 = array();
                                                    $r_pro_total = array();
                                                    if (@$r_challan_results[$tran_date]) {
                                                        foreach ($r_challan_results[$tran_date] as $tran_type_id => $challan_datas) {
                                                            foreach ($challan_datas as $challan_no => $p_datas) {
                                                                $c = $tran_type_id == 19 ? 'f8fff9' : 'fdf7f8';
                                                    ?>
                                                                <tr style="background:#<?= $c ?>">
                                                                    <td></td>
                                                                    <td style="text-align:left;"><?= $transaction_types[$tran_type_id] ?></td>
                                                                    ...
                                                                    <td style="text-align:left;"><?= @$all_territory_list[$p_datas[$product_id]['territory_id']] ?></td>
                                                                    <?php foreach ($f_product_list as $product_id => $product_name) { ?>
                                                                        <td><?= @$p_datas[$product_id]['challan_qty'] ?></td>
                                                                    <?php
                                                                        if ($tran_type_id == 19) {
                                                                            @$r_pro_1[$product_id] += $p_datas[$product_id]['challan_qty'];
                                                                        } else {
                                                                            @$r_pro_2[$product_id] += $p_datas[$product_id]['challan_qty'];
                                                                        }
                                                                        @$r_pro_total[$product_id] = $r_pro_1[$product_id] - $r_pro_2[$product_id];
                                                                    }
                                                                    ?>
                                                                </tr>
                                                    <?php
                                                    ...
                                                    if (@$inventory_adjustment_results[$tran_date]) {
                                                        foreach ($inventory_adjustment_results[$tran_date] as $tran_type_id => $adjust_datas) {
                                                            $c = 'f30b314d';
                                                    ?>
                                                            <tr style="background:#<?= $c ?>">
                                                                <td></td>
                                                                ...
                                                                ?>
                                                                    <td>
                                                                        <?= @$adjust_datas[$product_id]['adjust_qty'] ?></td>
                                                    ...
                                                    if (@$r_dist_issue[$tran_date]) {
                                                        foreach ($r_dist_issue[$tran_date] as $memo_no => $memo_datas) {
                                                            $c = 'f30b314e';
                                                    ?>
                                                            <tr style="background:#<?= $c ?>">
                                                                <td></td>
                                                                <td style="text-align:left;">DB Issue</td>
                                                                <td><?= $memo_no ?></td>
                                                                ...
                                                                foreach ($f_product_list as $product_id => $product_name) {
                                                                ?>
                                                                    <td><?= @$memo_datas[$product_id]['challan_qty'] ?></td>
                                                    ...
                                                    if (@$r_dist_challan_results[$tran_date]) {
                                                        foreach ($r_dist_challan_results[$tran_date] as $challan_no => $challan_datas) {
                                                            $c = '690bf34a';
                                                    ?>
                                                            <tr style="background:#<?= $c ?>">
                                                                <td></td>
                                                                <td style="text-align:left;">DB Return To Area</td>
                                                                <td><?= $challan_no ?></td>
                                                                ...
                                                                foreach ($f_product_list as $product_id => $product_name) {
                                                                ?>
                                                                    <td><?= @$challan_datas[$product_id]['challan_qty'] ?></td>
                                                    ...
                                                    <tr style="background:#c7c7c7;">
                                                        ...
                                                        <?php foreach ($f_product_list as $product_id => $product_name) { ?>
                                                            <td>
                                                                <?= $datas[$product_id]['closing_balance'] ?>
                                                                <?php /*?><?=@sprintf("%01.2f", ($datas[$product_id]['opening_balance']+$pro_total[$product_id]+$r_pro_total[$product_id]))?><?php */ ?>
                                                            </td>
                                                        <?php } ?>
                                                    </tr>
                                                <?php } ?>
