			...
			<?php echo $this->Form->create('DiscountBonusPolicy', array('role' => 'form')); ?>
					...
					<div class="form-group slap_set<?=$i?>">
						...
						<div class="input select">
							...
							<?php foreach($products as $p_key => $p_val){ ?>
								<option value="<?=$p_key;?>" <?php if($this->request->data['DiscountBonusPolicyProduct'][$key]['product_id']==$p_key){ echo 'selected'; } ?>><?=$p_val;?></option>
							<?php } ?>
						</select>
						</div>	
				...
				<div class="policy_options"> 
					...
					<div class="form-group policy_option<?=$i?>">
						<div class="form-group">
							<?php echo $this->Form->input('policy_type', array('type'=>'select', 'label'=>'Policy Option', 'class' => 'form-control','id'=>'policy_type'.$i, 'onChange'=>'showBonusOrDiscount(this.value, '.$i.')', 'options' => $policy_types, 'selected'=>$option_val['policy_type'], 'name'=>'data[DiscountBonusPolicyOption]['.$i.'][policy_type]',)); ?>
						<?php if($i==1){ ?>
						...
						<div class="form-group slab_create_for<?=$i?> slab_create_for">
								<label> </label>
							<?php if(array_search(1, $selected_create_for)!==false){ $selected_slab[$i]['is_so']=$option_val['is_so'];?>
							...
							<?php } ?>
							<?php if(array_search(2, $selected_create_for)!==false){ $selected_slab[$i]['is_sr']=$option_val['is_sr'];?>
								<div class="checkbox-inline create_slab_for">
							...
							<?php } ?>
							<?php if(array_search(3, $selected_create_for)!==false){ $selected_slab[$i]['is_db']=$option_val['is_db'];?>
								<div class="checkbox-inline create_slab_for">
						...
						<div class="exclusion_product <?php if(count($option_val['DiscountBonusPolicyOptionExclusionProduct'])==0) echo 'display_none' ?>">
							...
							<div class="exclusion_<?=$i?>_product_wraps">
								<?php 
								$ex_p=1;
								foreach($option_val['DiscountBonusPolicyOptionExclusionProduct'] as $ex_pro_data)
								{ //pr($ex_pro_data);exit;
								?>
									<div class="form-group <?php if($ex_p>1) echo 'exclusion_product'.$i ?>">
										<?php echo $this->Form->input('exclusion_product_id', array('type'=>'select', 'label'=>'Exclusion Product : ', 'class' => 'form-control', 'empty'=>'---- Select Product ----', 'id'=>'exclusion_product_id'.$i, 'name'=>'data[DiscountBonusPolicyOption]['.$i.'][exclusion_product_id][]','options' => $products,'default'=>$ex_pro_data['product_id'])); ?>
								...
								<div class="form-group">
								<?php echo $this->Form->input('exclusion_product_id', array('type'=>'select', 'label'=>'Exclusion Product : ', 'class' => 'form-control', 'empty'=>'---- Select Product ----', 'id'=>'exclusion_product_id'.$i, 'name'=>'data[DiscountBonusPolicyOption]['.$i.'][exclusion_product_id][]','options' => $products)); ?>
						...
						<div class="inclusion_product <?php if(count($option_val['DiscountBonusPolicyOptionInclusionProduct'])==0) echo 'display_none' ?>">
							<div class="inclusion_<?=$i?>_product_wraps">
								<?php 
								$ex_p=1;
								foreach($option_val['DiscountBonusPolicyOptionInclusionProduct'] as $ex_pro_data)
								{ //pr($ex_pro_data);exit;
								?>
									<div class="form-group <?php if($ex_p>1) echo 'inclusion_product'.$i ?>">
										<?php echo $this->Form->input('inclusion_product_id', array('type'=>'select', 'label'=>'Inclusion Product : ', 'class' => 'form-control', 'empty'=>'---- Select Product ----', 'id'=>'inclusion_product_id'.$i, 'name'=>'data[DiscountBonusPolicyOption]['.$i.'][inclusion_product_id][]','options' => $products,'default'=>$ex_pro_data['product_id'])); ?>
								...
								<?php if(count($option_val['DiscountBonusPolicyOptionInclusionProduct'])==0){ ?>
									<div class="form-group">
									<?php echo $this->Form->input('inclusion_product_id', array('type'=>'select', 'label'=>'Inclusion Product : ', 'class' => 'form-control', 'empty'=>'---- Select Product ----', 'id'=>'inclusion_product_id'.$i, 'name'=>'data[DiscountBonusPolicyOption]['.$i.'][inclusion_product_id][]','options' => $products)); ?>
						...
						<div class="bonus_product <?=($option_val['policy_type']==0?'display_none':'')?>">
							...
							?>
									...
									<?php echo $this->Form->input('bonus_qty', array('type'=>'number', 'label'=>false, 'class' => 'form-control m_select width_5', 'placeholder'=>'Bonus Qty', 'value'=>$p_result['bonus_qty'], 'name'=>' data[DiscountBonusPolicyOption]['.$i.'][bonus_qty][]')); ?>
						...
						<div class="discount_product <?=($option_val['policy_type']==1?'display_none':'')?>">
							<div class="form-group">
								<?php echo $this->Form->input('discount_amount', array('type'=>'text', 'label'=>'Discount Amount', 'class' => 'form-control','id'=>'discount_amount1', 'value'=>$option_val['discount_amount'], 'name'=>'data[DiscountBonusPolicyOption]['.$i.'][discount_amount]')); ?>
								...
								<?php echo $this->Form->input('disccount_type', array('type'=>'select', 'label'=> false, 'class' => 'form-control width_5','id'=>'disccount_type1', 'name'=>'data[DiscountBonusPolicyOption]['.$i.'][disccount_type]', 'selected'=>$option_val['disccount_type'], 'options' => $disccount_types)); ?>
							</div>
								...
								<div class="form-group option<?=$i?>_products_wrap">
									<div class="option<?=$i?>_slap_set<?=$k?>">
										<div class="form-group">
											...
											<select id="so_option<?=$i?>_slab_id<?=$k?>" class="form-control width_15 so_option_slab so_slab_id <?php if($option_val['is_so']==0){echo 'display_none';} ?>" name="data[DiscountBonusPolicyOptionPriceSlab][<?=$i?>][so_slab_id][]">
												
											</select>
											<select id="sr_option<?=$i?>_slab_id<?=$k?>" class="form-control width_15 sr_option_slab sr_slab_id <?php if($option_val['is_sr']==0){echo 'display_none';} ?>" name="data[DiscountBonusPolicyOptionPriceSlab][<?=$i?>][sr_slab_id][]">
												
											</select>
											<select id="db_option<?=$i?>_slab_id<?=$k?>" class="form-control width_15 db_option_slab db_slab_id <?php if($option_val['is_db']==0){echo 'display_none';} ?>" name="data[DiscountBonusPolicyOptionPriceSlab][<?=$i?>][db_slab_id][]">
		...
		<div class="option_'+x+'_product_wraps">\
			<div class="form-group">\
				<div class="input select">\
					...
					<input name="data[DiscountBonusPolicyOption]['+x+'][bonus_qty][]" class="form-control m_select"  type="number" placeholder="Bonus Qty">\
...
function getProductUnits(o, p, product_id, parent_unit_id)
{
	...
	$.ajax({
		...
		success: function(result){			
			...
			$(".option"+o+"_bonus_product"+p+"_wrap").html('<select class="form-control m_select" name="data[DiscountBonusPolicyOption]['+o+'][measurement_unit_id][]">'+result+'</select>');
		}
	});
}
