<div class="row">
    <div class="col-md-12">
		<div class="box box-primary">
			...
			<div class="form-group">
				<?php echo $this->Form->input('inventory_status_id', array('id'=>'inventory_status_id','class' => 'form-control inventory_status_id','empty'=>'---- Select Invetory Status ----','options'=>$inventoryStatus,'required'=>true)); ?><span style="color:red">*</span>
			</div>
