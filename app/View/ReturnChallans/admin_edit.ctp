		...
		<div class="box box-primary">
			...
			<div class="box-body">
				...
				<div class="form-group">
					<?php echo $this->Form->input('receiver_store_id', array('class' => 'form-control', 'empty' => '---- Select Receiver ----', 'options' => $receiverStore, 'required' => true, 'selected' => $draft_info[0]['ReturnChallan']['receiver_store_id'])); ?>
				</div>
				<div class="form-group">
					<?php echo $this->Form->input('remarks', array('class' => 'form-control', 'value' => $draft_info[0]['ReturnChallan']['remarks'])); ?>
				</div>
				<div class="form-group">
					<?php echo $this->Form->input('inventory_status_id', array('id' => 'inventory_status_id', 'class' => 'form-control inventory_status_id', 'empty' => '---- Select Invetory Status ----', 'options' => $inventoryStatus, 'required' => true, 'selected' => $draft_info[0]['ReturnChallan']['inventory_status_id'])); ?>
				</div>
				...
				<table class="table table-striped table-condensed table-bordered invoice_table">
					...
					<tbody>
						...
						foreach ($draft_info[0]['ReturnChallanDetail'] as $value) {
