...
<section class="content admin">	
    	...
    	<div class="col-md-6">
              ...
              <div class="box box-primary">
                <div class="box-header with-border stock_status">
                   	<h3 class="">Yearly Target Vs Achievement</h3>
                </div>
                <div class="box-body">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="">Area Territory Office Sales</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                  <div class="row">
                    ...
                    <div class="col-md-5">
                         ...
                         <ul class="chart-legend clearfix">
							...
							{ 
								...
								if($i==17){$color='5aa6e7';}
								if($i==18){$color='0d3d66';}
								if($i==19){$color='57ad4e';}
								if($i==20){$color='f8e96a';}
								if($i==21){$color='f82557';}
								
								if($i==22){$color='96fbe0';}
								if($i==23){$color='5b75ab';}
								if($i==24){$color='2a6bf1';}
								if($i==25){$color='09f27c';}
								if($i==26){$color='6a0d65';}
							?>
                ...
                <div class="box-footer no-padding">
                  <ul class="nav nav-pills nav-stacked">
                  	<?php foreach($pie_products as $pie_product){ ?>
                    <li><a><?=$pie_product['Product']['name']?> <span class="pull-right text-red"> <?=$DashboardsController->getAreaOfficeTerritorySales(0, $pie_product['PieProductSetting']['product_id'], $office_id);?>%</span></a></li>
                    <?php } ?>
                  </ul>
                </div>
                <!-- /.footer -->
    ...
    <div class="row">
    	<div class="col-md-12">
        	<div class="box box-primary">
            	<div class="box-header with-border stock_status"><h3 class="">Monthly Sales Trend</h3></div>
                <div class="box-body">
                        ...
                        <table class="table no-margin">
                          <thead style="background:#ccc;">
                            <tr>
                                ...
                                <th class="text-right">National SO</th>
                            </tr>
                          </thead>
                        ...
                        <table class="table no-margin">
                          ...
                          <thead>
                            <tr>
                                ...
                                <th class="text-center">Waiting Sync Memos</th><?php */?>
                            </tr>
                          </thead>
                          ...
                          <tbody>
                            ...
                            <tr>
                                ...
                                <td><?=isset($so['time']) ? $this->App->datetimeformat($so['time']) : ''?></td>
...
$( document ).ready(function() {
  ...
  var PieData        = [
	  ...
	  ?>
	  {
      value    : <?=$DashboardsController->getAreaOfficeTerritorySales($key, 0, $office_id);?>,
      color    : '#<?=$color?>',
      highlight: '#<?=$color?>',
      label    : '<?=$value?>'
      },
