		...
		<div class="box box-primary">
			<div class="box-header">
				...
				<div class="box-tools pull-right">
					<?php if($this->App->menu_permission('UserDoctorVisitPlanLists','admin_add')){ echo $this->Html->link(__('<i class="glyphicon glyphicon-plus"></i> New Plan'), array('action' => 'add'), array('class' => 'btn btn-primary', 'escape' => false)); } ?>
				</div>
			...
			<div class="box-body">
				...
				<div class="search-box">
					...
					<table class="search">
						<tr>
							<td width="50%"><?php echo $this->Form->input('user_id', array('id' => 'user_id','class' => 'form-control user_id', 'required'=>false,'empty'=>'---- Select SPO User ----')); ?></td>
                ...
                <table id="VisitPlanLists" class="table table-bordered table-striped">
					<thead>
						<tr>
							...
							<th class="text-center"><?php echo $this->Paginator->sort('user_id', 'SPO Name'); ?></th>
					...
					<tr>
						...
						<td class="text-center"><?php echo h($visitPlanList['User']['username']); ?></td>
						...
						<td class="text-center"><?php echo $this->App->dateformat($visitPlanList['UserDoctorVisitPlanList']['visit_plan_date']); ?></td>
						...
						<td class="text-center">
							<?php if($this->App->menu_permission('UserDoctorVisitPlanLists','admin_delete')){ echo $this->Form->postLink(__('<i class="glyphicon glyphicon-trash"></i>'), array('action' => 'delete', $visitPlanList['UserDoctorVisitPlanList']['id']), array('class' => 'btn btn-danger btn-xs', 'escape' => false, 'data-toggle'=>'tooltip', 'title' => 'delete'), __('Are you sure you want to delete # %s?', $visitPlanList['UserDoctorVisitPlanList']['id'])); } ?>
						</td>
					</tr>
					<?php endforeach; ?>
					</tbody>
