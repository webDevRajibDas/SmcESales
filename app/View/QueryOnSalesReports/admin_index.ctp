                                    ...
                                    <table cellspacing="0" cellpadding="10px" border="1px solid black" align="center" class="text-center report_table" id="sum_table">
                                        <thead>
                                            <tr class="titlerow">
                                                ...
                                                <th style="text-align:left;">Terrtory</th>
                                                    ...
                                                    ?>
                                                        ...
                                                        ?>
                                                                <tr class="">
                                                                    ...
                                                                    <td><?= $outlet_data['territory_name'] ?></td>
                                                                    <td><?= $outlet_data['thana_name'] ?></td>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var qty2 = row.find('td').eq(7).html();
        var memo_total = row.find('td').eq(9).html();
