		...
		<div class="box box-primary">
			...
			<div class="box-body">				
				...
				<div class="form-group">
					<?php echo $this->Form->input('effective_date', array('type'=>'text','class' => 'datepicker form-control effective_date')); ?>
				</div>
				...
				<div class="form-group">
					<?php echo $this->Form->input('is_vat_applicable', array('label'=>'<b>Is Vat Applicable :</b>','type'=>'checkbox','class' => 'checkbox-inline','div'=>false)); ?>
				</div>
				<div class="form-group">
							...
							<div class="col-xs-10">
								...
								<table style="margin-top: 1%;">
									<tbody>
										<tr>
											<td class="column_10">
												<?php echo $this->Form->input('is_db.1', array('label'=>'<b>DB :</b>','type'=>'checkbox','class' => 'checkbox-inline is_db','div'=>false,'id'=>false)); ?>
											</td>
										...
										<tr>
											...
											<td class="column_20">
												<div class="is_so_special_td" style="display: none">
													<?php echo $this->Form->input('is_so_special.1', array('label'=>'<b>Special :</b>','type'=>'checkbox','class' => 'checkbox-inline is_so_special','div'=>false,'id'=>false)); ?>
												</div>
											</td>
											<td class="column_70">
										...
										<tr>
											<td class="column_20">
												<div class="is_so_outlet_category_td" style="display: none">
													<?php echo $this->Form->input('is_so_outlet_category.1', array('label'=>'<b>Outlet Category :</b>','type'=>'checkbox','class' => 'checkbox-inline so_outlet_category','div'=>false,'id'=>false)); ?>
												</div>
											</td>
											<td class="column_70">
												<div id="market_list" class="input select so_outlet_category_td" style="float:left; width:80%; padding-left:20px;display: none">
				                                    ...
				                                    <div class="selection">
				                                        <?php echo $this->Form->input('so_outlet_category_id.1', array('id' => 'so_outlet_category_id', 'label'=>false, 'class' => 'checkbox so_outlet_category_id', 'multiple' => 'checkbox', 'options' => $outlet_categories)); ?>
				                                    </div>
				                                </div>
											</td>
										</tr>
										<tr>
											...
											<td class="column_20">
												<div class="is_sr_special_td" style="display: none">
													<?php echo $this->Form->input('is_sr_special.1', array('label'=>'<b>Special :</b>','type'=>'checkbox','class' => 'checkbox-inline is_sr_special','div'=>false,'id'=>false)); ?>
												</div>
											</td>
											<td class="column_70">
										...
										<tr>
											<td class="column_20">
												<div class="is_sr_outlet_category_td" style="display: none">
													<?php echo $this->Form->input('is_sr_outlet_category.1', array('label'=>'<b>Outlet Category :</b>','type'=>'checkbox','class' => 'checkbox-inline sr_outlet_category','div'=>false,'id'=>false)); ?>
												</div>
											</td>
											<td class="column_70">
												<div id="market_list" class="input select sr_outlet_category_td" style="float:left; width:80%; padding-left:20px; display: none">
				                                    <div class="selection">
				                                        <?php echo $this->Form->input('sr_outlet_category_id.1', array('id' => 'sr_outlet_category_id', 'label'=>false, 'class' => 'checkbox sr_outlet_category_id', 'multiple' => 'checkbox', 'options' => $dist_outlet_categories)); ?>
				                                    </div>
				                                </div>
											</td>
										</tr>
    	...
    	else
    	{
    		...
    		else
    		{
		    	...
		    	if($(this).prev().prev().find('.is_sr').prop('checked'))
		    	{
			    	...
			    	<td class="text-left" colspan="5"><input type="number" required="required" step="any" name="data[sr_price]['+section_id+'][]"></td>\
			    	</tr>';
