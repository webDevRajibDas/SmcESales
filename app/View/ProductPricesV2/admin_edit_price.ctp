		...
		<div class="box box-primary">
			<div class="box-header">
				...
				<div class="box-tools pull-right">
					<?php if ($this->App->menu_permission('product_prices', 'admin_price_list')) {
						echo $this->Html->link(__('<i class="glyphicon glyphicon-plus"></i> Price List'), array('action' => "admin_price_list/$product_id"), array('class' => 'btn btn-primary', 'escape' => false));
					} ?>
				</div>
			</div>
			<div class="box-body">
				...
				<div class="section all_price_section">
					<?php $i = 1;
					foreach ($price_data['ProductPriceSectionV2'] as $section_data) { ?>
						<div class="price_section" style="border:1px solid black;">
							<div class="row">
								<div class="col-xs-10">
									...
									<button class="btn btn-info btn_process pull-right" disabled>Process</button>
									<button class="btn btn-danger btn_unprocess pull-right">Unprocess</button>
								</div>
								<div class="col-xs-2">
														...
														<?php if (count($section_data['so_selected_special_group']) > 0 || count($section_data['so_selected_outlet_category_id']) > 0) { ?>
															...
															<table class="table table-bordered" style="margin-top:10px;margin-bottom:10px">
																<tr class="table-success">
																	<td colspan="6" class="text-center "><b>So Price</b></td>
																</tr>
																<?php
																$i = 1;
		...
		$("body").on('click', '.btn_process', function(e) {
			...
			if (
				...
				if (
					...
					console.log("ddd" + $(this).prev().prev().height());
