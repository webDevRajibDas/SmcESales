		...
		<div class="box box-primary">
			...
			<div class="box-body">				
				...
				<div class="form-group">
					<?php echo $this->Form->input('type_id', array('id' => 'type_id','class' => 'form-control','options'=>$institute_type,'default'=>$this->request->data['OutletNgoPrice'][0]['type_id'],'empty'=>'---- Select Institute Type','readonly')); ?>
				</div>
				<div class="form-group">
					<?php echo $this->Form->input('institute_id', array('id' => 'institute_id','class' => 'form-control','options'=>$institute_id,'empty'=>'---- Select Institute','readonly')); ?>
				</div>
				<div class="form-group">
