    ...
    <div class="col-md-12">
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><i class="glyphicon glyphicon-edit"></i>  <?php echo __('Add Session'); ?></h3>
			...
			<?php echo $this->Form->create('ProgramSession', array('role' => 'form')); ?>
				...
				<div class="form-group">
					<?php echo $this->Form->input('so_id', array('id' => 'sales_person_id','class' => 'form-control sales_person_id','empty'=>'---- Select SO ----')); ?>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<?php echo $this->Form->input('session_date', array('type'=>'text','class' => 'form-control datepicker')); ?>
				</div>
				<div class="form-group">
