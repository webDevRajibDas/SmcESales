    ...
    <div class="col-md-12">
        <div class="box box-primary">
			...
			<?php echo $this->Form->create('CurrentInventory', array('role' => 'form')); ?>
                        ...
                        <?php echo $this->Form->input('store_id', array('class' => 'form-control','empty'=>'--- Select --','required')); ?>
                    </div>
                <div class="form-group">
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td width="12%" align="center">							
							<?php echo $this->Form->input('expire_date', array('label'=>false, 'class' => 'full_width form-control expire_date expireDatepicker','type'=>'text')); ?>
                            </td>
