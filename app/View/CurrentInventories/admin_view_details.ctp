             ...
             <!--   <div class="search-box">
				...
				<table id="CurrentInventories" class="table table-bordered table-striped">
					...
					<tr>
						...
						<td class="text-center"><?php if($currentInventory['CurrentInventory']['expire_date'] != ' '){ echo $this->App->expire_dateformat($currentInventory['CurrentInventory']['expire_date']); } ?></td>
						<td class="text-center"><?php echo h($currentInventory['CurrentInventory']['qty']); ?></td>
						<td class="text-center"><?php echo h($currentInventory['CurrentInventory']['sale_unit_qty']); ?></td>
					</tr>
					<?php endforeach; ?>
					</tbody>
				</table>
