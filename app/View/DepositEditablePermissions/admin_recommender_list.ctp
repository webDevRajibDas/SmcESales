                    ...
                    <tbody id = "list_table">
                        <?php if(!empty($permited)){
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-info btn-xs toggleBtn add_more_<?=$id?>" onclick="deposit_recommended(<?=$id?>);"><i class="glyphicon glyphicon-plus"></i></a>
                                </td>
                            </tr>
                        <?php }
                         }
...
<script>
    ...
    $('body').on('click','.find',function() {
        ...
        ({
            type: "POST",
            url: '<?=BASE_URL?>deposit_editable_permissions/get_deposit_recommended_list',
            data: 
            {
                office_id:office_id,
            ...
            {          
                ...
                for(var i = 0; i<obj.length; i++){
                    ...
                    '<tr id ="table_row_'+deposit_id+'">\
                        ...
                        <td><a class="btn btn-info btn-xs toggleBtn add_more_<?=$id?>" onclick="deposit_recommended('+id+');"><i class="glyphicon glyphicon-plus"></i></a></td></tr>';
    ...
    function deposit_recommended(id){
        ...
        if(recommender_note == ''){
            ...
            ({
                type: "POST",
                url: '<?=BASE_URL?>deposit_editable_permissions/deposit_recommended',
