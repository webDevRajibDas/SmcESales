                ...
                <table class="table table-bordered">
					<tbody>
						...
						<tr>		
							...
							<td align="center"><?php echo $this->App->dateformat($val['ReturnChallanDetail']['expire_date']); ?></td>
							<td align="center">
								<?php
								if($returnChallan['ReturnChallan']['status'] == 1 AND $office_parent_id !=0){
								?>
								...
								<input type="number" class="full_width form-control" name="receive_quantity[]" value="<?php echo $val['ReturnChallanDetail']['challan_qty']; ?>"/>
								<?php
								}else{
								?>
								<?php echo $val['ReturnChallanDetail']['received_qty']; ?>
								<?php
								}
								?>
							</td>
						...
						<?php
							...
							$total_received_quantity = $total_received_quantity + $val['ReturnChallanDetail']['received_qty'];
