        ...
        <div class="box box-primary" style="min-height:950px;">
            ...
            <div class="box-body">
                <div class="search-box">
                    ...
                    <?php echo $this->Form->create('OtherEmergencyReports', array('role' => 'form', 'action' => 'cash_discount_offer_ors25_np_5_persent_20_may')); ?>

                    <table class="search">

                        <tr>
                            <td class="required" width="50%">
                                <?php echo $this->Form->input('date_from', array('class' => 'form-control datepickerfrom date_from', 'required' => true, 'autocomplete' => 'off')); ?>
                            </td>
                                        ...
                                        <tbody>
                                            <?php 
												...
												foreach ($report_data as $data) { 
													$mgrosvalue += $data['0']['memo_total_gross'];
													$mdiscountvalue += $data['0']['memo_total_discount'];
											?>
                                                <tr>
                                                    <td><?= $data['0']['office'] ?></td>
                                                    <td><?= $data['0']['territory'] ?></td>
                                                    <td><?= $data['0']['market'] ?></td>
                                                    <td><?= $data['0']['outlet'] ?></td>
											...
											<tr height="35">
												...
												<th> <?= sprintf('%0.2f', $mgrosvalue ) ?> </th>
												<th> <?= sprintf('%0.2f', $mdiscountvalue ) ?> </th>
											</tr>
                                        </tbody>
                                    </table>
                                </div>
...
<script>
    $(document).ready(function() {
        ...
        $("#download_xl").click(function(e) {
            ...
            a.download = "Cash-Discount-on_ORS.xls";
