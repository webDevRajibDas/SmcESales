		...
		<div class="box box-primary">
			...
			<?php echo $this->Form->create('OpenCombination', array('role' => 'form')); ?>
				...
				<div class="form-group">
					...
					echo $this->Form->input('product_id', array('class' => 'form-control product_common_class','id'=>'product_id1','empty'=>'---- Select Product ----','label'=>false,'default'=>$product_id, 'name'=>'data[OpenCombination][product_id][]',$disabled)); ?>
