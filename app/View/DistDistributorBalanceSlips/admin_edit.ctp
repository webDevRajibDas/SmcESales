        ...
        <div class="box box-primary">
            ...
            <div class="box-body">    
                ...
                <div class="form-group deposite_div">
                    <?php echo $this->Form->input('deposite_type_id', array('label' => 'Deposite Type:', 'id' => 'deposite_type_id', 'class' => 'form-control deposite_type_id','empty' => '---- Select Deposite Type ----','options'=>$deposite_type)); ?>
                </div>
                ...
                <div class="form-group deposite_div">
                    <?php echo $this->Form->input('reference_number', array('id' => '', 'class' => 'form-control')); ?>
                </div>
                <div class="form-group deposite_div">
                    <?php echo $this->Form->input('Deposite_date', array('id' => '', 'class' => 'form-control datepicker')); ?>
                </div>
           ...
           var distributor_id = $(this).val();
            if(distributor_id)
            {
               $.ajax({
                    ...
                    data: {'dist_distributor_id': distributor_id,'slip':1},
                    type: 'POST',
