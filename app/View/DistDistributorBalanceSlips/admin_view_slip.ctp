                ...
                <table id="Territories" class="table table-bordered table-striped">
                    <tbody>
                        ...
                        <tr>        
                            ...
                            <td align="center"><?php
                            if($val['DistDistributorBalanceHistory']['deposit_id'] != NULL){ 
                                if ($this->App->menu_permission('DistDistributorBalances', 'admin_edit')) {
                                            echo $this->Html->link(__('<i class="glyphicon glyphicon-pencil"></i>'), array('action' => 'edit_slip', $val['DistDistributorBalanceHistory']['id']), array('class' => 'btn btn-warning btn-xs', 'escape' => false, 'data-toggle' => 'tooltip', 'title' => 'edit_slip'));
                                        }
                            } 
                            ?>   
                            </td>
