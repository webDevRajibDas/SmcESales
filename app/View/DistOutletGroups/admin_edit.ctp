...
<?php
	$OutletGroup =new DistOutletGroupsController();
	/* echo "<pre>";
    ...
    <div class="col-xs-12">
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><i class="glyphicon glyphicon-plus"></i> <?php echo __('Edit Distributor Group'); ?></h3>
							...
							if(!empty($this->request->data['OutletGroupToOutlet'])){
								foreach($this->request->data['OutletGroupToOutlet'] as $val){
									...
									<tr>
										...
										<td>
											<?=$outlet_info['DistRoute']['name']?>
										</td>
										<td>
											<?=$outlet_info['DistMarket']['name']?>
										</td>
										<td>
											<?=$outlet_info['DistOutlet']['name']?>
