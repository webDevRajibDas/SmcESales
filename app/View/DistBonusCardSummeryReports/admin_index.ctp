                	...
                	<div id="content" style="width:90%;height:100%;margin-left:5%;margin-right:5%;">
                		...
                		<table class="table border table-hover" style="font-size:12px;" border="1">
                			...
                			<tbody>
                				...
                				<tr class="view_data" data-href="<?=BASE_URL;?>/dist_bonus_card_summery_reports/detail_bonus_card_report/<?=$data['route_id'].'/'.$bonus_card.'/'.$from_date.'/'.$to_date.'/'.$office_id.'/0/'.$data['outlet_type_id']?>">
                					<td class="text-center"><?=$data['tso_name']?></td>
                					<td class="text-center"><?=$data['db_name']?></td>
                					<td class="text-center"><?=$data['sr_name']?></td>
                                ...
                                <tr class="view_data" data-href="<?=BASE_URL;?>/dist_bonus_card_summery_reports/detail_bonus_card_report/<?='0/'.$bonus_card.'/'.$from_date.'/'.$to_date.'/'.$office_id.'/1/0'?>">
                                    <td class="text-center" colspan="8" ><b>Total Non-Pharma</b></td>
                                ...
                                <tr class="view_data" data-href="<?=BASE_URL;?>/dist_bonus_card_summery_reports/detail_bonus_card_report/<?='0/'.$bonus_card.'/'.$from_date.'/'.$to_date.'/'.$office_id.'/1/1'?>">
                                    <td class="text-center" colspan="8" ><b>Total Pharma</b></td>
                                ...
                                <tr class="view_data" data-href="<?=BASE_URL;?>/dist_bonus_card_summery_reports/detail_bonus_card_report/<?='0/'.$bonus_card.'/'.$from_date.'/'.$to_date.'/'.$office_id.'/1'?>">
...
<script>
    ...
    $(document).ready(function(){
        $("#fiscal_year_id").change(function(){
            $.post('<?=BASE_URL.'dist_bonus_card_summery_reports/get_bonus_card'?>',{'fiscal_year_id':$(this).val()}, function(data,status){
