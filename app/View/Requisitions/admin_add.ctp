	...
	<div class="col-md-12">
		<div class="box box-primary">
			...
			<?php echo $this->Form->create('Requisition', array('role' => 'form')); ?>
				...
				<div class="form-group">
					<?php echo $this->Form->input('sender_store_id', array('class' => 'form-control','empty'=>'---- Select Sender ----','id'=>'sender_store_id')); ?>
				</div>
				<div class="form-group">
...
<script>
	$(document).ready(function(){
		...
		$('#sender_store_id').change(function(){
			$.ajax({
				...
				success:function(data){
					...
					var products = json_decode.products;
