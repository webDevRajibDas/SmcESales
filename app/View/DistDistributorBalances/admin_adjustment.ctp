    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title"><i class="glyphicon glyphicon-edit"></i>  <?php echo __('Adjustment Distributors Balance'); ?></h3>
            ...
            <div class="box-body">		
                ...
                <div class="form-group">
                    <?php echo $this->Form->input('balance_transaction_type_id', array('label'=>'Transaction Type :','id'=>'balance_transaction_type_id','class' => 'form-control balance_transaction_type_id','options'=>$transaction_type)); ?>
                </div>
                <div class="form-group">
                    <?php echo $this->Form->input('balance', array('label'=>'Deposits Amount :','id'=>'balance','class' => 'form-control', 'type'=>'number')); ?>
                </div>
