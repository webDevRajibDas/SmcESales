...
<script>
	$(document).ready(function(){
		$("#fiscal_year_id").change(function(){
			$.post('DistBonusCardCalculate/get_bonus_card',{'fiscal_year_id':$(this).val()}, function(data,status){
		...
		$("#fiscal_year_id,#bonus_card_id,#searchOfficeId").change(function(){
			...
			{
				$.post('DistBonusCardCalculate/check_calculate_before',{'fiscal_year_id':fiscal_year_id,'bonus_card_id':bonus_card_id,'office_id':office_id}, function(data,status){
