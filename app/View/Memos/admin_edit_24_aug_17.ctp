...
<div class="row">
		...
		<div class="box box-primary">
			...
			<?php echo $this->Form->create('Memo', array('role' => 'form')); ?>
                <div class="form-group">
                    <?php echo $this->Form->input('office_id', array('id' => 'office_id', 'class' => 'form-control office_id', 'selected'=>$existing_record['office_id'])); ?>
                </div>
				<div class="form-group">
                    <?php echo $this->Form->input('sale_type_id', array('type'=>'text', 'class' => 'form-control', 'id' => 'sale_type_id', 'value' => 'SO Sales', 'disabled')); ?>
                </div>
                ...
                <div class="form-group">
                    <?php echo $this->Form->input('entry_date', array('class' => 'form-control datepicker', 'value' => $existing_record['memo_date'], 'required' => TRUE)); ?>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <?php echo $this->Form->input('memo_no', array('class' => 'form-control','required'=>TRUE,'type' => 'text', 'value'=>$existing_record['memo_no'], 'disabled')); ?>
                </div>
                <div class="form-group">
                    <?php echo $this->Form->input('memo_no', array('class' => 'form-control','required'=>TRUE,'type' => 'hidden', 'value'=>$existing_record['memo_no'])); ?>
                </div>
				...
				?>
					<tr id="<?php echo $sl?>" class="new_row_number">
						...
						<th class="text-center">
							<?php
								echo $this->Form->input('product_id',array('name'=>'data[MemoDetail][product_id][]','class'=>'form-control width_100 product_id','required'=>TRUE,'options'=>$product_list,'empty'=>'---- Select Product ----','label'=>false,'default'=>$val['product_id']));
							?>
						...
						<th class="text-center" width="12%">
							<input type="number" step="any" min="0" name="data[MemoDetail][sales_qty][]" class="form-control width_100 min_qty" value="<?=$val['sales_qty']?>"/>
						...
						<th class="text-center" width="10%">
                            ...
                            <input type="hidden" id="bonus_measurement_unit_id<?php echo $sl;?>" name="data[MemoDetail][bonus_measurement_unit_id][]" value="<?php if(!empty($val['bonus_product_id'])) echo $product_measurement_units[$val['bonus_product_id']];?>" class="form-control width_100 bonus_measurement_unit_id"/>
                        </th>
						<th class="text-center" width="10%">
				...
				<tfoot>
					<tr>
						...
						<td align="center"><input name="data[Memo][gross_value]" class="form-control width_100" type="text" id="gross_value" value="<?php echo $existing_record['Memo']['gross_value']; ?>" readonly />
						</td>
						<td></td>
						<td></td>
					</tr>
					<tr>
						...
						<td align="center"><input name="data[Memo][cash_recieved]" class="form-control width_100" type="text" id="cash_collection" value="<?php echo $existing_record['Memo']['cash_recieved']; ?>" required />
						</td>
						<td></td>
						<td></td>
					</tr>
					<tr>
						...
						<td align="center"><input name="data[Memo][credit_amount]" class="form-control width_100" type="text" id="credit_amount" value="<?php echo $existing_record['Memo']['credit_amount']; ?>" readonly />
						</td>
						<td></td>
						<td></td>
					</tr>
    ...
    <input type="hidden" id="cur_val">
    <input type="hidden" id="cur_val_bonus">
    <input type="hidden" id="cur_val_bonus_product_id">
    <input type="hidden" id="cur_val_bonus_product_qty">
    <input type="hidden" id="cur_val_bonus_measurement_unit_id">
...
<script>
    ...
    $(document).ready(function () {
    //var = all_edited_product;
    //all_edited_product = php echo product_array
    // split all_edited_product and you will get id
    // loop through product id and
    //edit_for_append 
        ...
        /*$("body").on("click", ".add_more", function () {
            ...
            product_box.append('<tr id='+sl+'>' + current_row + '</tr>');
            $('#'+sl+'>.sl_memo').text(sl);
        });*/
        ...
        $("body").on("click", ".product_id", function () {
             ...
             var cur_val_bonus = $('#'+current_row_no+'>th>.bonus').val();
             $('#cur_val_bonus').val(cur_val_bonus);
             var cur_val_bonus_product_id = $('#'+current_row_no+'>th>.bonus_product_id').val();
             $('#cur_val_bonus_product_id').val(cur_val_bonus_product_id);
             var cur_val_bonus_product_qty = $('#'+current_row_no+'>th>.bonus_product_qty').val();
             $('#cur_val_bonus_product_qty').val(cur_val_bonus_product_qty);
             var cur_val_bonus_measurement_unit_id = $('#'+current_row_no+'>th>.bonus_measurement_unit_id').val();
             $('#cur_val_bonus_measurement_unit_id').val(cur_val_bonus_measurement_unit_id);
        });
        ...
        $("body").on("change", ".product_id", function () {
            ...
            $('.product_id').each(function () {
                ...
                if ($(this).val() != '') {
                    ...
                    else 
                    {
                        ...
                        $('#'+ current_row_no+ ' .product_id').val($('#cur_val').val());
                        $('#'+current_row_no+'>th>.bonus').val($('#cur_val_bonus').val());
                        $('#'+current_row_no+'>th>.bonus_product_id').val($('#cur_val_bonus_product_id').val());
                        $('#'+current_row_no+'>th>.bonus_product_qty').val($('#cur_val_bonus_product_qty').val());
                        $('#'+current_row_no+'>th>.bonus_measurement_unit_id').val($('#cur_val_bonus_measurement_unit_id').val());
                        total_values();
                        new_product = 0;
                        $('#myModal').modal('hide');
                        $('#loading').hide();
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $('#'+sl+'>th>.min_qty').attr('max',total_qty);
