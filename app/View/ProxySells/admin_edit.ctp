		...
		<div class="box box-primary">
			...
			<?php echo $this->Form->create('ProxySell', array('role' => 'form')); ?>
                    ...
                    <div class="form-group">
						<?php echo $this->Form->input('office_id', array('id' => 'office_id', 'class' => 'form-control', 'selected' => $office_id, 'disabled' => true, 'empty'=>' --- Select Office ---- ')); ?>
					</div>
                    <?php }else{ ?>
...
<script>
	$(document).ready(function(){
		 var dates=$('.proxy_datepicker1').datepicker({
             'format': "yyyy-mm-dd",
             'autoclose': true
         }); 
        $('.proxy_datepicker1').click(function(){
		 ...
		 dates=$('.proxy_datepicker2').datepicker({
             'format': "yyyy-mm-dd",
             'autoclose': true
         }); 
