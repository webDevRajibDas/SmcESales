...
$dis="disabled";   
$office_id=$this->request->data['DistDeliveryMan']['office_id'];
$dis_id=$this->request->data['DistDeliveryMan']['dist_distributor_id'];
    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title"><i class="glyphicon glyphicon-edit"></i>  <?php echo __('Edit Delivery Man'); ?></h3>
            ...
            <div class="box-body">		
                <?php echo $this->Form->create('DistDeliveryMan', array('role' => 'form')); ?>
                ...
                <div class="form-group input-group">
                    <div class="input text required ">
                        <label for="DistDeliveryManCode">Code :</label>
                        ...
                        <input style="width:260px;display: inline-block;float:left;" name="data[DistDeliveryMan][code]" class="form-control" maxlength="255" type="number" readonly value="<?php echo $code;?>" id="DistDeliveryManCode" required="required">
                    </div>                
                </div>
                
                
                <div class="form-group">
                    <?php echo $this->Form->input('name', array('type' => 'hidden', 'name' => 'data[DistDeliveryMan][pre_name]', 'id' => 'office_id', 'class' => 'form-control')); ?>
                    <?php echo $this->Form->input('code', array('type' => 'hidden', 'name' => 'data[DistDeliveryMan][pre_code]', 'id' => 'code', 'class' => 'form-control')); ?>
                    <?php echo $this->Form->input('office_id', array('type' => 'hidden', 'name' => 'data[DistDeliveryMan][pre_office_id]', 'id' => 'office_id', 'class' => 'form-control', 'empty' => '---- Select ----')); ?>
                    <?php echo $this->Form->input('territory_id', array('type' => 'hidden', 'name' => 'data[DistDeliveryMan][pre_territory_id]', 'id' => 'office_id', 'class' => 'form-control', 'empty' => '---- Select ----')); ?>
                    <?php echo $this->Form->input('dist_distributor_id', array('type' => 'hidden', 'name' => 'data[DistDeliveryMan][pre_dist_distributor_id]', 'id' => 'office_id', 'class' => 'form-control', 'empty' => '---- Select ----')); ?> 
           ...
           var office_id=$(this).val();
            ...
            if(office_id)
            {
                ...
                $("#code_prefix").html(code);
                  ...
                  $.ajax({
                    url: '<?= BASE_URL . 'DistDeliveryMans/get_sr_code' ?>',
                    data: {'office_id': office_id},
                    type: 'POST',
                    success: function (data)
                    {
                        $("#DistDeliveryManCode").val(data);
                    }
                });
            }
            else 
