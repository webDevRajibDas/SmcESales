                ...
                <table class="table table-bordered table-striped">
					<tbody>
						...
						<tr>		
							...
							<td>
								<?php 
								if($claim['Claim']['status'] == 1 AND $office_paren_id >0 AND $claim['Claim']['isApproved']==1)
								{	
						...
						<tr>		
							...
							<td><?php if($claim['Claim']['status'] == 1 AND $claim['Claim']['isApproved'] == 1){echo '<span class="btn btn-warning btn-xs">pending </span>';} 
                ...
                <table class="table table-bordered">
					<tbody>
						...
						<tr>		
							...
							<td align="center"><?php echo $claimType[$val['ClaimDetail']['claim_type']]; ?></td>
						</tr>
						<?php
						...
						?>	
						<tr>		
							<td align="right" colspan="2"><strong>Total Quantity :</strong></td>
