          ...
          <?php if($this->App->menu_permission('nationalSalesReports', 'admin_add')){ echo $this->Html->link(__('<i class="glyphicon glyphicon-plus"></i> New ProjectionAchievement Setting'), array('action' => 'add'), array('class' => 'btn btn-primary', 'escape' => false)); } ?>
            ...
            <div class="box-body">
                ...
                <div class="search-box">
                    <?php echo $this->Form->create('TransactionListStockSos', array('role' => 'form', 'action' => 'index')); ?>
                    <table class="search">
                        <tr>
                        ...
                        <tr>
                            <td class="required">
                                <div id="territory_html">
                                    <?php echo $this->Form->input('territory_id', array('id' => 'territory_id', 'class' => 'form-control territory_id office_t_so', 'required' => true, 'empty' => '---- All ----')); ?>
                                </div>
                                        ...
                                        <?php if ($f_product_list) { ?>
                                            ...
                                            <tbody>
                                                <?php foreach ($aso_opening_closing_results as $tran_date => $datas) { ?>
                                                    ...
                                                    if (@$r_gift_issue[$tran_date]) {

                                                    ?>
                                                        <tr>
                                                            <td></td>
                                                            <td style="text-align:left;">Gift Issue</td>
                                                            <td></td>
                                                            ...
                                                            foreach ($f_product_list as $product_id => $product_name) {
                                                            ?>
                                                                <td><?= @$r_gift_issue[$tran_date][$product_id]['challan_qty'] ?></td>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            foreach ($f_product_list as $product_id => $product_name) {
                                                            ?>
                                                                <td><?= @$r_doc_gift_issue[$tran_date][$product_id]['challan_qty'] ?></td>
