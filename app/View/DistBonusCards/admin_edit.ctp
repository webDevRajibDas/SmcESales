    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header">
                 <h3 class="box-title"><i class="glyphicon glyphicon-edit"></i>  <?php echo __('Incentive Party Edit'); ?></h3> 
			...
			<?php echo $this->Form->create('DistBonusCard', array('role' => 'form')); ?>
				<div class="form-group">
                    <?php echo $this->Form->input('id', array('class' => 'form-control id', 'type'=>"hidden",'value'=>$bonus_card['id'])); ?>
                </div>
                <div class="form-group required">
                    <?php echo $this->Form->input('name', array('class' => 'form-control name', 'maxlength' => '15', 'required'=>true,'type' => 'text','value'=>$bonus_card['name'])); ?>
                </div>
                <div class="form-group required">
                    <?php echo $this->Form->input('bonus_card_type_id', array('label'=>'Incentive Party Type :','class' => 'form-control','empty'=>'---- Select ----','options'=>$bonusCardTypes, 'selected'=>$bonus_card['bonus_card_type_id'])); ?>
                </div>
                <div class="form-group required">
				...
				<div class="form-group required">
                    <?php echo $this->Form->input('min_qty', array('class' => 'form-control min_qty', 'required'=>true,'type' => 'text','value'=>$bonus_card['min_qty'])); ?>
                </div>
                ...
                <table class="table table-striped table-condensed table-bordered invoice_table">
                    ...
                    <tbody>
                    	...
                    	<tr class="table_row" id="rowCount'<?php echo $key+1;?>'">
							...
							<td><?php echo $product_data[$value['product_id']];?>
								<input type="hidden" name="product_id[<?php echo $key+1;?>]" value="<?php echo $value['product_id'];?>"/>
							</td>
							<td align="center">
								<input  name="quantity[<?php echo $key+1;?>]" class="<?php echo $value['product_id'];?>_product_qty  p_quantity" value="<?php echo $value['qty'];?>" >
							</td>
							<td align="center">
                ...
                <table class="table table-striped table-condensed table-bordered period_bonus_table" id= "period_bonus_table">
                    ...
                    <tbody>
                    	...
                    	foreach ($period_bonus as $key => $value) {
                    		...
                    		$date_from = date('d-m-Y',strtotime ($value['date_from']));
                    		$date_to =date('d-m-Y',strtotime ($value['date_to']));
                    	?>

                        <tr class="table_row" id="' + rowCount + '">
							<td align="center"><?php echo $key+1;?>
							</td>
							<td><?php echo $product_data[$product_id];?>
								<input type="hidden" name="period_product_id[<?php echo $product_id;?>][<?php $key+1;?>]" value="<?php echo $product_id;?>"/>
							</td>
							<td width="25%" align="center">
								<input name="period_date_from[<?php echo $product_id;?>][<?php $key+1;?>]" class="<?php echo $product_id;?>_period_date_from datepicker1 " value="<?php echo $date_from;?>" required >
							</td><td width="25%" align="center">
								<input  name="period_date_to[<?php echo $product_id;?>][<?php $key+1;?>]" class="<?php echo $product_id;?>_period_date_to datepicker1 " value="<?php echo $date_to;?>" required >
							</td><td align="center">
								<input  name="period_product_quantity[<?php echo $product_id;?>][<?php $key+1;?>]" class="<?php echo $product_id;?>_period_product_qty  p_quantity" value="<?php echo $value['qty'];?>" required >
							</td>
							<td align="center">
								<button class="btn btn-danger btn-xs period_product_remove" value="<?php $key+1;?>">
									<i class="fa fa-times"></i>
								</button>
							</td>
						</tr>
