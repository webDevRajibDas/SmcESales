        ...
        <div class="box box-primary">
            <div class="box-header">
                ...
                <div class="box-tools pull-right">
					<?php echo $this->Html->link(__('<i class="glyphicon glyphicon-th-large"></i> Distributor Bonus Card List'), array('action' => 'index'), array('class' => 'btn btn-primary', 'escape' => true)); ?>
                </div>
            </div>
            <div class="box-body">		
			<?php echo $this->Form->create('DistBonusCard', array('role' => 'form')); ?>
                ...
                <div class="form-group required">
                    <?php echo $this->Form->input('bonus_card_type_id', array('class' => 'form-control','empty'=>'---- Select ----','options'=>$bonusCardTypes)); ?>
                </div>
                <div class="form-group required">
