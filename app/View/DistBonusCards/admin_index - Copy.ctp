			...
			<div class="box-body">
				...
				<table id="CurrentInventories" class="table table-bordered table-striped">
					...
					<tr>
						...
						<td class="text-center"><?php if($currentInventory['CurrentInventory']['expire_date'] != '0000-00-00'){ echo $this->App->dateformat($currentInventory['CurrentInventory']['expire_date']); } ?></td>
