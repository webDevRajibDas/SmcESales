              ...
              <div class="box box-primary">
                ...
                <div class="box-footer no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    ...
                    <li><a><?=$pie_product['Product']['name']?> <span class="pull-right text-red"> <?=$DashboardsController->getAreaOfficeTerritorySales(0, $pie_product['PieProductSetting']['product_id']);?>%</span></a></li>
                    <?php } ?>
                  </ul>
                </div>
                <!-- /.footer -->
...
$( document ).ready(function() {
  ...
  var PieData        = [
	  ...
	  ?>
	  {
      value    : <?=$DashboardsController->getAreaOfficeTerritorySales($key);?>,
      color    : '#<?=$color?>',
      highlight: '#<?=$color?>',
      label    : '<?=$value?>'
      },
