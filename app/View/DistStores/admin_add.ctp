    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title"><i class="glyphicon glyphicon-edit"></i>  <?php echo __('Add Distributor Store'); ?></h3>
            ...
            <div class="box-body">		
                ...
                <div class="form-group territory">
                    <?php echo $this->Form->input('dist_distributor_id', array('label'=>'Distributor','id' => 'dist_distributor_id', 'class' => 'form-control dist_distributor_id', 'empty' => '---- Select Distributor ----', 'required' => false)); ?>
                </div>
                <div class="form-group">
