    ...
    <div class="col-xs-12">		
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title"><i class="glyphicon glyphicon-eye-open"></i> <?php echo __('Distributor Store'); ?></h3>
                ...
                <table id="Stores" class="table table-bordered table-striped">
                    <tbody>
                        <tr>		
                            ...
                            <td>
                                <?php echo h($store['DistStore']['id']); ?>
                                &nbsp;
                            </td>
                        </tr><tr>		
                            <td><strong><?php echo __('Name'); ?></strong></td>
                            <td>
                                <?php echo h($store['DistStore']['name']); ?>
                                &nbsp;
                            </td>
                        </tr><tr>		
                            <td><strong><?php echo __('Distributor Store Type'); ?></strong></td>
                            <td>
                                <?php echo h($store['DistStore']['store_type']); ?>
                                &nbsp;
                            </td>
                        </tr><tr>		
                            ...
                            <td>
                                <?php echo $this->Html->link($store['DistDistributor']['name'], array('controller' => 'DistDistributors', 'action' => 'view', $store['DistDistributor']['id']), array('class' => '')); ?>
                                &nbsp;
                            </td>
                        </tr><tr>		
                            <td><strong><?php echo __('Created At'); ?></strong></td>
                            <td>
                                <?php echo h($store['DistStore']['created_at']); ?>
                                &nbsp;
                            </td>
                        </tr><tr>		
                            <td><strong><?php echo __('Created By'); ?></strong></td>
                            <td>
                                <?php echo h($store['DistStore']['created_by']); ?>
                                &nbsp;
                            </td>
                        </tr><tr>		
                            <td><strong><?php echo __('Updated At'); ?></strong></td>
                            <td>
                                <?php echo h($store['DistStore']['updated_at']); ?>
                                &nbsp;
                            </td>
                        </tr><tr>		
                            <td><strong><?php echo __('Updated By'); ?></strong></td>
                            <td>
                                <?php echo h($store['DistStore']['updated_by']); ?>
                                &nbsp;
                            </td>
                        </tr>					
                    </tbody>
                    ...
                    <table class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center"><?php echo __('Distributor Store Id'); ?></th>
                        ...
                        <tbody>
                            ...
                            foreach ($store['CurrentInventory'] as $currentInventory):
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo $currentInventory['dist_store_id']; ?></td>
