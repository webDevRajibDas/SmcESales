    ...
    <div class="col-xs-12">		
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><i class="glyphicon glyphicon-eye-open"></i> <?php  echo __('Variant'); ?></h3>
		...
		<td>
			<?php echo h($variant['Variant']['name']); ?>
			&nbsp;
		</td>
</tr>					</tbody>
				</table>
		...
		<th class="text-center"><?php echo __('Maintain Batch'); ?></th>
							...
							<tbody>
									<?php
										$i = 0;
										foreach ($variant['Product'] as $product): ?>
		<tr>
