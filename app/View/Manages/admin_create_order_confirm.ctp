    ...
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            <div class="box-body">
               ...
               <?php if($this->Session->read('Office.group_id')==1){ ?>
                <div class="form-group"  id="distribut_id_so">
                    <?php echo $this->Form->input('distribut_outlet_id', array('label' => 'Distributer:', 'id' => 'distribut_outlet_id', 'class' => 'form-control distribut_outlet_id', 'required' => TRUE, 'empty' => '---- Select Distributer ----', 'options' => $distributers)); ?>
                </div>
                 <?php } else {?>
                  <div class="form-group"  id="distribut_id_so">
                    <?php echo $this->Form->input('distribut_outlet_id', array('label' => 'Distributer:', 'id' => 'distribut_outlet_id', 'class' => 'form-control distribut_outlet_id', 'required' => TRUE, 'options' => $distributers)); ?>
                </div>
                  <?php }?> 
        <?php if($this->Session->read('Office.group_id')==1){ ?>
         ...
         <?php } else {?>
              <div class="form-group" id="territory_id_div">
            <?php echo $this->Form->input('territory_id', array('label'=>'Primary Territory','id' => 'territory_id', 'class' => 'form-control territory_id', 'onChange' => 'rowUpdate(1);', 'required' => TRUE, 'options' => $territories)); ?>
        </div>
          <?php }?> 
       ...
       <!--- <div class="form-group"  id="market_id_so">
            <?php echo $this->Form->input('market_id', array('id' => 'market_id', 'class' => 'form-control market_id', 'required' => TRUE, 'empty' => '---- Select Market ----')); ?>
               ...
               <!--  <div class="form-group"  id="outlet_id_so">
                   <?php echo $this->Form->input('outlet_id', array('label' => 'Outlets:', 'id' => 'outlet_id', 'class' => 'form-control outlet_id', 'required' => TRUE, 'empty' => '---- Select Distributer ----', 'options' => $outlets)); ?>
               </div> -->
 

                <div class="form-group">
                    <?php echo $this->Form->input('entry_date', array('class' => 'form-control datepicker', 'value' => (isset($this->request->data['Order']['entry_date']) == '' ? $current_date : $this->request->data['Order']['entry_date']), 'required' => TRUE)); ?>
                </div>
                <div class="form-group">
                    <?php echo $this->Form->input('order_date', array('class' => 'form-control datepicker', 'value'=>$current_date, 'type' => 'text', 'required'=>TRUE)); ?>
                </div>
                
                <div class="form-group">
                    <?php echo $this->Form->input('order_no', array('class' => 'form-control order_no', 'required'=>TRUE, 'type' => 'text', 'value'=>$generate_order_no, 'readonly')); ?>
                </div>
                
                <div class="form-group">
                    <?php echo $this->Form->input('order_reference_no', array('class' => 'form-control order_reference_no', 'maxlength' => '15', 'required'=>false,'type' => 'text')); ?>
                </div>
                    ...
                    <table class="table table-striped table-condensed table-bordered invoice_table">
                        ...
                        <tfoot>
                            ...
                            <tr>
                                ...
                                <td align="center"><input name="data[Order][cash_recieved]" class="form-control width_100" type="text" id="cash_collection" required />
                                </td>
                                <td></td>
                                <td></td>
                            </tr>
                            <tr>
                             ...
                             <td colspan="5" align="right"><b>Instrument Type : </b></td> 
                                <td align="center" width="10%"><?php
                                 echo $this->Form->input('instrumentType_id', array('id' => 'instrumentType_id', 'class' => 'form-control width_150 instrumentType_id', 'required' => TRUE, 'label' => false,'empty' => '--- Select ---', 'options' => $instrumentType)); 
                                ?></td>
                            ...
                            <tr> 
                                ...
                                <td align="center" width="10%"><input name="data[Order][reference_number]" class="form-control width_150" type="text" id="reference_number" />
                                </td>
                                <td></td>
                                <td></td>
                            </tr>
                                                        ...
                                                        <tr  class="bonus_row">
                                                            <th class="text-center" id="bonus_product_list">
                                                                ...
                                                                echo $this->Form->input('product_id', array('name' => 'data[OrderDetail][product_id][]', 'class' => 'form-control width_100 open_bonus_product_id','label' => false,'options' => $products));
                                                                  ...
                                                                  /* echo $this->Form->input('product_id', array('name' => 'data[OrderDetail][product_id][]', 'class' => 'form-control width_100 open_bonus_product_id', 'empty' => '---- Select Product ----', 'label' => false,'options' => $products));*/
                                                                ?>
                                                                <input type="hidden" class="product_id_clone" />
                            ...
                            <td align="center"><input name="data[Order][credit_amount]" class="form-control width_100" type="text" id="credit_amount" readonly />
                            </td>
                            <td></td>
                            <td></td>
                        </tr>
