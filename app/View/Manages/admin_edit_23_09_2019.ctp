    ...
    <div class="col-md-12">
      <div class="box box-primary">
         <div class="box-header">
            <h3 class="box-title"><i class="glyphicon glyphicon-edit"></i>  <?php echo __('Edit Order'); ?></h3>
       ...
       <div class="box-body">
        ...
        <div class="form-group">
          <?php echo $this->Form->input('Order.company_id', array('id'=>'company_id','required'=>TRUE, 'class' => 'form-control company_id','selected' => $existing_record['Order']['company_id'])); ?>
        ...
        <?php 
          ...
          echo $this->Form->input('Order.company_id', array('id'=>'company_id','required'=>TRUE, 'type' => 'hidden', 'class' => 'form-control company_id','value' => $existing_record['Order']['company_id']));
          }
        ?>  
         <div class="form-group">
        ...
        <?php if($maintain_dealer_type==1){?>
         <div class="form-group"  id="distribut_outlet_id_so">
                   <?php echo $this->Form->input('distribut_outlet_id', array('label' => 'Dealer :', 'id' => 'distribut_outlet_id', 'class' => 'form-control distribut_outlet_id', 'required' => TRUE, 'options' => $distributers, 'selected'=>$existing_record['outlet_id'])); ?>
          </div>
				  <?php } ?>
        ...
        <?php if($maintain_dealer_type !=1){?>
               ...
               <div class="form-group"  id="outlet_id_so">
                   <?php echo $this->Form->input('distribut_outlet_id', array('label' => 'Outlet :', 'id' => 'distribut_outlet_id', 'class' => 'form-control outlet_id', 'required' => TRUE, 'options' => $office_outlets, 'selected'=>$existing_record['outlet_id'])); ?>
          </div> 
          ...
          <?php }?>      
                ...
                <div class="form-group">
                    <?php echo $this->Form->input('order_date', array('class' => 'form-control datepicker', 'type' => 'text', 'required'=>TRUE,  'value'=>$existing_record['order_date'])); ?>
                </div>
                <div class="form-group">
                    <?php echo $this->Form->input('order_no', array('class' => 'form-control','required'=>TRUE,'type' => 'text', 'value'=>$existing_record['order_no'], 'readonly')); ?>
                ...
                <div class="form-group">
                    <?php echo $this->Form->input('order_reference_no', array('class' => 'form-control order_reference_no', 'value'=>$existing_record['order_reference_no'], 'maxlength' => '15', 'required'=>false,'type' => 'text')); ?>
                </div>
                ...
                <div class="table-responsive">
                  ...
                  <table class="table table-striped table-condensed table-bordered invoice_table">
                    <thead>
                     <tr>
                      ...
                      <th class="text-left" width="12%">Sales QTY</th>
                      <th class="text-left" width="12%">Deliverd QTY</th>
                      <th class="text-left" width="12%">Remaining QTY</th>
                    ...
                    if(!empty($existing_record)){
                      ...
                      foreach($existing_record['OrderDetail'] as $val){
                        ...
                        <tr id="<?php echo $sl?>" class="new_row_number">
                         ...
                         <th class="text-center" width="12%">
                           <?php if($existing_record['Order']['manage_draft_status'] == 1){?>
                           <input type="number" step="any" min="0"  max="<?=$val['deliverd_qty']?>" name="data[OrderDetail][deliverd_qty][]" class="form-control width_100 min_qty sales_qty" value="<?=$val['deliverd_qty']?>" required/>
                              ...
                              <?php } else {?>
                                   <input type="number" step="any" min="0"  max="<?=$val['remaining_qty']?>" name="data[OrderDetail][deliverd_qty][]" class="form-control width_100 min_qty sales_qty" value="<?=$val['deliverd_qty']?>" required/>
                              <?php }?>
                                 <input type="hidden" class="combined_product" value="<?php if(isset($val['combined_product'])){ echo $val['combined_product'];}?>"/>
                               </th>
                               <th class="text-center" width="12%">
                                 <input type="number" step="any" min="0" name="data[OrderDetail][remaining_qty][]" class="form-control width_100 remaining_qty" <?='rqty-'.$val['product_id']?>" value="<?php if($val['sales_qty'] != $val['remaining_qty']){echo $val['remaining_qty'];}else{echo 0;}?>" readonly/>
                               </th>
                               <th class="text-center" width="12%">
                  ...
                  <tfoot>
                    ...
                    <tr>
                      ...
                      echo $this->Form->input('instrumentType_id', array('id' => 'instrumentType_id', 'class' => 'form-control width_150 instrumentType_id', 'required' => TRUE, 'label' => false,'empty' => '--- Select ---', 'options' => $instrumentType, 'selected'=>$existing_record['instrumentType_id'])); 
                      ?></td>
                      <td></td>
                      <td></td>
                    ...
                    <tr>
                      ...
                      <td align="center" width="10%"><input name="data[Order][reference_number]" class="form-control width_150" type="text" id="reference_number" value="<?php echo $existing_record['reference_number']; ?>" readonly="readonly" />
                      </td>
                      <td></td>
                      <td></td>
                    </tr>
    ...
    $(document).ready(function () {
       ...
       /* $('.territory_id').selectChain({
        ...
        $('.office_id').selectChain({
            ...
            type: 'post',
            data:{'office_id': 'office_id','company_id': 'company_id'}
      ...
      checkInventory();
       ...
       if (product_category_id != 32 && pro_val) {
        ...
        delay(function()
        {
            ...
            {
                min_qty = 0;   // update 05-09-2019 min_qty 1 to 0 and val(1) to val(0)
                $('#'+current_row_no+'>th>.min_qty').val(0);
            }
            ...
            if(min_qty> -1) // update 05-09-2019 min_qty 1 to 0 and val(1) to val(0)
            {
                if(ajax_flag == 1)
                {
                	$.ajax({
