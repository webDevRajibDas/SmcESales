                        ...
                        if(!empty($existing_record)){
                          ...
                          foreach($existing_record['MemoDetail'] as $val){
                            ...
                            <tr id="<?php echo $sl?>" class="new_row_number">
                             ...
                             <th class="text-center" width="12%">
                                 <input type="number" step="any" min="0" max="<?=$val['sales_qty']?>" name="data[MemoDetail][sales_qty][]" class="form-control width_100 min_qty" value="<?=$val['sales_qty']?>" required/>
                        ...
                        <div class="modal-content">
                         ...
                         <div class="modal-body">
                            <table class="table-bordered">
                                ...
                                <?php $bon=0;  foreach($existing_record['MemoDetail'] as $val){
                            ...
                            ?>
                                    <tr  class="bonus_row">
                                        <th class="text-center" id="bonus_product_list">
                                            <?php 
                                            echo $this->Form->input('product_id', array('name' => 'data[MemoDetail][product_id][]', 'class' => 'form-control width_100 open_bonus_product_id', 'empty' => '---- Select Product ----','options'=>$open_bonus_product_option, 'label' => false,'default'=>$val['product_id']));
                                            ?>
