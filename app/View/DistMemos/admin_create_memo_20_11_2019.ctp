...
if(!empty($pre_submit_data))
{
   ...
   $selected_memo_date=date("d-m-Y",strtotime($pre_submit_data['memo_date']));
...
else 
{
   ...
   if(!empty($from_outlet))
   {
       ...
       if(isset($tso_id))
        ...
        $selected_memo_date=date("d-m-Y",strtotime($from_outlet['DistOutlet']['memo_date']));
   }
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6">
                        <div class="form-group">
                            <?php echo $this->Form->input('memo_date', array('class' => 'form-control datepicker', 'value' => ($selected_memo_date)?$selected_memo_date:$current_date, 'type' => 'text', 'required' => TRUE)); ?>
                        </div>
                    ...
                    <div class="col-xs-6">
                        ...
                        <div class="form-group">
                            ...
                            if(!empty($pre_submit_data))
                            {
                                echo $this->Form->input('memo_reference_no', array('label'=>'Memo Number :','class' => 'form-control memo_reference_no','selected' => !empty($from_outlet) ? $from_outlet['DistOutlet']['memo_reference_no'] :'', 'maxlength' => '15', 'required' => true, 'type' => 'text','value'=>''));
                            }
                            else if(!empty($from_outlet))
                            {
                               echo $this->Form->input('memo_reference_no', array('label'=>'Memo Number :','class' => 'form-control memo_reference_no', 'selected' => !empty($from_outlet) ? $from_outlet['DistOutlet']['memo_reference_no'] :'','maxlength' => '15', 'required' => true,'value'=>!empty($from_outlet) ? $from_outlet['DistOutlet']['memo_reference_no'] :'', 'type' => 'text')); 
                            }
                            else 
                            {
                                echo $this->Form->input('memo_reference_no', array('label'=>'Memo Number :','class' => 'form-control memo_reference_no', 'selected' => !empty($from_outlet) ? $from_outlet['DistOutlet']['memo_reference_no'] :'','maxlength' => '15', 'required' => true, 'type' => 'text'));
                            }
                           ?>
                        </div>
...
<!--                                <th class="text-center" width="10%">Bonus</th>-->
                        ...
                        <tbody class="product_row_box">
                            <tr id="1" class="new_row_number">
                                ...
                                <th class="text-center" width="12%">
                                    <input type="number"  name="data[MemoDetail][sales_qty][]" step="any" class="form-control width_100 min_qty sales_qty_validation_check" required />
                                                        ...
                                                        <tbody class="bonus_product">
                                                            <tr  class="bonus_row">
                                                                <th class="text-center" id="bonus_product_list">
                                                                    <?php
                                                                    echo $this->Form->input('product_id', array('name' => 'data[MemoDetail][product_id][]', 'class' => 'form-control width_100 open_bonus_product_id', 'empty' => '---- Select Product ----', 'label' => false,'autofocus' => true));
                                                                    ?>
                                                                    <input type="hidden" class="product_id_clone" />
                                                                ...
                                                                <th class="text-center" width="12%">
                                                                    <input type="number"  name="data[MemoDetail][sales_qty][]" step="any" id='open_bonus_min_qty' class="form-control width_100 open_bonus_min_qty" />
                                                                    <input type="hidden" class="combined_product"/>
                                                                </th>
                                                                <th class="text-center" width="10%">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box-body">		
                    ...
                    <?php echo $this->Form->input('market_memo_date', array('type'=>'hidden','id' => 'market_memo_date')); ?>
                    ...
                    <?php echo $this->Form->input('market_memo_reference_no', array('type'=>'hidden','id' => 'market_memo_reference_no')); ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box-body">		
                    ...
                    <?php echo $this->Form->input('market_memo_date', array('type'=>'hidden','id' => 'outlet_memo_date')); ?>
                    ...
                    <?php echo $this->Form->input('market_memo_reference_no', array('type'=>'hidden','id' => 'outlet_memo_reference_no')); ?>
...
<div class="modal fade" id="last_memo" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Last Memo Info.</h4>
            </div>
            <div class="modal-body">
...
<script>
    $(document).ready(function () {
        ...
        $('body').on("click", ".make_market", function () 
        {
            ...
            var market_memo_date=$("#DistMemoMemoDate").val();
            var market_ae_id=$("#ae_id").val();
            var market_tso_id=$("#tso_id").val();
            var DistMemoMemoReferenceNo=$("#DistMemoMemoReferenceNo").val();
            ...
            $("#market_memo_date").val(market_memo_date);
            $("#market_ae_id").val(market_ae_id);
            $("#market_tso_id").val(market_tso_id);
            $("#market_memo_reference_no").val(DistMemoMemoReferenceNo);
    ...
    $('#myModal2').on('shown.bs.modal', function () {
       ...
       function get_territory_and_thana_id_by_distributor_id(dist_id)
       {
            ...
            $.ajax({
                async:false,
                type: "POST",
                url: "<?php echo BASE_URL; ?>DistMemos/get_territory_and_thana_id_by_distributor_id",
        ...
        var distributor_id = $('#distributor_id').val();
            ...
            if (new_product == 1) {
                ...
                $.ajax({
                    ...
                    'type': 'POST',
                    data: {product_id: product_id, territory_id: territory_id, distributor_id: distributor_id, product_id_list: product_id_list,memo_date:memo_date},
                    success: function (result)
                    {
                        var obj = jQuery.parseJSON(result);
...
<script>
    ...
    $(document).ready(function ()
    {
        ...
        $('body').on('click', '.delete_item', function () {
            ...
            $('#cash_collection').val(new_gross_value);
                ...
                $.ajax({
                    ...
                    success: function (result)
                    {
                        if (result == 'yes') {
                            ...
                            if (no_of_new_combined_product > 0) {
                                $.ajax({
                                    url: '<?= BASE_URL . 'dist_memos/get_combine_or_individual_price' ?>',
                                    'type': 'POST',
                                    data: {combined_product: combined_product, min_qty: min_qty_new, product_id: product_id_new, product_id_list: product_id_list,memo_date:memo_date},
                                    success: function (result) {
...
<script>
    $(document).ready(function () {
        ...
        /********************check ************/
        $('body').on("blur", ".memo_reference_no", function () {
            check_valid_memo_no();
        });
    });
    ...
    $(document).ready(function () {
        $("body").on("click", ".bonus_add_more", function () {
            ...
            <tr class="bonus_row">\
                ...
                <th class="text-center" width="12%">\
                    <input type="number"  name="data[MemoDetail][sales_qty][]" step="any" class="form-control width_100 open_bonus_min_qty" required />\
                    <input type="hidden" class="combined_product"/>\
                </th>\
                <th class="text-center" width="10%">\
                    <a class="btn btn-primary btn-xs bonus_add_more"><i class="glyphicon glyphicon-plus"></i></a>\
                ...
                if (event.ctrlKey || event.metaKey) {
                    ...
                    else
                    {
                       ...
                       case 'l':
                                event.preventDefault();
                                console.log('here');
                                // $("#last_memo").trigger("click");
                                $('#last_memo').modal('toggle');
                                //$("#DistOutletName").trigger("focus");
                       break;
                       case 'f':
                                 event.preventDefault();
...
$("body").on("focusout", "#no_of_product", function () {
   ...
   {             
    ...
    function get_last_memo_info()
    {
        ...
        {
            $.ajax({
                url: '<?= BASE_URL . 'DistMemos/get_last_memo_info' ?>',
                data: {'office_id': office_id},
                type: 'POST',
                success: function (data)
                {
                        
                        $("#last_memo .modal-body").html(data);
                }
            });
        }
        else
        {
            $("#last_memo .modal-body").html("<p>No Data Availabe. Please Select Office First.</p>");
        }
    }
    /*-------------------------- Last Memo info print : END --------------------------------------*/
</script>
