    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title"><i class="glyphicon glyphicon-edit"></i>  <?php echo __('Create SR Memo'); ?></h3>
...
<script>
    $(document).ready(function () {
        ...
        $("body").on("change", ".order_id", function () {
            ...
            if(order_id){
                $.ajax({
                url: '<?= BASE_URL . 'DistMemos/get_order_info' ?>',
