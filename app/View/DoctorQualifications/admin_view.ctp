    ...
    <div class="col-xs-12">		
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><i class="glyphicon glyphicon-eye-open"></i> <?php  echo __('Doctor Qualification'); ?></h3>
				<div class="box-tools pull-right">
	                <?php echo $this->Html->link(__('<i class="glyphicon glyphicon-th-large"></i> Doctor Qualification List'), array('action' => 'index'), array('class' => 'btn btn-primary', 'escape' => false)); ?>
				</div>
			</div>			
			<div class="box-body">
		...
		<td>
			<?php echo h($doctorQualification['DoctorQualification']['id']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('Title'); ?></strong></td>
		<td>
			<?php echo h($doctorQualification['DoctorQualification']['title']); ?>
			&nbsp;
		</td>
</tr>					</tbody>
				</table>
			...
			<div class="box box-primary">
				...
				<?php if (!empty($doctorQualification['Doctor'])): ?>
		...
		<th class="text-center"><?php echo __('Updated By'); ?></th>
							...
							<tbody>
									<?php
										$i = 0;
										foreach ($doctorQualification['Doctor'] as $doctor): ?>
		<tr>
