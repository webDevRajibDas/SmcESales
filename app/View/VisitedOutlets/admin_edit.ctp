    ...
    <div class="col-md-12">
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><i class="glyphicon glyphicon-edit"></i>  <?php echo __('Admin Edit Visited Outlet'); ?></h3>
			...
			<div class="box-body">		
			<?php echo $this->Form->create('VisitedOutlet', array('role' => 'form')); ?>
					...
					<div class="form-group">
						<?php echo $this->Form->input('visited_at', array('class' => 'form-control')); ?>
					</div>
					<div class="form-group">
