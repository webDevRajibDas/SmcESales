    ...
    <div class="col-md-12">
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><i class="glyphicon glyphicon-edit"></i>  <?php echo __('Edit Designation'); ?></h3>
			...
			<div class="box-body">		
			<?php echo $this->Form->create('Designation', array('role' => 'form')); ?>
				<div class="form-group">
					<?php echo $this->Form->input('id', array('class' => 'form-control')); ?>
				</div>
				<div class="form-group">
					<?php echo $this->Form->input('designation_name', array('class' => 'form-control')); ?>
				</div>
...
<?php //pr($challan_info[0]['Requisition']);die; //pr($challan_info[0]['ChallanDetail']);die;?>

<div class="row">
    <div class="col-md-12">
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><i class="glyphicon glyphicon-edit"></i>  <?php echo __('Update DO Challan'); ?></h3>
				<div class="box-tools pull-right">
			...
			<div class="form-group">
				<?php echo $this->Form->input('receiver_store_id', array('id'=>'receiver_store_id','class' => 'form-control','empty'=>'---- Select Receiver ----','options'=>$receivers,'required'=>true,'selected'=>$challan_info[0]['Challan']['receiver_store_id'],'readonly')); ?>
			</div>
			<div class="form-group">
				<?php echo $this->Form->input('requisition_id', array('label'=>'DO No.','id'=>'requisition_id','class' => 'form-control requisition_id','empty'=>'---- Select DO ----','required'=>true,'selected'=>$challan_info[0]['Challan']['requisition_id'],'readonly')); ?>
			</div>
			<div class="form-group">
				<?php echo $this->Form->input('remarks', array('class' => 'form-control','value'=>$challan_info[0]['Challan']['remarks'])); ?>
			</div>			
			<div class="form-group">
				<?php echo $this->Form->input('Requisition.status', array('class' => 'form-control','type'=>'checkbox','label'=>'<b>Is DO Close :</b>','value'=>'2','default'=>$req_status[$challan_info[0]['Challan']['requisition_id']])); ?>
			</div>
			<div class="form-group">
			...
			<table class="table table-striped table-condensed table-bordered invoice_table">
				...
				<tbody>
					<?php $rowcount=1; foreach($challan_info[0]['ChallanDetail'] as $data) {
						if($data['virtual_product_name_show'] > 0){
					...
					<tr class="table_row" id="rowCount<?=$rowcount;?>">
						...
						<td>
							<input type="hidden" name="selected_product_id[]" class="selected_product_id" value="<?=$data['product_id']?><?=$data['batch_no']?><?=$data['expire_date']?>"/><?=$data['Product']['name']?>
							<input type="hidden" name="product_id[]" value="<?=$data['Product']['id']?>"/>
						</td>
						<td align="center">
							<input type="hidden" name="batch_no[]" value="<?=$data['batch_no']?>"><?=$data['batch_no']?>
						</td>
						<td align="center">
							<input type="hidden" name="expire_date[]" value="<?=$data['expire_date']?>"><?=$data['expire_date']?>
						</td>
						...
						<td align="center">
							<input type="hidden" name="quantity[]" class="p_quantity" value="<?=$data['challan_qty'];?>"><?=$data['challan_qty'];?>
						</td>
						<td align="center">
							<input type="text" class="full_width form-control" name="remarks[]" value="<?=$data['remarks']?>">
						</td>
						<td align="center">
