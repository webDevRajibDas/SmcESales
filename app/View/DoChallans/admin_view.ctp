					...
					<tbody>
						...
						<tr>		
							...
							<td>
                               ...
                               {
                                        echo $this->Form->input('received_date', array('type'=>'text','label'=>false, 'class' => 'form-control datepicker_range datepicker','required'=>true));
                                }else{								
						...
						<tr>		
							...
							<td><?php  echo $challan['Challan']['status'] == 1 ? '<span class="btn btn-warning btn-xs">Pending</span>' :($challan['Challan']['status'] == 0?'<span class="btn btn-info btn-xs">Draft</span>':'<span class="btn btn-Sucess btn-xs">Received</span>'); ?></td>
						</tr>
						<tr>		
					...
					<tbody>
						...
						if(!empty($challandetail))
						{
							...
							foreach($challandetail as $val){
								...
								if($val['ChallanDetail']['virtual_product_name_show'] > 0){
						...
						<tr>		
							...
							<td><input type="text" name="received_quantity[]" value="<?php echo $val['ChallanDetail']['challan_qty']; ?>"/></td>							
