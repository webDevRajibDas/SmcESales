    ...
    <div class="col-md-12">
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><i class="glyphicon glyphicon-edit"></i>  <?php echo __('Edit Receiver Office Person'); ?></h3>
			...
			<?php echo $this->Form->create('RecieverOfficePerson', array('role' => 'form')); ?>
				...
				<div class="form-group">
					<?php echo $this->Form->input('sales_person_id', array('class' => 'form-control','empty'=>'---- Select ----','options'=>$salesPeople,'id'=>'sales_person_id')); ?>
				</div>
