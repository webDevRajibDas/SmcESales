<div class="row">
    <div class="col-md-12">
		<div class="box box-primary">
			...
			<div class="box-body">		
			<?php echo $this->Form->create('DmsUser', array('action' => 'admin_add')); ?>
			<!--Start change Date 30-10-2019 -->
				...
				<!-- end change Date 30-10-2019 -->
				<div class="form-group">
					<?php echo $this->Form->input('DmsUser.dashboard', array('class' => 'form-control','id'=>'office_id','options'=>array('1'=>'Graphical Dashboard','2'=>'Normal Dashboard'))); ?>
				</div>
				<div class="form-group">
...
$(document).ready(function(){ 
	...
	$('#user_group_id').change(function(){
		...
		if(user_group == 1034){
			...
			$.ajax({    
			type : 'POST',
			url: '<?= BASE_URL.'dms_users/get_distributor_list_for_db_user'?>',
