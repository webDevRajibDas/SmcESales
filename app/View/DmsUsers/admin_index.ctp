		...
		<div class="box box-primary">
			<div class="box-header">
				...
				<div class="box-tools pull-right">
					<?php if($this->App->menu_permission('dms_users','admin_add')){ ?> <a href="<?php echo Router::url('/admin/dms_users/add'); ?>"><button class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i> New DB User</button></a> <?php } ?>			 		
				</div>
			</div>	
			<div class="box-body">               
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-center">
								...
								<?php if($this->App->menu_permission('dms_users','admin_edit')){  
								...
								<?php if($this->App->menu_permission('dms_users','admin_delete')){ ?> <?php echo $this->Form->postLink('<i class="glyphicon glyphicon-trash"></i>', array('action' => '/admin/dms_users/admin_delete', $row['User']['id']), array('class' => 'btn btn-danger btn-xs', 'escape' => false, 'data-toggle'=>'tooltip', 'title' => 'Delete','escape' => false, 'confirm' => __('Are you sure you want to delete this user? Delete it your own risk'))); ?> <?php } ?>
