    ...
    <div class="col-xs-12">		
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><i class="glyphicon glyphicon-eye-open"></i> <?php  echo __('NCP Challan Details'); ?></h3>
                ...
                <table class="table table-bordered">
					<tbody>
						...
						<tr>		
							...
							<td align="center"><?php echo $this->App->expire_dateformat($val['ChallanDetail']['expire_date']); ?></td>
							<td align="center">
								<?php
								if($challan['Challan']['status'] == 1 AND $office_paren_id !=0){
								?>
								...
								<input type="number" class="full_width form-control" name="receive_quantity[]" value="<?php echo $val['ChallanDetail']['challan_qty']; ?>"/>
								<?php
								}else{
								?>
								<?php echo $val['ChallanDetail']['received_qty']; ?>
								<?php
								}
								?>
							</td>
