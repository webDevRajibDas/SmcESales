    ...
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            <div class="box-body">		
                ...
                <div class="form-group">
                    <?php echo $this->Form->input('thana_id', array('class' => 'form-control thana_id','id'=>'thana_id', 'empty' => '---- Select ----','options'=>$thanas, 'selected'=>$this->request->data['DistRoute']['thana_id'])); ?>
                </div>
                <div class="form-group">
