    ...
    <div class="col-xs-12">
        <div class="box box-primary">
          ...
          <?php if($this->App->menu_permission('nationalSalesReports', 'admin_add')){ echo $this->Html->link(__('<i class="glyphicon glyphicon-plus"></i> New ProjectionAchievement Setting'), array('action' => 'add'), array('class' => 'btn btn-primary', 'escape' => false)); } ?>
            ...
            <div class="box-body" id="xls_body">

                <div class="search-box">
                    <?php echo $this->Form->create('DistDbWiseDetailSales', array('role' => 'form')); ?>
                    <table class="search">
                        <tr>
                        ...
                        <tr>
                            <td colspan="2">
                                <?php echo $this->Form->input('type', array('legend' => 'Type :', 'class' => 'type', 'type' => 'radio', 'default' => 'db', 'onClick' => 'typeChange(this.value)', 'options' => $types, 'required' => true));  ?>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                ...
                                <div id="sr_html">
                                    <?php echo $this->Form->input('sr_id', array('label' => 'Sales Representative', 'id' => 'sr_id', 'class' => 'form-control sr_id', 'required' => false, 'options' => $so_list, 'empty' => '---- All ----')); ?>
                                </div>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td class="columns_box">
                                <?php echo $this->Form->input('columns', array('legend' => 'Product Type :', 'class' => 'columns', 'type' => 'radio', 'default' => 'product', 'options' => $columns, 'required' => true));  ?>
                            </td>
                            <td></td>
                        </tr>
...
<script>
    ...
    $('.office_id').selectChain({
        ...
        data: {
            'office_id': 'office_id',
            'date_from': 'DistDbWiseDetailSalesDateFrom',
            'date_to': 'DistDbWiseDetailSalesDateTo'
        },
        <?php if (isset($db_id) && $db_id) { ?>
