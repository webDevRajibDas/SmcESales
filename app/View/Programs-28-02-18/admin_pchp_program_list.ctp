    ...
    <div class="col-xs-12">
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><i class="glyphicon glyphicon-th-large"></i> <?php echo __('PCHP Program List'); ?></h3>
				<div class="box-tools pull-right">
					<?php if($this->App->menu_permission('programs','admin_add_pchp')){ echo $this->Html->link(__('<i class="glyphicon glyphicon-plus"></i> Add/Edit PCHP Program'), array('action' => 'add_pchp'), array('class' => 'btn btn-primary', 'escape' => false)); } ?>
				</div>
			</div>	
			<div class="box-body">
                ...
                <table id="BonusCards" class="table table-bordered table-striped">
					<thead>
						<tr>
							...
							<th class="text-center"><?php echo $this->Paginator->sort('in_charge'); ?></th>
							<th class="text-center"><?php echo $this->Paginator->sort('ownar_name'); ?></th>
					...
					<tr>
						...
						<td class="text-left"><?php echo h($program['Outlet']['in_charge']); ?></td>
						<td class="text-left"><?php echo h($program['Outlet']['ownar_name']); ?></td>
						...
						<td class="text-center">
							<?php if($this->App->menu_permission('programs','admin_edit_pchp')){ echo $this->Html->link(__('<i class="glyphicon glyphicon-pencil"></i>'), array('action' => 'edit_pchp', $program['Program']['id']), array('class' => 'btn btn-warning btn-xs', 'escape' => false, 'data-toggle'=>'tooltip', 'title' => 'Deassigned')); } ?>
						</td>
					</tr>
					<?php endforeach; ?>
					</tbody>
