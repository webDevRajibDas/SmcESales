		...
		<div class="box box-primary">
			<div class="box-header">
				...
				<div class="box-tools pull-right">
					<?php if($this->App->menu_permission('programs','admin_add_bsp')){ echo $this->Html->link(__('<i class="glyphicon glyphicon-plus"></i> Add/Edit BSP Program'), array('action' => 'add_bsp'), array('class' => 'btn btn-primary', 'escape' => false)); } ?>
				</div>
			</div>	
			<div class="box-body">
                <div class="search-box">
					...
					<table class="search">
						...
						<tr>
							<td>							
								<?php echo $this->Form->input('market_id', array('id'=>'market_id', 'class' => 'form-control','empty'=>'---- Select ----','required'=>false)); ?>
							</td>
							<td></td>							
						</tr>					
						<tr align="center">
                ...
                <table id="BonusCards" class="table table-bordered table-striped">
					...
					<tr>
						...
						<td class="text-center">
							<?php if($this->App->menu_permission('programs','admin_edit_bsp')){ echo $this->Html->link(__('<i class="glyphicon glyphicon-pencil"></i>'), array('action' => 'edit_bsp', $program['Program']['id']), array('class' => 'btn btn-warning btn-xs', 'escape' => false, 'data-toggle'=>'tooltip', 'title' => 'Deassigned')); } ?>
						</td>
					</tr>
					<?php endforeach; ?>
					</tbody>
