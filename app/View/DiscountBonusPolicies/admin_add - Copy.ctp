		...
		<div class="option_'+x+'_product_wraps">\
			<div class="form-group">\
				<div class="input select">\
					...
					<input name="data[DiscountBonusPolicyOption]['+x+'][bonus_qty][]" class="form-control width_5" required  type="number" placeholder="Bonus Qty">\
	...
	<div class="discount_product">\
		<div class="form-group">\
			<div class="input text">\
				...
				<input name="data[DiscountBonusPolicyOption]['+x+'][discount_amount]" class="form-control discountAmount" type="text">\
			</div>\
			<div class="input text">\
