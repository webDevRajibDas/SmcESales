...
<?php
$obj = new DBCommissionReportsController();
?>
<style>
    .search .radio label {
        width: auto;
                    ...
                    <table class="search">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td ><?php echo $this->Form->input('report_type', array('legend' => 'Report Type :', 'class' => 'product_type', 'type' => 'radio', 'default' => '1', 'options' => array(1 => 'Details', 2 => 'Summary'), 'required' => true)); ?></td>
                            </tr>
                                ...
                                <table width="100%" class="table table-bordered">
                                    <tbody>
                                        <tr>
                                            ...
                                            <th ><div align="center">Numer of Orders</div></th>
                                        ...
                                        if (!empty($data)) {
                                            ...
                                            foreach ($data as $key => $value) {
                                                ...
                                                if ($distributor == $value[0]['distributor_name']) {
                                                    ...
                                                    $dist_distributor_id=$value[0]['distributor_id'];
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><div align="center"><?= $obj->get_area_executive_name($value[0]['office_id'], $value[0]['distributor_id']); ?></div></td>
                                                        <td>
                                                            <div align="center">
                                                                <?php
                                                                $tso_id = $obj->get_tso_name($value[0]['office_id'], $value[0]['distributor_id']);
                                                        ...
                                                        <td>
                                                            <div align="center">
                                                                ...
                                                                ?>
                                                                <?php
                                                                $commission = $obj->get_commissions($date_from, $date_to, $value[0]['price'], $value[0]['office_id'], $value[0]['distributor_id'], $value[0]['id']);
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div align="center">
                                                                <?php
                                                                 //echo $obj->get_total_challan($value[0]['office_id'], $value[0]['distributor_id'],$date_from,$date_to);
                                                                echo $value[0]['number_of_challans'];
                                                                $total_number_of_challans += $value[0]['number_of_challans'];
                                                                ?>
                                                            </div>
                                ...
                                if (!empty($data)) {
                                    ...
                                    <table width="100%" class="table table-bordered" style="text-align: center;">
                                        <tbody>
                                            ...
                                            $i = 0;
                                            $tso_id = $obj->get_tso_name($data[0][0]['office_id'], $data[0][0]['distributor_id']);
                                            $area_excutive_id = $obj->get_area_executive_id($data[0][0]['office_id'], $data[0][0]['distributor_id']);
...
<script>
   $('body').on("change", "#office_id", function () {
    ...
    function get_area_executive(office_id){
        $.ajax({
                url: '<?= BASE_URL ?>DBCommissionReports/get_area_executive',
                'type': 'POST',
    ...
    $('body').on("change", "#dist_area_executive_id", function () {
        ...
        get_tso(dist_area_executive_id);
    });
    function get_tso(dist_area_executive_id){
         var office_id = $('#office_id').val();
        $.ajax({
                url: '<?= BASE_URL ?>DBCommissionReports/get_tso',
                'type': 'POST',
    ...
    $('body').on("change", "#dist_tso_id", function () {
        ...
        get_distributor(dist_tso_id);
    });
    function get_distributor(dist_tso_id){
         var office_id = $('#office_id').val();
         var dist_area_executive_id = $('#dist_area_executive_id').val();
        $.ajax({
                url: '<?= BASE_URL ?>DBCommissionReports/get_distributor',
                'type': 'POST',
                data: {office_id: office_id,dist_area_executive_id:dist_area_executive_id,dist_tso_id:dist_tso_id},
                success: function (response) {
                    var obj = jQuery.parseJSON(response);
    ...
    function get_products(product_category_id) {
        if (product_category_id != '') {
            $.ajax({
                url: '<?= BASE_URL ?>DBCommissionReports/get_products',
                'type': 'POST',
    ...
    $('body').on("change", "#dist_tso_id", function () {
        ...
        var dist_area_executive_id = $('#dist_area_executive_id').val()
        var dist_tso_id = $(this).val();
        get_ae_tso_dist(office_id,dist_area_executive_id,dist_tso_id);
    });
