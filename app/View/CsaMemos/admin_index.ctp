...
// echo $this->request->data['CsaMemo']['market_id'];
    ...
    <div class="col-xs-12">
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><i class="glyphicon glyphicon-th-large"></i> <?php echo __('Csa Memo List'); ?></h3>
				<div class="box-tools pull-right">
					<?php if($this->App->menu_permission('memos','admin_create_memo')){ ?>
						<a class="btn btn-primary" href="<?=BASE_URL?>admin/memos/create_memo?csa=1"><i class="glyphicon glyphicon-plus"></i> New Csa Memo</a>
					<?php } ?>
			...
			<div class="box-body">
				<div class="search-box">
					<?php echo $this->Form->create('CsaMemo', array('role' => 'form', 'action'=>'filter')); ?>
					<table class="search">
						<tr>
							...
							<td><?php echo $this->Form->input('csa_memo_no', array('class' => 'form-control','required'=>false)); ?></td>								
						</tr>					
						<tr>
							<td><?php echo $this->Form->input('csa_id', array('class' => 'form-control ', 'id' => 'csa_id','empty'=>'--- Select Csa ---','required'=>'required')); ?> </td>
							<td>
								<?php echo $this->Form->input('date_from', array('class' => 'form-control datepicker','value'=>(isset($this->request->data['CsaMemo']['date_from'])=='' ? $current_date : $this->request->data['CsaMemo']['date_from']),'required'=>false)); ?>
							</td>
						...
						<tr>
							...
							<td>
								<?php echo $this->Form->input('date_to', array('class' => 'form-control datepicker','value'=>(isset($this->request->data['CsaMemo']['date_to'])=='' ? $current_date : $this->request->data['CsaMemo']['date_to']),'required'=>false)); ?>
							</td>
														
						</tr>	
						<tr>
						<td><?php echo $this->Form->input('thana_id', array('class' => 'form-control ', 'id' => 'thana_id','empty'=>'--- Select Thana ---')); ?> </td>
							<td></td>
				...
				<table id="CsaMemo" class="table table-bordered">
					<thead>
						<tr>
							<th width="50" class="text-center"><?php echo $this->Paginator->sort('id'); ?></th>
							<th class="text-center"><?php echo $this->Paginator->sort('csa_memo_no'); ?></th>
							...
							<th class="text-center"><?php echo $this->Paginator->sort('gross_value','CsaMemo Total'); ?></th>
					...
					<tr style="background-color:<?php echo $memo['CsaMemo']['from_app']==0 ? '#f5f5f5':'white'?>">
						<td align="center"><?php echo h($memo['CsaMemo']['id']); ?></td>
						<td align="center"><?php echo h($memo['CsaMemo']['csa_memo_no']); ?></td>
						...
						<td align="center"><?php echo sprintf('%.2f',$memo['CsaMemo']['gross_value']); ?></td>
						<td align="center"><?php echo $this->App->datetimeformat($memo['CsaMemo']['memo_time']); ?></td>
						<td align="center">
                        ...
                        <td class="text-center">
							<?php if($this->App->menu_permission('csa_memos', 'admin_view')){ echo $this->Html->link(__('<i class="glyphicon glyphicon-eye-open"></i>'), array('action' => 'view', $memo['CsaMemo']['id']), array('class' => 'btn btn-primary btn-xs', 'escape' => false, 'data-toggle'=>'tooltip', 'title' => 'view')); } ?>
							
							<?php if($memo['CsaMemo']['action']!=0){?>
							
                            	
                                <?php if($memo['CsaMemo']['status']==0){?>
									<?php if($this->App->menu_permission('memos','admin_edit')){ echo $this->Html->link(__('<i class="glyphicon glyphicon-pencil"></i>'), array('action' => 'edit', $memo['CsaMemo']['id']), array('class' => 'btn btn-warning btn-xs', 'escape' => false, 'data-toggle'=>'tooltip', 'title' => 'edit')); } ?>
                                <?php } ?>
                            
								<?php if($this->App->menu_permission('csa_memos', 'admin_delete')){ echo $this->Form->postLink(__('<i class="glyphicon glyphicon-trash"></i>'), array('action' => 'delete', $memo['CsaMemo']['id']), array('class' => 'btn btn-danger btn-xs', 'escape' => false, 'data-toggle'=>'tooltip', 'title' => 'delete'), __('Are you sure you want to delete # %s?', $memo['CsaMemo']['id'])); } ?>
					...
					<?php 
					$total_amount = $total_amount + $memo['CsaMemo']['gross_value'];
					endforeach; 					
					?>
					<tr>
...
<!-- Report Print -->
	...
	<div id="content" style="width:90%;height:100%;margin-left:5%;margin-right:5%;">
		...
		<div style="width:100%;text-align:center;float:left">
			...
			<h5><?php if(!empty($requested_data)){ ?><strong>Between:</strong>&nbsp;&nbsp;<u><?php  echo $requested_data['CsaMemo']['date_from']; ?>&nbsp;&nbsp;to&nbsp;&nbsp;<?php echo $requested_data['CsaMemo']['date_to']; }?></u>&nbsp;&nbsp;&nbsp;&nbsp;<strong>Reporting Date:</strong>&nbsp;&nbsp;<?php echo date('d-F-Y');?></h5>
			<h4>Area : <?php echo $offices[$requested_data['CsaMemo']['office_id']];?></h4>
		</div>	  
