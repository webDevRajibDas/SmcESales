        ...
        <div class="box box-primary">
            <div class="box-body" style="overflow-x:auto;">
                ...
                <div class="form-group">
                    <?php echo $this->Form->input('dist_distributor_id', array('label' => 'Distributor Name', 'id' => 'dist_distributor_id', 'class' => 'form-control', 'empty' => '------ Please Select ------', 'default' => $territory_id ? $territory_id : "")); ?> 
                </div>
                <div class="form-group">
