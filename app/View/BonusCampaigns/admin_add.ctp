    ...
    <div class="col-md-12">
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><i class="glyphicon glyphicon-edit"></i>  <?php echo __('Add Bonus Campaign'); ?></h3>
			...
			<?php echo $this->Form->create('BonusCampaign', array('role' => 'form', 'enctype'=>'multipart/form-data')); ?>
				...
				<div class="form-group">
					<div class="form-group required">
						<label>Product :</label>
						<?php echo $this->Form->input('product_id', array('class' => 'form-control','required' => true, 'empty'=>'---- Select Product ----', 'label'=>false, 'options' => $products,'name'=>'data[BonusCampaign][product_id][]')); ?>
				...
				<div class="create_for">
					<?php echo $this->Form->input('create_for', array('label'=>'Create For :', 'class' => 'checkbox-inline',  'multiple' => 'checkbox', 'options' => array('1'=>'SO','2'=>'SR'),'div'=>false,'hiddenField'=>false)); ?>
				</div>
				</div>
