                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-left">
                                <div class="form-group">
                                    <?php echo $this->Form->input('outlet_coverage_pharma', array('class' => 'form-control-1 target_outlet_coverage_pharma sales', 'name' => 'data[SaleTarget][outlet_coverage_pharma]', 'label' => '')); ?>
                                </div>
                            </td>
                            <td class="text-left">
                                <div class="form-group">
                                    <?php echo $this->Form->input('outlet_coverage_non_pharma', array('class' => 'form-control-1 target_outlet_coverage_non_pharma sales', 'name' => 'data[SaleTarget][outlet_coverage_non_pharma]', 'label' => '')); ?>
                                </div>
                            </td>
                            <td class="text-left">
                                <div class="form-group">
                                    <?php echo $this->Form->input('effective_call_pharma', array('class' => 'form-control-1 target_outlet_coverage_non_pharma sales', 'name' => 'data[SaleTarget][effective_call_pharma]', 'label' => '')); ?>
                                </div>
                            </td>
                            <td class="text-left">
                                <div class="form-group">
                                    <?php echo $this->Form->input('effective_call_non_pharma', array('class' => 'form-control-1 target_effective_call sales', 'name' => 'data[SaleTarget][effective_call_non_pharma]', 'label' => '')); ?>
                                </div>
                            </td>
                            <td class="text-left">
                                <div class="form-group">
                                    <?php echo $this->Form->input('session', array('class' => 'sales form-control-1 target_session', 'name' => 'data[SaleTarget][session]', 'label' => '')); ?>
                                </div>
                            </td>
...
<script>
    function get_val() {
        ...
        if (FiscalYearId !== '')
        {
            $.ajax({
                type: "POST",
                url: "<?php echo BASE_URL; ?>admin/NationalTargetEffectiveCallOutletCoverageSessions/get_national_target_effective_call_outlet_coverage_session",
        ...
        } else
        {
            ...
            $("input[name='data[SaleTarget][effective_call_pharma]'").val('0.00');
            $("input[name='data[SaleTarget][effective_call_non_pharma]'").val('0.00');
