                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-left">
                                <div class="form-group">
                                    <?php echo $this->Form->input('effective_call_pharma', array('class' => 'form-control-1 target_outlet_coverage_non_pharma', 'name' => 'data[SaleTarget][effective_call_pharma]', 'label' => '', 'value' => '0.00')); ?>
                                </div>
                            </td>
                            <td class="text-left">
                                <div class="form-group">
                                    <?php echo $this->Form->input('effective_call_non_pharma', array('class' => 'form-control-1 target_effective_call', 'name' => 'data[SaleTarget][effective_call_non_pharma]', 'label' => '', 'value' => '0.00')); ?>
                                </div>
                            </td>
                            <td class="text-left">
                                <div class="form-group">
