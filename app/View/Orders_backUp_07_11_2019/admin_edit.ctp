      ...
      <div class="box box-primary">
       ...
       <div class="box-body">
         ...
         <div class="form-group">
            <?php echo $this->Form->input('office_id', array('id' => 'office_id', 'class' => 'form-control office_id','required'=>TRUE, 'selected'=>$existing_record['Order']['office_id'])); ?>
        ...
        <?php if($maintain_dealer_type==1){?>
         <div class="form-group"  id="distribut_outlet_id_so">
                   <?php echo $this->Form->input('distribut_outlet_id', array('label' => 'Dealer :', 'id' => 'distribut_outlet_id', 'class' => 'form-control distribut_outlet_id', 'required' => TRUE, 'options' => $outlets, 'selected'=>$existing_record['outlet_id'], 'disabled'=>'disabled')); ?>
...
<div class="form-group" style="padding-top:20px;">
    <div class="pull-right">
      <?php if($existing_record['Order']['status']==0) {?>
