    ...
    <div class="col-xs-12">
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><i class="glyphicon glyphicon-th-large"></i> <?php echo __('Order List'); ?></h3>
				<div class="box-tools pull-right">
					<?php if($this->App->menu_permission('orders','admin_create_order')){ echo $this->Html->link(__('<i class="glyphicon glyphicon-plus"></i> New Order'), array('action' => 'create_order'), array('class' => 'btn btn-primary', 'escape' => false)); } ?>
					...
					//} ?>
					<?php if($this->App->menu_permission('orders','admin_order_map')){ echo $this->Html->link(__('<i class="glyphicon glyphicon-map-marker"></i> Order on Map'), array('action' => 'order_map'), array('class' => 'btn btn-success', 'escape' => false)); } ?>
				</div>
			</div>	
			<div class="box-body">
				<div class="search-box">
					...
					<table class="search">
						...
						<tr>
							...
							<td width="50%"><?php echo $this->Form->input('order_no', array('class' => 'form-control','required'=>false)); ?></td>							
						</tr>					
						...
						<tr>
							...
							<td><?php echo $this->Form->input('outlet_id', array('label' => 'Dealer:','id' => 'outlet_id','class' => 'form-control distribut_outlet_id','required'=>false,'empty'=>'---- Select Dealer ----','options')); ?>
				...
				<table id="Order" class="table table-bordered">
					<thead>
						<tr>
                            ...
                            <th class="text-center"><?php echo $this->Paginator->sort('order_status'); ?></th>
					...
					<tr style="background-color:<?php echo $order['Order']['from_app']==0 ? '#f5f5f5':'white'?>">
						...
						<td align="center"><?php echo $this->App->datetimeformat($order['Order']['order_time']); ?></td>
