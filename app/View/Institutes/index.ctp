			...
			<div class="box-body">
                <table id="Institutes" class="table table-bordered table-striped">
					...
					<tr>
						...
						<td class="text-center"><?php echo h($institute['Institute']['short_name']); ?></td>
						<td class="text-center"><?php echo h($institute['Institute']['name']); ?></td>
						<td class="text-center"><?php echo h($institute['Institute']['type']); ?></td>
						<td class="text-center"><?php echo h($institute['Institute']['address']); ?></td>
						<td class="text-center"><?php echo h($institute['Institute']['email']); ?></td>
						<td class="text-center"><?php echo h($institute['Institute']['telephone']); ?></td>
						<td class="text-center"><?php echo h($institute['Institute']['contactname']); ?></td>
						<td class="text-center"><?php echo h($institute['Institute']['is_active']); ?></td>
