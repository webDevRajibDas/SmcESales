<?php
App::import('Controller', 'DistQueryOnSalesReportsController');
$controller = new DistQueryOnSalesReportsController;
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="search-box">
                    ...
                    <?php echo $this->Form->create('DistQueryOnSalesReports', array('role' => 'form', 'action' => 'index')); ?>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr id="<?= $i ?>">
                                                        ...
                                                        <td style="width:20%">
                                                            <?php echo $this->Form->input('product_id', array('label' => false, 'id' => 'product_id', 'class' => 'form-control product_id', 'required' => true, 'empty' => '---- Select Product ----', 'options' => $product_list, 'style' => 'width:100%', 'name' => 'data[DistQueryOnSalesReports][product_id][]', 'value' => $row['product_id'], 'required' => true)); ?>
                                                        </td>
                                                        <td class="mobile_td"><b>Comparator</b></td>
                                                        <td style="width:20%">
                                                            <?php echo $this->Form->input('compotator', array('label' => false, 'id' => 'compotator', 'class' => 'form-control compotator', 'required' => true, 'empty' => '---- Select Compotator ----', 'options' => $compotators, 'style' => 'width:100%', 'name' => 'data[DistQueryOnSalesReports][compotator][]', 'value' => $row['compotator'], 'required' => true)); ?>
                                                        </td>
                                                        <td class="mobile_td"><b>Qty</b></td>
                                                        <td style="width:10%">
                                                            <?php echo $this->Form->input('qty', array('class' => 'form-control qty', 'label' => false, 'required' => true, 'style' => 'width:100%', 'name' => 'data[DistQueryOnSalesReports][qty][]', 'value' => $row['qty'])); ?>
                                                        </td>
                                                        <td class="mobile_td"><b>...</b></td>
                                                        <td style="width:10%">


                                                            <?php echo $this->Form->input('qty2', array('class' => 'form-control qty2', 'label' => false, 'id' => 'qty2', 'disabled' => 'disabled', 'style' => 'width:100%', 'name' => 'data[DistQueryOnSalesReports][qty2][]', 'value' => $row['qty2'], 'disabled' => $row['qty2'] ? false : 'disabled',)); ?>
                                                        ...
                                                        <td style="width:20%">
                                                            <?php echo $this->Form->input('memo_total', array('label' => false, 'id' => 'memo_total', 'class' => 'form-control memo_total', 'required' => true, 'empty' => '---- Select Compotator ----', 'options' => $memo_totals, 'style' => 'width:100%', 'name' => 'data[DistQueryOnSalesReports][memo_total][]', 'value' => $row['memo_total'])); ?>
                                                        </td>
                                                ...
                                                <tr id="1">
                                                    <td class="mobile_td"><b>Product</b></td>
                                                    <td style="width:20%">
                                                        <?php echo $this->Form->input('product_id', array('label' => false, 'id' => 'product_id', 'class' => 'form-control product_id', 'required' => true, 'empty' => '---- Select Product ----', 'options' => $product_list, 'style' => 'width:100%', 'name' => 'data[DistQueryOnSalesReports][product_id][]', 'required' => true,)); ?>
                                                    </td>
                                                    <td class="mobile_td"><b>Comparator</b></td>
                                                    <td style="width:20%">
                                                        <?php echo $this->Form->input('compotator', array('label' => false, 'id' => 'compotator', 'class' => 'form-control compotator', 'required' => true, 'empty' => '---- Select Compotator ----', 'options' => $compotators, 'style' => 'width:100%', 'name' => 'data[DistQueryOnSalesReports][compotator][]', 'required' => true,)); ?>
                                                    </td>
                                                    <td class="mobile_td"><b>Qty</b></td>
                                                    <td style="width:10%">
                                                        <?php echo $this->Form->input('qty', array('class' => 'form-control qty', 'label' => false, 'required' => true, 'style' => 'width:100%', 'name' => 'data[DistQueryOnSalesReports][qty][]')); ?>
                                                    </td>
                                                    <td class="mobile_td"><b>...</b></td>
                                                    <td style="width:10%">
                                                        <?php echo $this->Form->input('qty2', array('class' => 'form-control qty2', 'label' => false, 'id' => 'qty2', 'disabled' => 'disabled', 'style' => 'width:100%', 'name' => 'data[DistQueryOnSalesReports][qty2][]')); ?>
                                                    </td>
                                                    <td class="mobile_td"><b>Memo/Total</b></td>
                                                    <td style="width:20%">
                                                        <?php echo $this->Form->input('memo_total', array('class' => 'form-control memo_total', 'label' => false, 'id' => 'memo_total', 'options' => $memo_totals, 'required' => true, 'style' => 'width:100%', 'name' => 'data[DistQueryOnSalesReports][memo_total][]')); ?>
                                                    </td>
                                ...
                                <div style="float:left; width:100%; height:430px; overflow:scroll;">
                                    ...
                                    <table cellspacing="0" cellpadding="10px" border="1px solid black" align="center" class="text-center report_table" id="sum_table">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        <td colspan="9" style="text-align:left;"><b>Report for: <?= $product_name ?> <?= $compare_compotato ?> <?= $compare_qty ?> <?= $compare_compotato == 'between' ? 'To ' . $compare_qty2 : '' ?> (<?= $unit_type_text ?> Unit - <?= ($product_compotator[$product_id]['memo_total'] == 'permemo') ? 'Per Memo' : 'Memo Total' ?>)</b></td>
                                                    </tr>
                                                    ...
                                                    ?>
                                                        ...
                                                        ?>
                                                                <tr class="">
                                                                    <td style="text-align:left;"><?= $outlet_data['aso'] ?></td>
                                                                    <td style="text-align:left;"><?= $outlet_data['tso'] ?></td>
                                                                    <td style="text-align:left;"><?= $outlet_data['db'] ?></td>
                                                                    <td style="text-align:left;"><?= $outlet_data['sr'] ?></td>
                                                                    <td style="text-align:left;"><?= $outlet_data['route'] ?></td>
                                                                    <td style="text-align:left;"><?= $outlet_data['market_name'] ?></td>
...
<script>
    ...
    /*$('.office_id').selectChain({
        target: $('.tso_id'),
        value:'name',
        url: '<?= BASE_URL . 'DistQueryOnSalesReports/get_tso_list' ?>',
        type: 'post',
    ...
    $('.tso_id').selectChain({
        target: $('.dist_id'),
        value: 'name',
        url: '<?= BASE_URL . 'DistQueryOnSalesReports/get_distributor_list' ?>',
        type: 'post',
        data: {
            'office_id': 'office_id',
            'tso_id': 'tso_id'
