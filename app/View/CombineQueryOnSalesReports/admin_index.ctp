<?php
App::import('Controller', 'CombineQueryOnSalesReportsController');
$controller = new CombineQueryOnSalesReportsController;
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="search-box">
                    ...
                    <?php echo $this->Form->create('CombineQueryOnSalesReports', array('role' => 'form', 'action' => 'index')); ?>
                        ...
                        <tr>
                            <td>
                                <div id="territory_html">
                                    <?php echo $this->Form->input('territory_id', array('id' => 'territory_id', 'class' => 'form-control chosen territory_id office_t_so', 'required' => false, 'empty' => '---- All ----', 'multiple' => true)); ?>
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr id="<?= $i ?>">
                                                        ...
                                                        <td style="width:30%">
                                                            <?php foreach ($row['product_id'] as $key_p => $pid) { ?>
                                                                <div class="product">
                                                                    <?php echo $this->Form->input('product_id', array('label' => false, 'id' => 'product_id', 'class' => 'form-control product_id', 'required' => true, 'empty' => '---- Select Product ----', 'options' => $product_list, 'style' => 'width:90%', 'name' => 'data[CombineQueryOnSalesReports][product_id][' . $i . '][]', 'value' => $pid, 'required' => true)); ?>
                                                                    <?php if ($key_p == 0) { ?>
                                                        ...
                                                        <td style="width:20%">
                                                            <?php echo $this->Form->input('compotator', array('label' => false, 'id' => 'compotator', 'class' => 'form-control compotator', 'required' => true, 'empty' => '---- Select Compotator ----', 'options' => $compotators, 'style' => 'width:100%', 'name' => 'data[CombineQueryOnSalesReports][compotator][' . $i . ']', 'value' => $row['compotator'], 'required' => true)); ?>
                                                        </td>
                                                        <td class="mobile_td"><b>Volume/Value</b></td>
                                                        <td style="width:20%">
                                                            <?php echo $this->Form->input('volume_or_value', array('label' => false, 'id' => 'volume_or_value', 'class' => 'form-control volume_or_value', 'required' => true, 'options' => $volumes_values, 'style' => 'width:100%', 'name' => 'data[CombineQueryOnSalesReports][volume_or_value][' . $i . ']', 'required' => true, 'value' => $row['volume_or_value'])); ?>
                                                        </td>
                                                        <td class="mobile_td"><b>From</b></td>
                                                        <td style="width:10%">
                                                            <?php echo $this->Form->input('qty', array('class' => 'form-control qty', 'label' => false, 'required' => true, 'style' => 'width:100%', 'name' => 'data[CombineQueryOnSalesReports][qty][' . $i . ']', 'value' => $row['qty'])); ?>
                                                        </td>
                                                        <td class="mobile_td"><b>To</b></td>
                                                        <td style="width:10%">


                                                            <?php echo $this->Form->input('qty2', array('class' => 'form-control qty2', 'label' => false, 'id' => 'qty2', 'disabled' => 'disabled', 'style' => 'width:100%', 'name' => 'data[CombineQueryOnSalesReports][qty2][' . $i . ']', 'value' => $row['qty2'], 'disabled' => $row['qty2'] ? false : 'disabled',)); ?>
                                                        ...
                                                        <td style="width:20%">
                                                            <?php echo $this->Form->input('memo_total', array('label' => false, 'id' => 'memo_total', 'class' => 'form-control memo_total', 'required' => true, 'empty' => '---- Select Compotator ----', 'options' => $memo_totals, 'style' => 'width:100%', 'name' => 'data[CombineQueryOnSalesReports][memo_total][' . $i . ']', 'value' => $row['memo_total'])); ?>
                                                        </td>
                                                ...
                                                <tr id="1">
                                                    ...
                                                    <td style="width:30%">
                                                        <div class="product">
                                                            <?php echo $this->Form->input('product_id', array('label' => false, 'id' => 'product_id', 'class' => 'form-control product_id', 'required' => true, 'empty' => '---- Select Product ----', 'options' => $product_list, 'style' => 'width:90%', 'name' => 'data[CombineQueryOnSalesReports][product_id][1][]', 'required' => true,)); ?>
                                                            <a href="#" class="btn btn-xs btn-success add_more_product" style="margin-top:0%"><i class="fa fa-plus"></i></a>
                                                        </div>
                                                    </td>
                                                    <td class="mobile_td"><b>Comparator</b></td>
                                                    <td style="width:20%">
                                                        <?php echo $this->Form->input('compotator', array('label' => false, 'id' => 'compotator', 'class' => 'form-control compotator', 'required' => true, 'empty' => '---- Select Compotator ----', 'options' => $compotators, 'style' => 'width:100%', 'name' => 'data[CombineQueryOnSalesReports][compotator][1]', 'required' => true,)); ?>
                                                    </td>
                                                    <td class="mobile_td"><b>Volume/Value</b></td>
                                                    <td style="width:20%">
                                                        <?php echo $this->Form->input('volume_or_value', array('label' => false, 'id' => 'compotator', 'class' => 'form-control volume_or_value', 'required' => true, 'options' => $volumes_values, 'style' => 'width:100%', 'name' => 'data[CombineQueryOnSalesReports][volume_or_value][1]', 'required' => true,)); ?>
                                                    </td>
                                                    <td class="mobile_td"><b>From</b></td>
                                                    <td style="width:10%">
                                                        <?php echo $this->Form->input('qty', array('class' => 'form-control qty', 'label' => false, 'required' => true, 'style' => 'width:100%', 'name' => 'data[CombineQueryOnSalesReports][qty][1]')); ?>
                                                    </td>
                                                    <td class="mobile_td"><b>To</b></td>
                                                    <td style="width:10%">
                                                        <?php echo $this->Form->input('qty2', array('class' => 'form-control qty2', 'label' => false, 'id' => 'qty2', 'disabled' => 'disabled', 'style' => 'width:100%', 'name' => 'data[CombineQueryOnSalesReports][qty2][1]')); ?>
                                                    </td>
                                                    <td class="mobile_td"><b>Memo/Total</b></td>
                                                    <td style="width:20%">
                                                        <?php echo $this->Form->input('memo_total', array('class' => 'form-control memo_total', 'label' => false, 'id' => 'memo_total', 'options' => $memo_totals, 'required' => true, 'style' => 'width:100%', 'name' => 'data[CombineQueryOnSalesReports][memo_total][1]')); ?>
                                                    </td>
                                    ...
                                    <table cellspacing="0" cellpadding="10px" border="1px solid black" align="center" class="text-center report_table" id="sum_table">
                                        <thead>
                                            <tr class="titlerow">
                                                ...
                                                <th style="text-align:left;">Market-Thana-District</th>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <?php foreach ($results as $data) { ?>
                                                    <tr>
                                                        <td colspan="6" style="text-align:left;"><?= $data['heading_td'] ?></td>
                                                    </tr>
                                                    <?php
                                                    $total_outlet = 0;
                                                    $total_qty = 0;
                                                    ...
                                                    <?php foreach ($data['details'] as $rpt_data) { ?>
                                                        <tr class="">
                                                            <td style="text-align:left;"><?= $rpt_data['outlet_name'] ?></td>
                                                            <td style="text-align:left;"><?= $rpt_data['categories'] ?></td>
                                                            <td style="text-align:left;"><?= $rpt_data['mkt_thana_dis'] ?></td>
                                                            <td><?= $rpt_data['office_name'] ?></td>
                                                    ...
                                                    <tr style="background:#f7f7f7; font-weight:bold;">
                                                        ...
                                                        <td style="text-align:right;"><?= sprintf("%01.2f", $total_value) ?></td>
                                                ...
                                                <tr style="background:#f7f7f7; font-weight:bold;">
                                                    ...
                                                    <td style="text-align:right;"><?= sprintf("%01.2f", $g_total_value) ?></td>
...
<script>
    ...
    $('.office_id').selectChain({
        ...
        afterSuccess: function() {
            $('.territory_id').trigger("chosen:updated");
        }
    });
</script>
    ...
    $(document).ready(function() {
        ...
        $(document).on({
            click: function(e) {
                ...
                var current_row_no = $(this).parent().parent().parent().find('tr:last').attr('id');
                ...
                if (valid_row != '') {
                    var tr = '<tr id=' + sl + '>\
                            ...
                            <td>\
                            <a href="#" class="btn btn-xs btn-danger remove_row filter_mobile" style="margin-top:0%"><i class="glyphicon glyphicon-trash"></i></a>\
                            </td>\
                          </tr>';
                    ...
                    $('tr#' + sl + ' td .product_id').attr('name', 'data[CombineQueryOnSalesReports][product_id][' + sl + '][]');
                    $('tr#' + sl + ' td .qty2').attr('name', 'data[CombineQueryOnSalesReports][qty2][' + sl + ']');
                    $('tr#' + sl + ' td .compotator').attr('name', 'data[CombineQueryOnSalesReports][compotator][' + sl + ']');
                    $('tr#' + sl + ' td .volume_or_value').attr('name', 'data[CombineQueryOnSalesReports][volume_or_value][' + sl + ']');
                    $('tr#' + sl + ' td .qty').attr('name', 'data[CombineQueryOnSalesReports][qty][' + sl + ']');
                    $('tr#' + sl + ' td .memo_total').attr('name', 'data[CombineQueryOnSalesReports][memo_total][' + sl + ']');
