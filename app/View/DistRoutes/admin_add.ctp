    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title"><i class="glyphicon glyphicon-edit"></i>  <?php echo __('Add Route/Beat'); ?></h3>
            ...
            <div class="box-body">		
                ...
                <div class="form-group required">
                    <?php echo $this->Form->input('district_id', array('class' => 'form-control district','id'=>'district_id', 'empty' => '---- Select ----','required'=>true)); ?>
                </div>
                <div class="form-group required">
                    <?php echo $this->Form->input('thana_id', array('class' => 'form-control thana_id','id'=>'thana_id', 'empty' => '---- Select ----','required'=>true)); ?>
                </div>
                <div class="form-group">
