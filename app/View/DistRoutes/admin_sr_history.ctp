    ...
    <div class="col-xs-12">
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title"><i class="glyphicon glyphicon-th-large"></i> <?php echo __('Sales Representatives and Route/Beat Mapping History'); ?></h3>
                <div class="box-tools pull-right">
                    <?php
                    if ($this->App->menu_permission('DistSalesRepresentatives', 'admin_index')) {
                        echo $this->Html->link(__('<i class="glyphicon glyphicon-th-large"></i> Sales Representatives List'), array('controller'=>'DistSalesRepresentatives','action' => 'index'), array('class' => 'btn btn-primary', 'escape' => false));
                    }
                    ?>
                </div>
            </div>	
            <div class="box-body">
                <div class="search-box">
                    <?php echo $this->Form->create('DistRoutes', array('role' => 'form', 'action' => 'sr_history')); ?>
                    <table class="search">
                        ...
                        <tr><td width="50%"><?php echo $this->Form->input('dist_sr_id', array('label' => 'Sales Representatives', 'id' => 'dist_sr_id', 'class' => 'form-control', 'required' => false, 'empty' => '---- Select Sales Representatives ----','options'=>$distsrs,'selected'=>$dist_sr_id)); ?></td></tr>
                ...
                <table id="Territories" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center"><?php echo "SR Name"; ?></th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $value['DistSalesRepresentative']['name'];?></td>
...
<script>
   ...
   $('#dist_sr_id').selectChain({
        ...
        value: 'name',
        url: '<?= BASE_URL . 'DistRoutes/get_sr_route_list' ?>',
        type: 'post',
    ...
    $('#dist_distributor_id').selectChain({
        target: $('#dist_sr_id'),
        value: 'name',
        url: '<?= BASE_URL . 'DistRoutes/get_sr_sr_list' ?>',
        type: 'post',
