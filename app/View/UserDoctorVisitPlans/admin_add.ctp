    ...
    <div class="col-md-12">
		<div class="box box-primary">
			...
			<?php echo $this->Form->create('UserDoctorVisitPlan', array('role' => 'form')); ?>
                    ...
                    <div class="form-group">
                        <?php echo $this->Form->input('territory_id', array('id'=>'territory_id', 'class' => 'form-control territory_id', 'empty' => '---- Select ----', 'options' => '')); ?>
                    </div>
                    <div class="form-group">
...
$(document).ready(function () {
	...
	$('body').on('click','.doctor_id_click',function(){
		...
		{
			/*checked_doctor=$.grep(checked_doctor, function(value){
		...
		console.log(checked_doctor.size());*/
	});
...
$(".submit").click(function(e){
	...
	$("#UserDoctorVisitPlanAdminAddForm").submit();
});
});
</script>