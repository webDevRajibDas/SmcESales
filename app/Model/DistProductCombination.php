 ...
 */
class DistProductCombination extends AppModel {
 ...
 */
	public $belongsTo = array(
		...
		'DistProductPrice' => array(
			'className' => 'DistProductPrice',
		...
		'DistCombination' => array(
			'className' => 'DistCombination',
	...
	public function filter($params, $conditions) {
		if (!empty($params['DistProductCombination.product_id'])) {
            $conditions = array('DistProductCombination.product_id' => $params['DistProductCombination.product_id']);
        }
        return $conditions;
    }
