 ...
 */
	...
	public function filter($params, $conditions) {
		...
		if (!empty($params['Program.office_id'])) {
            $conditions[] = array('Territory.office_id' => $params['Program.office_id']);
        }
		if (!empty($params['Program.territory_id'])) {
            $conditions[] = array('Program.territory_id' => $params['Program.territory_id']);
        }
		if (!empty($params['Program.market_id'])) {
            $conditions[] = array('Program.market_id' => $params['Program.market_id']);
        }
