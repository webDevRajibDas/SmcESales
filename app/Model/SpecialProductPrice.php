 ...
 */
class SpecialProductPrice extends AppModel {

	public function filter($params, $conditions) {
		$conditions = array();
		
		if (!empty($params['Product.product_category_id'])) {
            $conditions[] = array('SpecialProductPrice.id' => $params['Product.product_category_id']);
        }
		if (!empty($params['SpecialProductPrice.institute_id'])) {
            $conditions[] = array('SpecialProductPrice.institute_id' => $params['SpecialProductPrice.institute_id']);
        }
		if (!empty($params['SpecialProductPrice.target_custommer'])) {
            $conditions[] = array('SpecialProductPrice.target_custommer' => $params['SpecialProductPrice.target_custommer']);
        }
        return $conditions;
    }
