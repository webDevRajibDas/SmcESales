 ...
 */
class DistDistributorWiseCommission extends AppModel {
    ...
    public function filter($params, $conditions) {
      //pr($conditions);die();
       // $conditions = array();
        if (!empty($params['DistDistributorWiseCommissions.dist_distributor_id'])) {
            $conditions[] = array('DistDistributorWiseCommissions.dist_distributor_id' => $params['DistDistributorWiseCommissions.dist_distributor_id']);
        }
        return $conditions;
    }
