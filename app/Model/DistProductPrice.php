 ...
 */
class DistProductPrice extends AppModel {

	public function filter($params, $conditions) {
		$conditions = array();
		
		if (!empty($params['Product.product_category_id'])) {
            $conditions[] = array('DistProductPrice.id' => $params['Product.product_category_id']);
        }
		if (!empty($params['DistProductPrice.institute_id'])) {
            $conditions[] = array('DistProductPrice.institute_id' => $params['DistProductPrice.institute_id']);
        }
		if (!empty($params['DistProductPrice.target_custommer'])) {
            $conditions[] = array('DistProductPrice.target_custommer' => $params['DistProductPrice.target_custommer']);
        }
        return $conditions;
    }
