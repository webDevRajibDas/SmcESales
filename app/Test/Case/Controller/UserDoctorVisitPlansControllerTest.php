<?php
App::uses('UserDoctorVisitPlansController', 'Controller');

/**
 * UserDoctorVisitPlansController Test Case
 *
 */
class UserDoctorVisitPlansControllerTest extends ControllerTestCase {
