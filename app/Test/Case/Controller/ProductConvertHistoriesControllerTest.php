<?php
App::uses('ProductConvertHistoriesController', 'Controller');

/**
 * ProductConvertHistoriesController Test Case
 *
 */
class ProductConvertHistoriesControllerTest extends ControllerTestCase {
