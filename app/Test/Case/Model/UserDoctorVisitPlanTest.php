<?php
App::uses('UserDoctorVisitPlan', 'Model');

/**
 * UserDoctorVisitPlan Test Case
 *
 */
class UserDoctorVisitPlanTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->UserDoctorVisitPlan = ClassRegistry::init('UserDoctorVisitPlan');
	}
 ...
 */
	public function tearDown() {
		unset($this->UserDoctorVisitPlan);
