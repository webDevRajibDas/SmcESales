<?php
App::uses('ProductFractionSlab', 'Model');

/**
 * ProductFractionSlab Test Case
 *
 */
class ProductFractionSlabTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->ProductFractionSlab = ClassRegistry::init('ProductFractionSlab');
	}
 ...
 */
	public function tearDown() {
		unset($this->ProductFractionSlab);
