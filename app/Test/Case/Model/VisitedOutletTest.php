<?php
App::uses('VisitedOutlet', 'Model');

/**
 * VisitedOutlet Test Case
 *
 */
class VisitedOutletTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->VisitedOutlet = ClassRegistry::init('VisitedOutlet');
	}
