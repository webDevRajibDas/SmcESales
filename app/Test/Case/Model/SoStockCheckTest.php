<?php
App::uses('SoStockCheck', 'Model');

/**
 * SoStockCheck Test Case
 *
 */
class SoStockCheckTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->SoStockCheck = ClassRegistry::init('SoStockCheck');
	}
