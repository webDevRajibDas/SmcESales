<?php
App::uses('BonusEligibleOutlet', 'Model');

/**
 * BonusEligibleOutlet Test Case
 *
 */
class BonusEligibleOutletTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->BonusEligibleOutlet = ClassRegistry::init('BonusEligibleOutlet');
	}
 ...
 */
	public function tearDown() {
		unset($this->BonusEligibleOutlet);
